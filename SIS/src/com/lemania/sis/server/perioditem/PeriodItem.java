package com.lemania.sis.server.perioditem;
...
public class PeriodItem extends DatastoreObject implements Comparable<PeriodItem> {
	...
	public String getPeriod() {
		this.period = Integer.toString(fromHour) + ":" + Integer.toString(fromMinute)
				+ " - "
				+ Integer.toString(toHour) + ":" + Integer.toString(toMinute);
		return this.period;
	}
