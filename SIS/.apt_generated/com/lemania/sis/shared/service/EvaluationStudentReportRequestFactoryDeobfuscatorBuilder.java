...
withOperation(new OperationKey("c7S3rrHU3mix_y1cwjSpZVbjMjM="),
  ...
  .withDomainMethodDescriptor("(Lcom/lemania/sis/server/EvaluationStudentReport;)V")
  .withMethodName("save")
  .withRequestContext("com.lemania.sis.shared.service.EvaluationStudentReportRequestFactory$EvaluationStudentReportRequestContext")
  .build());
...
withOperation(new OperationKey("Ne7B$3OTJa1FdDTqX_i2DzySwos="),
  new OperationData.Builder()
  .withClientMethodDescriptor("(Lcom/lemania/sis/shared/EvaluationStudentReportProxy;)Lcom/google/web/bindery/requestfactory/shared/Request;")
  .withDomainMethodDescriptor("(Lcom/lemania/sis/server/EvaluationStudentReport;)Lcom/lemania/sis/server/EvaluationStudentReport;")
...
withOperation(new OperationKey("KWtmJ462MBas1XNFHC_uRLgJfVA="),
  ...
  .withDomainMethodDescriptor("(Ljava/lang/String;Ljava/lang/String;)Lcom/lemania/sis/server/EvaluationStudentReport;")
  .withMethodName("load")
  .withRequestContext("com.lemania.sis.shared.service.EvaluationStudentReportRequestFactory$EvaluationStudentReportRequestContext")
  .build());
...
withClientToDomainMappings("com.lemania.sis.server.EvaluationStudentReport", Arrays.asList("com.lemania.sis.shared.EvaluationStudentReportProxy"));
}}
