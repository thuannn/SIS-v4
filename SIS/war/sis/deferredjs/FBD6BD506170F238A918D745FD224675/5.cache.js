...
defineSeed(1177, 710, makeCastMap([Q$IsWidget, Q$EcolePresenter$MyView]), EcoleView_0);
...
defineSeed(1178, 392, makeCastMap([Q$HasCell, Q$Column]), EcoleView$1_0);
...
defineSeed(1179, 392, makeCastMap([Q$HasCell, Q$Column]), EcoleView$2_0);
...
defineSeed(1180, 366, makeCastMap([Q$HasCell, Q$Column]), EcoleView$3_0);
...
defineSeed(1610, 648, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$6X_0);
