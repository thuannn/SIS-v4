...
;
defineSeed(885, 736, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(886, 718, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1_0);
...
defineSeed(984, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(985, 644, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(986, 644, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(987, 644, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(1004, 718, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1376, 710, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1377, 1, {}, HomeView_BinderImpl_0);
...
defineSeed(1378, 1, {}, HomeView_HomeViewUiBinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1379, 1, makeCastMap([Q$KeyPressHandler, Q$EventHandler]), HomeView_HomeViewUiBinderImpl$Widgets$1_0);
_.this$1 = null;
function HomeView_HomeViewUiBinderImpl$Widgets$2_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1380, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), HomeView_HomeViewUiBinderImpl$Widgets$2_0);
...
defineSeed(1381, 1, makeCastMap([Q$FocusHandler, Q$EventHandler, Q$HomeView_HomeViewUiBinderImpl$Widgets$3]), HomeView_HomeViewUiBinderImpl$Widgets$3_0);
_.this$1 = null;
...
defineSeed(1684, 648, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
