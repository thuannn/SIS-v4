...
defineSeed(753, 236, {}, BrancheNameAfterChangeEvent_0);
...
function $updateBranche(this$static, branche, brancheName, brancheCoef, isActive){
  ...
  $fire((x_0 = new BrancheRequestFactory_BrancheRequestContextImpl$5X_0(rc, branche) , $addInvocation(rc.state.dialect, x_0) , x_0), new FrmBrancheListPresenter$2_0(this$static));
}
...
defineSeed(817, 699, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$BrancheNameAfterChangeEvent$BrancheNameAfterChangeHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBrancheListPresenter, Q$FrmBrancheListUiHandler]), FrmBrancheListPresenter_0);
...
defineSeed(818, 638, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$1_0);
...
defineSeed(819, 638, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$2_0);
...
defineSeed(820, 638, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$3_0);
...
;
defineSeed(821, 730, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$BrancheNameAfterChangeEvent$BrancheNameAfterChangeHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(824, 712, {}, FrmBrancheListPresenterMyProxyImpl$2_0);
...
defineSeed(825, 1, {}, FrmBrancheListPresenterMyProxyImpl$2$1_0);
...
function $setBrancheTableData(this$static, branches){
  ...
  $setHeight_0(this$static.tblBranche, '' + branches.size_1() * ($clinit_NotificationTypes() , lineHeight).value_0 + 'px');
}
...
defineSeed(1188, 704, makeCastMap([Q$IsWidget, Q$FrmBrancheListPresenter$MyView]), FrmBrancheListView_0);
...
defineSeed(1189, 360, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$1_0);
_.getValue = function getValue_6(object){
  return dynamicCast(object, Q$BrancheProxy).getBrancheName();
}
;
function $update_3(this$static, index_0, branche, value_0){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedBranche = index_0;
    $updateBranche(dynamicCast(this$static.this$0.uiHandlers, Q$FrmBrancheListUiHandler), branche, value_0, ($clinit_Double() , '' + branche.getDefaultCoef().value_0), branche.getIsActive());
  }
}
...
defineSeed(1190, 1, {}, FrmBrancheListView$2_0);
_.update = function update_4(index_0, branche, value_0){
  $update_3(this, index_0, dynamicCast(branche, Q$BrancheProxy), dynamicCast(value_0, Q$String));
}
;
...
defineSeed(1191, 360, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$3_0);
_.getValue = function getValue_7(object){
  return $getValue_3(dynamicCast(object, Q$BrancheProxy));
}
;
function $update_4(this$static, index_0, branche, value_0){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedBranche = index_0;
    $updateBranche(dynamicCast(this$static.this$0.uiHandlers, Q$FrmBrancheListUiHandler), branche, branche.getBrancheName(), value_0, branche.getIsActive());
  }
}
...
defineSeed(1192, 1, {}, FrmBrancheListView$4_0);
_.update = function update_5(index_0, branche, value_0){
  $update_4(this, index_0, dynamicCast(branche, Q$BrancheProxy), dynamicCast(value_0, Q$String));
}
;
...
defineSeed(1193, 360, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$5_0);
_.getValue = function getValue_8(branche){
  return dynamicCast(branche, Q$BrancheProxy).getIsActive();
}
;
function $update_5(this$static, index_0, branche, value_0){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedBranche = index_0;
    $updateBranche(dynamicCast(this$static.this$0.uiHandlers, Q$FrmBrancheListUiHandler), branche, branche.getBrancheName(), ($clinit_Double() , '' + branche.getDefaultCoef().value_0), value_0);
  }
}
...
defineSeed(1194, 1, {}, FrmBrancheListView$6_0);
_.update = function update_6(index_0, branche, value_0){
  $update_5(this, index_0, dynamicCast(branche, Q$BrancheProxy), dynamicCast(value_0, Q$Boolean));
}
;
function FrmBrancheListView_BinderImpl_0(){
}

defineSeed(1195, 1, {}, FrmBrancheListView_BinderImpl_0);
...
defineSeed(1196, 1, {}, FrmBrancheListView_BinderImpl$Widgets_0);
...
defineSeed(1557, 642, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$5X_0);
...
function $refreshBulletinBrancheNames(this$static, oldBrancheName, newBrancheName){
  var x_0;
  x_0 = new BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$6X_0(this$static, oldBrancheName, newBrancheName);
...
defineSeed(1564, 642, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$6X_0);
...
;
var Lcom_lemania_sis_client_presenter_FrmBrancheListPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheListPresenter', 817), Lcom_lemania_sis_client_presenter_FrmBrancheListPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheListPresenter$1', 818), Lcom_lemania_sis_client_presenter_FrmBrancheListPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheListPresenter$2', 819), Lcom_lemania_sis_client_presenter_FrmBrancheListPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheListPresenter$3', 820), Lcom_lemania_sis_client_event_BrancheNameAfterChangeEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'BrancheNameAfterChangeEvent', 753), Lcom_lemania_sis_client_presenter_FrmBrancheListPresenterMyProxyImpl$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheListPresenterMyProxyImpl$2', 824), Lcom_lemania_sis_client_presenter_FrmBrancheListPresenterMyProxyImpl$2$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheListPresenterMyProxyImpl$2$1', 825), Lcom_lemania_sis_client_view_FrmBrancheListView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView', 1188), Lcom_lemania_sis_client_view_FrmBrancheListView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView$1', 1189), Lcom_lemania_sis_client_view_FrmBrancheListView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView$2', 1190), Lcom_lemania_sis_client_view_FrmBrancheListView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView$3', 1191), Lcom_lemania_sis_client_view_FrmBrancheListView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView$4', 1192), Lcom_lemania_sis_client_view_FrmBrancheListView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView$5', 1193), Lcom_lemania_sis_client_view_FrmBrancheListView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView$6', 1194), Lcom_lemania_sis_client_view_FrmBrancheListView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView_BinderImpl', 1195), Lcom_lemania_sis_client_view_FrmBrancheListView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView_BinderImpl$Widgets', 1196), Lcom_lemania_sis_shared_service_BrancheRequestFactory_1BrancheRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BrancheRequestFactory_BrancheRequestContextImpl$5X', 1557), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$6X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$6X', 1564);
$entry(onLoad)(7);
