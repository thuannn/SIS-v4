...
defineSeed(896, 699, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(897, 638, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(898, 638, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(899, 638, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(900, 638, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1266, 704, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1267, 360, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(1269, 360, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1590, 642, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1594, 642, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
