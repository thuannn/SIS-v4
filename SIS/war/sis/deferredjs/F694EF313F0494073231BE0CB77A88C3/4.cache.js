...
defineSeed(1202, 787, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(1203, 718, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(1204, 718, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(1205, 718, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(1206, 718, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1513, 792, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1514, 421, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1516, 421, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1946, 722, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
