...
defineSeed(1420, 787, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(1421, 718, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(1422, 718, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(1423, 718, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(1424, 718, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(1425, 718, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(1426, 718, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(1427, 718, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(1428, 718, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(1429, 718, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1753, 792, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1754, 466, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1755, 421, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1758, 466, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1759, 466, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1760, 466, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1761, 421, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1900, 722, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1901, 722, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1902, 722, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1981, 722, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$8X_0);
