...
defineSeed(1219, 787, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$EcoleAddedEvent$EcoleAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$EcolePresenter, Q$EcoleListUiHandler]), EcolePresenter_0);
...
defineSeed(1220, 718, makeCastMap([Q$Receiver]), EcolePresenter$1_0);
...
defineSeed(1221, 718, makeCastMap([Q$Receiver]), EcolePresenter$2_0);
...
defineSeed(1528, 792, makeCastMap([Q$IsWidget, Q$EcolePresenter$MyView]), EcoleView_0);
...
defineSeed(1529, 466, makeCastMap([Q$HasCell, Q$Column]), EcoleView$1_0);
...
defineSeed(1530, 466, makeCastMap([Q$HasCell, Q$Column]), EcoleView$2_0);
...
defineSeed(1531, 421, makeCastMap([Q$HasCell, Q$Column]), EcoleView$3_0);
...
defineSeed(1952, 722, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$6X_0);
