...
defineSeed(1297, 787, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
_.onBind = function onBind_24(){
  dynamicCast(this.view, Q$FrmClasseListPresenter$MyView).setUiHandlers(this);
  $initializeTable_5(dynamicCast(this.view, Q$FrmClasseListPresenter$MyView));
}
;
...
_.onReset = function onReset_23(){
  ...
  $fire($listAll_6(rc), new FrmClasseListPresenter$1_0(this));
...
defineSeed(1298, 718, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(1299, 718, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
_.onFailure_0 = function onFailure_105(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_105(response){
  $onSuccess_89(this, dynamicCast(response, Q$ClasseProxy));
}
;
_.this$0 = null;
...
defineSeed(1300, 718, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(1301, 718, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
function $refreshUpdatedClasse(this$static, classe){
  ...
  $add_14(this$static.dataProvider.listWrapper, this$static.selectedClasse, classe);
...
function FrmClasseListView_0(){
  ...
  this.widget = $build_f_HTMLPanel1_19(new FrmClasseListView_BinderImpl$Widgets_0(this));
}

defineSeed(1601, 792, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1602, 421, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
_.getValue = function getValue_67(object){
  return dynamicCast(object, Q$ClasseProxy).getClassName();
}
;
function $update_30(this$static, index, classe, value){
...
defineSeed(1603, 1, {}, FrmClasseListView$2_0);
_.update = function update_31(index, classe, value){
  $update_30(this, index, dynamicCast(classe, Q$ClasseProxy), dynamicCast(value, Q$String));
}
;
_.this$0 = null;
...
defineSeed(1604, 421, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
_.getValue = function getValue_68(classe){
  return dynamicCast(classe, Q$ClasseProxy).getIsActive();
}
;
function $update_31(this$static, index, classe, value){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedClasse = index;
...
defineSeed(1605, 1, {}, FrmClasseListView$4_0);
_.update = function update_32(index, classe, value){
  $update_31(this, index, dynamicCast(classe, Q$ClasseProxy), dynamicCast(value, Q$Boolean));
}
;
_.this$0 = null;
...
defineSeed(1606, 1, {}, FrmClasseListView_BinderImpl_0);
function $build_f_HTMLPanel1_19(this$static){
  ...
  $addAndReplaceElement(f_HTMLPanel1, (f_VerticalPanel2 = new VerticalPanel_0 , $add_12(f_VerticalPanel2, (f_Label3 = new Label_0 , f_Label3.element['className'] = 'pageTitle' , $setHorizontalAlignment(f_Label3, ($clinit_HasHorizontalAlignment() , ALIGN_CENTER)) , $setTextOrHtml(f_Label3.directionalTextHelper, 'LISTE DES CLASSES', false) , $updateHorizontalAlignment(f_Label3) , f_Label3)) , $add_12(f_VerticalPanel2, (f_Grid4 = new Grid_0 , $resizeColumns(f_Grid4, 2) , $resizeRows(f_Grid4, 2) , $setWidget_3(f_Grid4, 0, 0, (f_Label5 = new Label_0 , $setTextOrHtml(f_Label5.directionalTextHelper, 'Ecole :', false) , $updateHorizontalAlignment(f_Label5) , f_Label5)) , $setWidget_3(f_Grid4, 0, 1, (lstEcoles = new ListBox_0 , lstEcoles.element['className'] = 'sis_textbox' , $addDomHandler(lstEcoles, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_ChangeEvent() , $clinit_ChangeEvent() , TYPE)) , this$static.owner.lstEcoles = lstEcoles , lstEcoles)) , $setWidget_3(f_Grid4, 1, 0, (f_Label6 = new Label_0 , $setTextOrHtml(f_Label6.directionalTextHelper, 'Programme :', false) , $updateHorizontalAlignment(f_Label6) , f_Label6)) , $setWidget_3(f_Grid4, 1, 1, (lstCours = new ListBox_0 , lstCours.element['className'] = 'sis_textbox' , $addDomHandler(lstCours, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, TYPE) , this$static.owner.lstCours = lstCours , lstCours)) , f_Grid4.element.style['width'] = '80%' , f_Grid4.tableElem['cellSpacing'] = 5 , f_Grid4.tableElem['cellPadding'] = 5 , f_Grid4)) , $add_12(f_VerticalPanel2, (tblClasseList = this$static.owner.tblClasseList , tblClasseList.element.style['height'] = '500px' , tblClasseList.element.style['width'] = '80%' , tblClasseList)) , f_VerticalPanel2.element.style['width'] = '100%' , f_VerticalPanel2.table['cellSpacing'] = 2 , f_VerticalPanel2), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(1607, 1, {}, FrmClasseListView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1608, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmClasseListView_BinderImpl$Widgets$1_0);
...
defineSeed(1609, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmClasseListView_BinderImpl$Widgets$2_0);
...
defineSeed(1931, 722, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1935, 722, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
...
var Lcom_lemania_sis_client_presenter_FrmClasseListPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseListPresenter', 1297), Lcom_lemania_sis_client_presenter_FrmClasseListPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseListPresenter$1', 1298), Lcom_lemania_sis_client_presenter_FrmClasseListPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseListPresenter$2', 1299), Lcom_lemania_sis_client_presenter_FrmClasseListPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseListPresenter$3', 1300), Lcom_lemania_sis_client_presenter_FrmClasseListPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseListPresenter$4', 1301), Lcom_lemania_sis_client_view_FrmClasseListView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView', 1601), Lcom_lemania_sis_client_view_FrmClasseListView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView$1', 1602), Lcom_lemania_sis_client_view_FrmClasseListView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView$2', 1603), Lcom_lemania_sis_client_view_FrmClasseListView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView$3', 1604), Lcom_lemania_sis_client_view_FrmClasseListView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView$4', 1605), Lcom_lemania_sis_client_view_FrmClasseListView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView_BinderImpl', 1606), Lcom_lemania_sis_client_view_FrmClasseListView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView_BinderImpl$Widgets', 1607), Lcom_lemania_sis_client_view_FrmClasseListView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView_BinderImpl$Widgets$1', 1608), Lcom_lemania_sis_client_view_FrmClasseListView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView_BinderImpl$Widgets$2', 1609), Lcom_lemania_sis_shared_service_ClasseRequestFactory_1ClasseRequestContextImpl$3X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ClasseRequestFactory_ClasseRequestContextImpl$3X', 1931), Lcom_lemania_sis_shared_service_ClasseRequestFactory_1ClasseRequestContextImpl$9X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ClasseRequestFactory_ClasseRequestContextImpl$9X', 1935);
$entry(onLoad)(13);
