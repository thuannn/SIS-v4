...
defineSeed(1289, 787, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseAddPresenter, Q$FrmClasseAddUiHandler]), FrmClasseAddPresenter_0);
...
defineSeed(1290, 718, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$1_0);
...
defineSeed(1291, 718, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$2_0);
...
defineSeed(1292, 718, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$3_0);
...
defineSeed(1594, 792, makeCastMap([Q$IsWidget, Q$FrmClasseAddPresenter$MyView]), FrmClasseAddView_0);
...
defineSeed(1595, 10, makeCastMap([Q$Timer]), FrmClasseAddView$1_0);
...
defineSeed(1934, 722, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$8X_0);
