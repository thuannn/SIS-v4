...
defineSeed(859, 271, {}, ProfessorAfterAddEvent_0);
...
defineSeed(1103, 718, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(1110, 800, {}, UserManagementPresenterMyProxyImpl$2_0);
...
defineSeed(1111, 1, {}, UserManagementPresenterMyProxyImpl$2$1_0);
...
defineSeed(1414, 787, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsAddPresenter, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(1415, 718, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(1745, 792, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1980, 722, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$7X_0);
