...
defineSeed(1375, 787, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmSubjectListPresenter, Q$FrmSubjectListUiHandler]), FrmSubjectListPresenter_0);
...
defineSeed(1376, 718, makeCastMap([Q$Receiver]), FrmSubjectListPresenter$1_0);
...
defineSeed(1377, 718, makeCastMap([Q$Receiver]), FrmSubjectListPresenter$2_0);
...
defineSeed(1702, 792, makeCastMap([Q$IsWidget, Q$FrmSubjectListPresenter$MyView]), FrmSubjectListView_0);
...
defineSeed(1703, 421, makeCastMap([Q$HasCell, Q$Column]), FrmSubjectListView$1_0);
...
defineSeed(1705, 421, makeCastMap([Q$HasCell, Q$Column]), FrmSubjectListView$3_0);
...
defineSeed(1707, 421, makeCastMap([Q$HasCell, Q$Column]), FrmSubjectListView$5_0);
...
defineSeed(2010, 722, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$2X_0);
...
defineSeed(2014, 722, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$8X_0);
