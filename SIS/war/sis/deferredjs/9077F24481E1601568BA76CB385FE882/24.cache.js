...
defineSeed(1030, 687, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$SettingsPresenter, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(1031, 626, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(1032, 626, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(1033, 626, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1034, 626, makeCastMap([Q$Receiver]), SettingsPresenter$4_0);
...
defineSeed(1035, 626, makeCastMap([Q$Receiver]), SettingsPresenter$5_0);
...
defineSeed(1036, 626, makeCastMap([Q$Receiver]), SettingsPresenter$6_0);
...
defineSeed(1421, 692, makeCastMap([Q$IsWidget, Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1645, 630, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
...
defineSeed(1669, 630, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$4X_0);
