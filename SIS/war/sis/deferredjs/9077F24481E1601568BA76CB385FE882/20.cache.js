...
;
defineSeed(867, 718, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(868, 700, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1_0);
...
defineSeed(869, 1, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1$1_0);
...
defineSeed(966, 687, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(967, 626, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(968, 626, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(969, 626, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(986, 700, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(987, 1, {}, MainPagePresenterMyProxyImpl$5$1_0);
...
defineSeed(1358, 692, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1666, 630, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
