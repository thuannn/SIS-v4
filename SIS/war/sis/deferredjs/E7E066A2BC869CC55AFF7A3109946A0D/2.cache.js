...
defineSeed(755, 235, {}, CoursAddedEvent_0);
...
defineSeed(777, 698, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursAddPresenter, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(778, 637, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(779, 637, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(789, 729, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(790, 711, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(791, 1, {}, CoursPresenterMyProxyImpl$1$1_0);
...
defineSeed(1152, 703, makeCastMap([Q$IsWidget, Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(1153, 1, {}, CoursAddView_BinderImpl_0);
...
defineSeed(1154, 1, {}, CoursAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1155, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1156, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1600, 641, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
...
_.val$cours = null;
_.val$ecoleId = null;
var Lcom_lemania_sis_client_presenter_CoursAddPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursAddPresenter', 777), Lcom_lemania_sis_client_presenter_CoursAddPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursAddPresenter$1', 778), Lcom_lemania_sis_client_presenter_CoursAddPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursAddPresenter$2', 779), Lcom_lemania_sis_client_event_CoursAddedEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'CoursAddedEvent', 755), Lcom_lemania_sis_client_presenter_CoursPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursPresenterMyProxyImpl$1', 790), Lcom_lemania_sis_client_presenter_CoursPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursPresenterMyProxyImpl$1$1', 791), Lcom_lemania_sis_client_view_CoursAddView_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView', 1152), Lcom_lemania_sis_client_view_CoursAddView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView_BinderImpl', 1153), Lcom_lemania_sis_client_view_CoursAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView_BinderImpl$Widgets', 1154), Lcom_lemania_sis_client_view_CoursAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView_BinderImpl$Widgets$1', 1155), Lcom_lemania_sis_client_view_CoursAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView_BinderImpl$Widgets$2', 1156), Lcom_lemania_sis_shared_service_CoursRequestFactory_1CoursRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$7X', 1600);
$entry(onLoad)(2);
