...
defineSeed(544, 500, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]));
...
function $addStyleName(this$static, row){
  ...
  td = $getCellElement_0(this$static.this$0.bodyElem, row, 0);
  setStyleName(td, 'spaceCell', true);
}

function $setRowSpan(this$static, row, column, rowSpan){
  (this$static.this$0.prepareCell(row, column) , $getCellElement_0(this$static.this$0.bodyElem, row, column))['rowSpan'] = rowSpan;
}

defineSeed(548, 544, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]));
...
function $setWidth_1(this$static, column, width){
...
function $onBulletinChange(this$static, bulletinId){
  ...
  $fire($listAll_4(rc, bulletinId), new FrmBulletinViewDetailPresenter$4_0(this$static, bulletinId));
}
...
defineSeed(1285, 805, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinViewDetailPresenter, Q$FrmBulletinViewDetailUiHandler]), FrmBulletinViewDetailPresenter_0);
...
defineSeed(1286, 736, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$1_0);
...
function $onSuccess_76(this$static, response){
  $setStudentListData_0(dynamicCast(this$static.this$0.view, Q$FrmBulletinViewDetailPresenter$MyView), response);
}
...
defineSeed(1287, 736, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$2_0);
...
defineSeed(1288, 736, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$3_0);
...
defineSeed(1289, 736, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$4_0);
...
defineSeed(1290, 736, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$5_0);
...
defineSeed(1291, 736, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$6_0);
_.onFailure_0 = function onFailure_96(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_96(response){
  $onSuccess_80(this, dynamicCast(response, Q$BulletinProxy));
}
;
_.this$0 = null;
_.val$branches = null;
...
defineSeed(1519, 1, makeCastMap([Q$RunAsyncCallback]));
_.onSuccess = function onSuccess_202(){
...
function $drawGradeTableMatu(this$static, subjects, branches, isStudent){
  ...
  $setText_2(this$static.tblBulletin, rowCount.value_0, 0, 'Mati\xE8re');
  $setText_2(this$static.tblBulletin, rowCount.value_0, 1, 'Coef');
  $setText_2(this$static.tblBulletin, rowCount.value_0, 7, 'T1');
  $setText_2(this$static.tblBulletin, rowCount.value_0, 13, 'T2');
  $setText_2(this$static.tblBulletin, rowCount.value_0, 14, 'Moyenne Semestrielle');
  ...
  for (subject$iterator = new AbstractList$IteratorImpl_0(subjects); subject$iterator.i < subject$iterator.this$0_0.size_1();) {
    subject = dynamicCast($next_5(subject$iterator), Q$BulletinSubjectProxy);
    rowCount = valueOf_1(rowCount.value_0 + 1);
    $setText_2(this$static.tblBulletin, rowCount.value_0, 0, subject.getSubjectName());
    $setText_2(this$static.tblBulletin, rowCount.value_0, 1, ($clinit_Double() , '' + subject.getSubjectCoef().value_0));
    $setText_2(this$static.tblBulletin, rowCount.value_0, 7, subject.getT1());
    $setText_2(this$static.tblBulletin, rowCount.value_0, 13, subject.getT2());
    $setText_2(this$static.tblBulletin, rowCount.value_0, 14, subject.getAn());
    isStudent.value_0?$setText_2(this$static.tblBulletin, rowCount.value_0 + 1, 14, ''):$setText_2(this$static.tblBulletin, rowCount.value_0 + 1, 14, !subject.getRemarqueT3().length?!subject.getRemarqueT2().length?subject.getRemarqueT1():subject.getRemarqueT2():subject.getRemarqueT3());
    for (i = 0; i < 15; ++i)
    ...
    for (branche$iterator = branches.iterator(); branche$iterator.hasNext();) {
      ...
      if ($equals_5(branche.getBulletinSubjectId(), subject.getId_0())) {
        rowCount = valueOf_1(rowCount.value_0 + 1);
        brancheCount = valueOf_1(brancheCount.value_0 + 1);
        $setText_2(this$static.tblBulletin, rowCount.value_0, 0, branche.getBulletinBrancheName());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 1, '' + branche.getBrancheCoef().value_0);
        $setText_2(this$static.tblBulletin, rowCount.value_0, 2, branche.getT1_1());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 3, branche.getT1_2());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 4, branche.getT1_3());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 5, branche.getT1_4());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 6, branche.getT1_5());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 7, branche.getT1());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 8, branche.getT2_1());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 9, branche.getT2_2());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 10, branche.getT2_3());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 11, branche.getT2_4());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 12, branche.getT2_5());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 13, branche.getT2());
      }
    }
    ...
    rowCount = valueOf_1(rowCount.value_0 + 1);
    $setText_2(this$static.tblBulletin, rowCount.value_0, 0, '');
    $addStyleName(this$static.tblBulletin.cellFormatter, rowCount.value_0);
  }
  $setWidth_1(this$static.tblBulletin.columnFormatter, 0, '30%');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 1, '10%');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 7, '10%');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 13, '10%');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 14, '40%');
...
function $drawGradeTableNormal(this$static, subjects, branches, isStudent){
  ...
  $setText_2(this$static.tblBulletin, rowCount.value_0, 7, 'T1');
  $setText_2(this$static.tblBulletin, rowCount.value_0, 13, 'T2');
  $setText_2(this$static.tblBulletin, rowCount.value_0, 19, 'T3');
  $setText_2(this$static.tblBulletin, rowCount.value_0, 20, 'Moyenne Annuelle');
  $setStyleName_1(this$static.tblBulletin.rowFormatter, rowCount.value_0);
  for (subject$iterator = new AbstractList$IteratorImpl_0(subjects); subject$iterator.i < subject$iterator.this$0_0.size_1();) {
    subject = dynamicCast($next_5(subject$iterator), Q$BulletinSubjectProxy);
    rowCount = valueOf_1(rowCount.value_0 + 1);
    ...
    $setText_2(this$static.tblBulletin, rowCount.value_0, 7, subject.getT1());
    $setText_2(this$static.tblBulletin, rowCount.value_0, 13, subject.getT2());
    $setText_2(this$static.tblBulletin, rowCount.value_0, 19, subject.getT3());
    $setText_2(this$static.tblBulletin, rowCount.value_0, 20, subject.getAn());
    isStudent.value_0?$setText_2(this$static.tblBulletin, rowCount.value_0 + 1, 20, ''):$setText_2(this$static.tblBulletin, rowCount.value_0 + 1, 20, !subject.getRemarqueT3().length?!subject.getRemarqueT2().length?subject.getRemarqueT1():subject.getRemarqueT2():subject.getRemarqueT3());
    for (i = 0; i < 21; ++i)
      $setStyleName_0(this$static.tblBulletin.cellFormatter, rowCount.value_0, i, 'subjectLine');
    brancheCount = valueOf_1(0);
    for (branche$iterator = branches.iterator(); branche$iterator.hasNext();) {
      ...
      if ($equals_5(branche.getBulletinSubjectId(), subject.getId_0())) {
        ...
        $setText_2(this$static.tblBulletin, rowCount.value_0, 12, branche.getT2_5());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 13, branche.getT2());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 14, branche.getT3_1());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 15, branche.getT3_2());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 16, branche.getT3_3());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 17, branche.getT3_4());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 18, branche.getT3_5());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 19, branche.getT3());
      }
    }
  ...
  $setWidth_1(this$static.tblBulletin.columnFormatter, 0, '20%');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 1, '10%');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 7, '10%');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 13, '10%');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 14, '');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 19, '10%');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 20, '40%');
  setStylePrimaryName($ensureColumn(this$static.tblBulletin.columnFormatter, 7), 'gradeColumn');
  setStyleName($ensureColumn(this$static.tblBulletin.columnFormatter, 13), 'gradeColumn', true);
...
function $drawGradeTablePrematurite(this$static, subjects, branches, isStudent){
  ...
  $setText_2(this$static.tblBulletin, rowCount.value_0, 13, 'T2');
  $setText_2(this$static.tblBulletin, rowCount.value_0, 19, 'T3');
  $setText_2(this$static.tblBulletin, rowCount.value_0, 25, 'T4');
  $setText_2(this$static.tblBulletin, rowCount.value_0, 26, 'Moyenne Annuelle');
  $setStyleName_1(this$static.tblBulletin.rowFormatter, rowCount.value_0);
  for (subject$iterator = new AbstractList$IteratorImpl_0(subjects); subject$iterator.i < subject$iterator.this$0_0.size_1();) {
    subject = dynamicCast($next_5(subject$iterator), Q$BulletinSubjectProxy);
    rowCount = valueOf_1(rowCount.value_0 + 1);
    ...
    $setText_2(this$static.tblBulletin, rowCount.value_0, 13, subject.getT2());
    $setText_2(this$static.tblBulletin, rowCount.value_0, 19, subject.getT3());
    $setText_2(this$static.tblBulletin, rowCount.value_0, 25, subject.getT3());
    $setText_2(this$static.tblBulletin, rowCount.value_0, 26, subject.getAn());
    isStudent.value_0?$setText_2(this$static.tblBulletin, rowCount.value_0 + 1, 26, ''):$setText_2(this$static.tblBulletin, rowCount.value_0 + 1, 26, !subject.getRemarqueT4().length?!subject.getRemarqueT3().length?!subject.getRemarqueT2().length?subject.getRemarqueT1():subject.getRemarqueT2():subject.getRemarqueT3():subject.getRemarqueT4());
    for (i = 0; i < 27; ++i)
      $setStyleName_0(this$static.tblBulletin.cellFormatter, rowCount.value_0, i, 'subjectLine');
    brancheCount = valueOf_1(0);
    for (branche$iterator = branches.iterator(); branche$iterator.hasNext();) {
      ...
      if ($equals_5(branche.getBulletinSubjectId(), subject.getId_0())) {
        ...
        $setText_2(this$static.tblBulletin, rowCount.value_0, 18, branche.getT3_5());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 19, branche.getT3());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 20, branche.getT4_1());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 21, branche.getT4_2());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 22, branche.getT4_3());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 23, branche.getT4_4());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 24, branche.getT4_5());
        $setText_2(this$static.tblBulletin, rowCount.value_0, 25, branche.getT4());
      }
    }
  ...
  $setWidth_1(this$static.tblBulletin.columnFormatter, 14, '');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 19, '10%');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 25, '10%');
  $setWidth_1(this$static.tblBulletin.columnFormatter, 26, '40%');
  setStylePrimaryName($ensureColumn(this$static.tblBulletin.columnFormatter, 7), 'gradeColumn');
  setStyleName($ensureColumn(this$static.tblBulletin.columnFormatter, 13), 'gradeColumn', true);
  setStyleName($ensureColumn(this$static.tblBulletin.columnFormatter, 19), 'gradeColumn', true);
...
function $setStudentListData_0(this$static, bulletins){
  ...
  for (bulletin$iterator = bulletins.iterator(); bulletin$iterator.hasNext();) {
    ...
    $insertItem_0(this$static.lstBulletins, bulletin.getStudentName() + ' - ' + bulletin.getClasseName() + ' - ' + bulletin.getYear(), '' + toString_6(bulletin.getId_0().value_0), -1);
  }
}
...
function $styleTableMatu(this$static){
  ...
  for (i = 0; i < 15; ++i)
    for (j = 1; j < this$static.tblBulletin.bodyElem.rows.length; ++j) {
      $isCellPresent(this$static.tblBulletin, j, i) && $equals_6($getPropertyString($getElement(this$static.tblBulletin.cellFormatter, j, i), 'className'), '') && $setStyleName_0(this$static.tblBulletin.cellFormatter, j, i, 'brancheLine');
    }
}
...
function FrmBulletinViewDetailView_0(){
  this.widget = $build_f_HTMLPanel1_16(new FrmBulletinViewDetailView_BinderImpl$Widgets_0(this));
}

defineSeed(1595, 810, makeCastMap([Q$IsWidget, Q$FrmBulletinViewDetailPresenter$MyView]), FrmBulletinViewDetailView_0);
...
defineSeed(1596, 1, {}, FrmBulletinViewDetailView_BinderImpl_0);
...
defineSeed(1597, 1, {}, FrmBulletinViewDetailView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1598, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewDetailView_BinderImpl$Widgets$1_0);
...
defineSeed(1599, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewDetailView_BinderImpl$Widgets$2_0);
...
function $listAllByEmail(this$static, email){
  var x;
  x = new BulletinRequestFactory_BulletinRequestContextImpl$9X_0(this$static, email);
...
defineSeed(1863, 740, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$2X_0);
_.makeRequestData = function makeRequestData_4(){
  return new RequestData_0('7HBY8B2nCIoMsX53cfsuuXo4zK0=', initValues(_3Ljava_lang_Object_2_classLit, makeCastMap([Q$Serializable, Q$Object_$1]), Q$Object, [this.val$bulletinId]), this.propertyRefs, Lcom_lemania_sis_shared_bulletin_BulletinProxy_2_classLit, null);
}
;
_.val$bulletinId = null;
function BulletinRequestFactory_BulletinRequestContextImpl$9X_0(this$0, val$email){
  this.val$email = val$email;
  AbstractRequest_0.call(this, this$0);
}

defineSeed(1867, 740, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$9X_0);
_.makeRequestData = function makeRequestData_8(){
  return new RequestData_0('SfcsDkX_WyQ6esmR8iJ7HlmF_84=', initValues(_3Ljava_lang_Object_2_classLit, makeCastMap([Q$Serializable, Q$Object_$1]), Q$Object, [this.val$email]), this.propertyRefs, Ljava_util_List_2_classLit, Lcom_lemania_sis_shared_bulletin_BulletinProxy_2_classLit);
}
;
_.val$email = null;
...
defineSeed(1934, 740, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X_0);
...
;
_.val$bulletinId = null;
var Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter', 1285), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$1', 1286), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$2', 1287), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$3', 1288), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$4', 1289), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$5', 1290), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$6', 1291), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView', 1595), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl', 1596), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets', 1597), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets$1', 1598), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets$2', 1599), Lcom_lemania_sis_shared_bulletin_BulletinRequestFactory_1BulletinRequestContextImpl$2X_2_classLit = createForClass('com.lemania.sis.shared.bulletin.', 'BulletinRequestFactory_BulletinRequestContextImpl$2X', 1863), Lcom_lemania_sis_shared_bulletin_BulletinRequestFactory_1BulletinRequestContextImpl$9X_2_classLit = createForClass('com.lemania.sis.shared.bulletin.', 'BulletinRequestFactory_BulletinRequestContextImpl$9X', 1867), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X', 1934);
$entry(onLoad)(10);
