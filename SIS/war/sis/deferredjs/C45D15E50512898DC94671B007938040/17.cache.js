...
defineSeed(865, 273, {}, CheckDeadlineEvent_0);
...
function $onBulletinSubjectSelected(this$static, bulletinSubject){
  ...
  $fire($listAll_3(rc, '' + toString_6(bulletinSubject.getId_0().value_0)), new FrmMarkInputPresenter$6_0(this$static));
}
...
function $onCheckDeadline(this$static){
  ...
  $fire($listAll_9(rc), new FrmMarkInputPresenter$5_0(this$static));
}
...
defineSeed(1366, 805, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CheckDeadlineEvent$CheckDeadlineHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmMarkInputPresenter, Q$FrmMarkInputUiHandler]), FrmMarkInputPresenter_0);
...
_.onReset = function onReset_27(){
  ...
  this.currentUser.isAdmin && $fire($listAll_7(rc), new FrmMarkInputPresenter$2_0(this));
}
;
...
defineSeed(1367, 736, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$1_0);
...
defineSeed(1368, 736, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$2_0);
...
defineSeed(1369, 736, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$3_0);
...
defineSeed(1370, 736, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$4_0);
...
defineSeed(1371, 736, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$5_0);
...
defineSeed(1372, 736, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$6_0);
...
defineSeed(1373, 736, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$7_0);
_.onFailure_0 = function onFailure_137(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_137(response){
  $onSuccess_119(this, dynamicCast(response, Q$BulletinBrancheProxy));
}
;
_.this$0 = null;
...
defineSeed(1374, 736, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$8_0);
_.onFailure_0 = function onFailure_138(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_138(response){
  $onSuccess_120(this, dynamicCast(response, Q$BulletinSubjectProxy));
}
;
_.this$0 = null;
_.val$bulletinBranche = null;
defineSeed(1375, 833, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CheckDeadlineEvent$CheckDeadlineHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(1378, 818, {}, FrmMarkInputPresenterMyProxyImpl$2_0);
_.success = function success_41(presenter){
  $success_39(this, dynamicCast(presenter, Q$FrmMarkInputPresenter));
}
;
_.val$event = null;
...
defineSeed(1379, 1, {}, FrmMarkInputPresenterMyProxyImpl$2$1_0);
...
defineSeed(1485, 1, makeCastMap([Q$RunAsyncCallback]));
...
function $clearInputFields(this$static){
  $setText_1(this$static.txt_t_1_1, '');
  $setText_1(this$static.txt_t_1_2, '');
  $setText_1(this$static.txt_t_1_3, '');
  $setText_1(this$static.txt_t_1_4, '');
  $setText_1(this$static.txt_t_1_5, '');
  $setText_1(this$static.txt_t_2_1, '');
  $setText_1(this$static.txt_t_2_2, '');
  $setText_1(this$static.txt_t_2_3, '');
  $setText_1(this$static.txt_t_2_4, '');
  $setText_1(this$static.txt_t_2_5, '');
  $setText_1(this$static.txt_t_3_1, '');
  $setText_1(this$static.txt_t_3_2, '');
  $setText_1(this$static.txt_t_3_3, '');
  $setText_1(this$static.txt_t_3_4, '');
  $setText_1(this$static.txt_t_3_5, '');
  $setText_1(this$static.txt_t_4_1, '');
  $setText_1(this$static.txt_t_4_2, '');
  $setText_1(this$static.txt_t_4_3, '');
  $setText_1(this$static.txt_t_4_4, '');
  $setText_1(this$static.txt_t_4_5, '');
  $setText_1(this$static.txtRemarque1, '');
  $setText_1(this$static.txtRemarque2, '');
  $setText_1(this$static.txtRemarque3, '');
  $setText_1(this$static.txtRemarque4, '');
  $setText_0(this$static.txtT1, '');
  $setText_0(this$static.txtT2, '');
  $setText_0(this$static.txtT3, '');
  $setText_0(this$static.txtT4, '');
  ...
  for (setting$iterator = settings.iterator(); setting$iterator.hasNext();) {
    ...
    if ($getItemText(this$static.lstAssignments, this$static.lstAssignments.element.selectedIndex).toLowerCase().indexOf('maturit\xE9 suisse') != -1) {
      if ($getItemText(this$static.lstAssignments, this$static.lstAssignments.element.selectedIndex).toLowerCase().indexOf('pr\xE9alable') == -1) {
        if ($equals_6(setting.getOptionName(), ($clinit_NotificationTypes() , 'BLOCK_MATU_T1'))) {
        ...
        if ($equals_6(setting.getOptionName(), 'BLOCK_MATU_T2')) {
          deadLine = __parseAndValidateInt(setting.getOptionValue());
    ...
    if ($getItemText(this$static.lstAssignments, this$static.lstAssignments.element.selectedIndex).toLowerCase().indexOf('baccalaur\xE9at fran\xE7ais') != -1) {
      if ($equals_6(setting.getOptionName(), ($clinit_NotificationTypes() , 'BLOCK_BAC_T1'))) {
        deadLine = __parseAndValidateInt(setting.getOptionValue());
        deadLine <= currentDate?(this$static.blockT1 = true):(this$static.blockT1 = false);
      }
      if ($equals_6(setting.getOptionName(), 'BLOCK_BAC_T2')) {
        deadLine = __parseAndValidateInt(setting.getOptionValue());
        deadLine <= currentDate?(this$static.blockT2 = true):(this$static.blockT2 = false);
      }
      if ($equals_6(setting.getOptionName(), 'BLOCK_BAC_T3')) {
        deadLine = __parseAndValidateInt(setting.getOptionValue());
    ...
    if ($getItemText(this$static.lstAssignments, this$static.lstAssignments.element.selectedIndex).toLowerCase().indexOf('etudes secondaires') != -1) {
      if ($equals_6(setting.getOptionName(), ($clinit_NotificationTypes() , 'BLOCK_ES_T1'))) {
        deadLine = __parseAndValidateInt(setting.getOptionValue());
        deadLine <= currentDate?(this$static.blockT1 = true):(this$static.blockT1 = false);
      }
      if ($equals_6(setting.getOptionName(), 'BLOCK_ES_T2')) {
        deadLine = __parseAndValidateInt(setting.getOptionValue());
        deadLine <= currentDate?(this$static.blockT2 = true):(this$static.blockT2 = false);
      }
      if ($equals_6(setting.getOptionName(), 'BLOCK_ES_T3')) {
        deadLine = __parseAndValidateInt(setting.getOptionValue());
        deadLine <= currentDate?(this$static.blockT3 = true):(this$static.blockT3 = false);
      }
    }
...
function $onLstProfsChange_1(this$static){
...
function $showCurrentNotes(this$static){
  $setText_1(this$static.txt_t_1_1, this$static.selectedBulletinBranche.getT1_1());
  $setText_1(this$static.txt_t_1_2, this$static.selectedBulletinBranche.getT1_2());
  $setText_1(this$static.txt_t_1_3, this$static.selectedBulletinBranche.getT1_3());
  $setText_1(this$static.txt_t_1_4, this$static.selectedBulletinBranche.getT1_4());
  $setText_1(this$static.txt_t_1_5, this$static.selectedBulletinBranche.getT1_5());
  $setText_1(this$static.txt_t_2_1, this$static.selectedBulletinBranche.getT2_1());
  $setText_1(this$static.txt_t_2_2, this$static.selectedBulletinBranche.getT2_2());
  $setText_1(this$static.txt_t_2_3, this$static.selectedBulletinBranche.getT2_3());
  $setText_1(this$static.txt_t_2_4, this$static.selectedBulletinBranche.getT2_4());
  $setText_1(this$static.txt_t_2_5, this$static.selectedBulletinBranche.getT2_5());
  $setText_1(this$static.txt_t_3_1, this$static.selectedBulletinBranche.getT3_1());
  $setText_1(this$static.txt_t_3_2, this$static.selectedBulletinBranche.getT3_2());
  $setText_1(this$static.txt_t_3_3, this$static.selectedBulletinBranche.getT3_3());
  $setText_1(this$static.txt_t_3_4, this$static.selectedBulletinBranche.getT3_4());
  $setText_1(this$static.txt_t_3_5, this$static.selectedBulletinBranche.getT3_5());
  $setText_1(this$static.txt_t_4_1, this$static.selectedBulletinBranche.getT4_1());
  $setText_1(this$static.txt_t_4_2, this$static.selectedBulletinBranche.getT4_2());
  $setText_1(this$static.txt_t_4_3, this$static.selectedBulletinBranche.getT4_3());
  $setText_1(this$static.txt_t_4_4, this$static.selectedBulletinBranche.getT4_4());
  $setText_1(this$static.txt_t_4_5, this$static.selectedBulletinBranche.getT4_5());
  $setText_0(this$static.txtT1, this$static.selectedBulletinBranche.getT1());
  $setText_0(this$static.txtT2, this$static.selectedBulletinBranche.getT2());
  $setText_0(this$static.txtT3, this$static.selectedBulletinBranche.getT3());
  $setText_0(this$static.txtT4, this$static.selectedBulletinBranche.getT4());
  $modifyUiByProgramme(this$static);
}

function $showCurrentRemarques(this$static){
  $setText_1(this$static.txtRemarque1, this$static.selectedBulletinSubject.getRemarqueT1());
  $setText_1(this$static.txtRemarque2, this$static.selectedBulletinSubject.getRemarqueT2());
  $setText_1(this$static.txtRemarque3, this$static.selectedBulletinSubject.getRemarqueT3());
  $setText_1(this$static.txtRemarque4, this$static.selectedBulletinSubject.getRemarqueT4());
}
...
function $showUpdatedBulletinDetails(this$static, bulletinBranche, bulletinSubject){
  ...
  $setText_0(this$static.txtT1, bulletinBranche.getT1());
  $setText_0(this$static.txtT2, bulletinBranche.getT2());
  $setText_0(this$static.txtT3, bulletinBranche.getT3());
  $setText_0(this$static.txtT4, bulletinBranche.getT4());
}
...
function FrmMarkInputView_0(){
  ...
  this.widget = $build_f_HTMLPanel1_23(new FrmMarkInputView_BinderImpl$Widgets_0(this));
}

defineSeed(1684, 810, makeCastMap([Q$IsWidget, Q$FrmMarkInputPresenter$MyView]), FrmMarkInputView_0);
...
defineSeed(1685, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$1_0);
...
defineSeed(1686, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$10_0);
_.getValue = function getValue_88(object){
...
defineSeed(1687, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$11_0);
_.getValue = function getValue_89(object){
  return $getValue_11(dynamicCast(object, Q$BulletinBrancheProxy));
}
;
...
defineSeed(1688, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$12_0);
_.getValue = function getValue_90(object){
...
defineSeed(1689, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$13_0);
_.getValue = function getValue_91(object){
...
defineSeed(1690, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$14_0);
_.getValue = function getValue_92(object){
...
defineSeed(1691, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$15_0);
_.getValue = function getValue_93(object){
...
defineSeed(1692, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmMarkInputView$16_0);
_.onSelectionChange = function onSelectionChange_7(event_0){
  ...
  if (this.this$0.selectedBulletinBranche) {
    $setText_0(this.this$0.lblStudentName, this.this$0.selectedBulletinSubject.getStudentName() + ' - ' + this.this$0.selectedBulletinBranche.getBulletinBrancheName());
...
defineSeed(1693, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$17_0);
_.getValue = function getValue_94(object){
...
defineSeed(1694, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmMarkInputView$18_0);
_.onSelectionChange = function onSelectionChange_8(event_0){
  ...
  if (this.this$0.selectedBulletinSubject) {
    ...
    $add_15(this.this$0.bulletinSubjectAverageDataProvider.listWrapper, this.this$0.selectedBulletinSubject);
...
defineSeed(1695, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$2_0);
_.getValue = function getValue_95(object){
...
defineSeed(1696, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$3_0);
_.getValue = function getValue_96(object){
...
defineSeed(1697, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$4_0);
_.getValue = function getValue_97(object){
...
defineSeed(1698, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$5_0);
_.getValue = function getValue_98(object){
...
defineSeed(1699, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$6_0);
_.getValue = function getValue_99(object){
...
defineSeed(1700, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$7_0);
_.getValue = function getValue_100(object){
...
defineSeed(1701, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$8_0);
_.getValue = function getValue_101(object){
...
defineSeed(1702, 475, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$9_0);
_.getValue = function getValue_102(object){
...
defineSeed(1703, 1, {}, FrmMarkInputView_BinderImpl_0);
function $build_f_HTMLPanel1_23(this$static){
  ...
  $addAndReplaceElement(f_HTMLPanel1, (f_VerticalPanel2 = new VerticalPanel_0 , $add_12(f_VerticalPanel2, (f_Label3 = new Label_0 , f_Label3.element['className'] = 'pageTitle' , $setHorizontalAlignment(f_Label3, ($clinit_HasHorizontalAlignment() , ALIGN_CENTER)) , $setTextOrHtml(f_Label3.directionalTextHelper, 'SAISIR LES NOTES', false) , $updateHorizontalAlignment(f_Label3) , f_Label3)) , $add_12(f_VerticalPanel2, (f_Grid4 = new Grid_0 , $resizeColumns(f_Grid4, 3) , $resizeRows(f_Grid4, 2) , $setWidget_3(f_Grid4, 0, 0, (f_Label5 = new Label_0 , f_Label5.element['className'] = 'step' , $setHorizontalAlignment(f_Label5, ALIGN_LEFT) , $setTextOrHtml(f_Label5.directionalTextHelper, '1', false) , $updateHorizontalAlignment(f_Label5) , f_Label5)) , $setWidget_3(f_Grid4, 0, 1, (f_Label6 = new Label_0 , f_Label6.element['className'] = 'fieldTitle' , $setTextOrHtml(f_Label6.directionalTextHelper, 'Choisir le nom du professeur :', false) , $updateHorizontalAlignment(f_Label6) , f_Label6)) , $setWidget_3(f_Grid4, 0, 2, (lstProfs = new ListBox_0 , lstProfs.element.style['width'] = '300px' , $addDomHandler(lstProfs, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_ChangeEvent() , $clinit_ChangeEvent() , TYPE)) , this$static.owner.lstProfs = lstProfs , lstProfs)) , $setWidget_3(f_Grid4, 1, 0, (f_Label7 = new Label_0 , f_Label7.element['className'] = 'step' , $setTextOrHtml(f_Label7.directionalTextHelper, '2', false) , $updateHorizontalAlignment(f_Label7) , f_Label7)) , $setWidget_3(f_Grid4, 1, 1, (f_Label8 = new Label_0 , f_Label8.element['className'] = 'fieldTitle' , $setTextOrHtml(f_Label8.directionalTextHelper, 'Choisir la classe & mati\xE8re \xE0 saisir les notes :', false) , $updateHorizontalAlignment(f_Label8) , f_Label8)) , $setWidget_3(f_Grid4, 1, 2, (lstAssignments = new ListBox_0 , lstAssignments.element.style['width'] = '300px' , $addDomHandler(lstAssignments, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, TYPE) , this$static.owner.lstAssignments = lstAssignments , lstAssignments)) , f_Grid4.element.style['width'] = '80%' , f_Grid4)) , $add_12(f_VerticalPanel2, (f_HorizontalPanel9 = new HorizontalPanel_0 , $add_10(f_HorizontalPanel9, (f_VerticalPanel10 = new VerticalPanel_0 , $add_12(f_VerticalPanel10, (f_HorizontalPanel11 = new HorizontalPanel_0 , $add_10(f_HorizontalPanel11, (f_Label12 = new Label_0 , f_Label12.element['className'] = 'step' , $setTextOrHtml(f_Label12.directionalTextHelper, '3', false) , $updateHorizontalAlignment(f_Label12) , f_Label12)) , $add_10(f_HorizontalPanel11, (f_Label13 = new Label_0 , f_Label13.element['className'] = 'fieldTitle' , $setTextOrHtml(f_Label13.directionalTextHelper, 'Choisir un \xE9l\xE8ve \xE0 saisir les notes :', false) , $updateHorizontalAlignment(f_Label13) , f_Label13.element.style['height'] = '' , f_Label13.element.style['width'] = '' , f_Label13)) , f_HorizontalPanel11.element.style['width'] = '100%' , f_HorizontalPanel11)) , $add_12(f_VerticalPanel10, (tblBulletinSubjects = this$static.owner.tblBulletinSubjects , tblBulletinSubjects.element.style['height'] = '460px' , tblBulletinSubjects.element.style['width'] = '100%' , tblBulletinSubjects)) , f_VerticalPanel10.element['className'] = 'subSection' , f_VerticalPanel10.element.style['width'] = '100%' , f_VerticalPanel10.table['cellSpacing'] = 2 , f_VerticalPanel10)) , $add_10(f_HorizontalPanel9, (f_VerticalPanel14 = new VerticalPanel_0 , $add_12(f_VerticalPanel14, (f_HorizontalPanel15 = new HorizontalPanel_0 , $add_10(f_HorizontalPanel15, (f_Label16 = new Label_0 , f_Label16.element['className'] = 'step' , $setTextOrHtml(f_Label16.directionalTextHelper, '4', false) , $updateHorizontalAlignment(f_Label16) , f_Label16)) , $add_10(f_HorizontalPanel15, (f_Label17 = new Label_0 , f_Label17.element['className'] = 'fieldTitle' , $setTextOrHtml(f_Label17.directionalTextHelper, 'Chosir une branche \xE0 saisir les notes :', false) , $updateHorizontalAlignment(f_Label17) , f_Label17.element.style['height'] = '' , f_Label17.element.style['width'] = '' , f_Label17)) , f_HorizontalPanel15.element.style['width'] = '100%' , f_HorizontalPanel15)) , $add_12(f_VerticalPanel14, (tblBranches = this$static.owner.tblBranches , tblBranches.element.style['height'] = '250px' , tblBranches.element.style['width'] = '100%' , tblBranches)) , $add_12(f_VerticalPanel14, (f_Label18 = new Label_0 , f_Label18.element['className'] = 'fieldTitle' , $setTextOrHtml(f_Label18.directionalTextHelper, "Moyenne annuelle / semestrielle de l'\xE9l\xE8ve choisit", false) , $updateHorizontalAlignment(f_Label18) , f_Label18)) , $add_12(f_VerticalPanel14, (tblAverageGrade = this$static.owner.tblAverageGrade , tblAverageGrade.element.style['height'] = '150px' , tblAverageGrade.element.style['width'] = '100%' , tblAverageGrade)) , f_VerticalPanel14.element['className'] = 'subSection' , f_VerticalPanel14.element.style['width'] = '100%' , f_VerticalPanel14.table['cellSpacing'] = 2 , f_VerticalPanel14)) , $add_10(f_HorizontalPanel9, (f_VerticalPanel19 = new VerticalPanel_0 , $add_12(f_VerticalPanel19, (pnlNoteInput = new VerticalPanel_0 , $add_12(pnlNoteInput, (f_HorizontalPanel20 = new HorizontalPanel_0 , $setVerticalAlignment(f_HorizontalPanel20, ($clinit_HasVerticalAlignment() , ALIGN_MIDDLE)) , $add_10(f_HorizontalPanel20, (f_Label21 = new Label_0 , f_Label21.element['className'] = 'step' , $setTextOrHtml(f_Label21.directionalTextHelper, '5', false) , $updateHorizontalAlignment(f_Label21) , f_Label21)) , $add_10(f_HorizontalPanel20, (f_Label22 = new Label_0 , f_Label22.element['className'] = 'fieldTitle' , $setTextOrHtml(f_Label22.directionalTextHelper, 'Saisir les notes et les remarques pour :', false) , $updateHorizontalAlignment(f_Label22) , f_Label22)) , f_HorizontalPanel20.element.style['width'] = '100%' , f_HorizontalPanel20)) , $add_12(pnlNoteInput, (lblStudentName = new Label_0 , lblStudentName.element['className'] = 'header' , $setTextOrHtml(lblStudentName.directionalTextHelper, '-', false) , $updateHorizontalAlignment(lblStudentName) , this$static.owner.lblStudentName = lblStudentName , lblStudentName)) , $add_12(pnlNoteInput, (f_Label23 = new Label_0 , f_Label23.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label23.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label23) , f_Label23)) , $add_12(pnlNoteInput, (pnlT1 = new VerticalPanel_0 , $add_12(pnlT1, (f_HorizontalPanel24 = new HorizontalPanel_0 , $add_10(f_HorizontalPanel24, (f_Label25 = new Label_0 , $setTextOrHtml(f_Label25.directionalTextHelper, 'Trimestre 1 :', false) , $updateHorizontalAlignment(f_Label25) , f_Label25.element.style['width'] = '' , f_Label25)) , $add_10(f_HorizontalPanel24, (txt_t_1_1 = new DoubleBox_0 , txt_t_1_1.element['className'] = 'markInputText' , txt_t_1_1.element.style['width'] = '25px' , this$static.owner.txt_t_1_1 = txt_t_1_1 , txt_t_1_1)) , $add_10(f_HorizontalPanel24, (txt_t_1_2 = new DoubleBox_0 , txt_t_1_2.element.style['width'] = '25px' , this$static.owner.txt_t_1_2 = txt_t_1_2 , txt_t_1_2)) , $add_10(f_HorizontalPanel24, (txt_t_1_3 = new DoubleBox_0 , txt_t_1_3.element.style['width'] = '25px' , this$static.owner.txt_t_1_3 = txt_t_1_3 , txt_t_1_3)) , $add_10(f_HorizontalPanel24, (txt_t_1_4 = new DoubleBox_0 , txt_t_1_4.element.style['width'] = '25px' , this$static.owner.txt_t_1_4 = txt_t_1_4 , txt_t_1_4)) , $add_10(f_HorizontalPanel24, (txt_t_1_5 = new DoubleBox_0 , txt_t_1_5.element.style['width'] = '25px' , this$static.owner.txt_t_1_5 = txt_t_1_5 , txt_t_1_5)) , $add_10(f_HorizontalPanel24, (txtT1 = new Label_0 , txtT1.element['className'] = 'averageGrade' , $setTextOrHtml(txtT1.directionalTextHelper, '-', false) , $updateHorizontalAlignment(txtT1) , txtT1.element.style['width'] = '25px' , this$static.owner.txtT1 = txtT1 , txtT1)) , f_HorizontalPanel24.element.style['width'] = '400px' , f_HorizontalPanel24)) , $add_12(pnlT1, (txtRemarque1 = new TextArea_1 , txtRemarque1.element.style['height'] = '40px' , txtRemarque1.element.cols = 50 , txtRemarque1.element.style['width'] = '95%' , this$static.owner.txtRemarque1 = txtRemarque1 , txtRemarque1)) , pnlT1.element.style['width'] = '100%' , pnlT1.table['cellSpacing'] = 5 , this$static.owner.pnlT1 = pnlT1 , pnlT1)) , $add_12(pnlNoteInput, (f_Label26 = new Label_0 , f_Label26.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label26.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label26) , f_Label26)) , $add_12(pnlNoteInput, (pnlT2 = new VerticalPanel_0 , $add_12(pnlT2, (f_HorizontalPanel27 = new HorizontalPanel_0 , $add_10(f_HorizontalPanel27, (f_Label28 = new Label_0 , $setTextOrHtml(f_Label28.directionalTextHelper, 'Trimestre 2 :', false) , $updateHorizontalAlignment(f_Label28) , f_Label28.element.style['width'] = '' , f_Label28)) , $add_10(f_HorizontalPanel27, (txt_t_2_1 = new DoubleBox_0 , txt_t_2_1.element['className'] = 'markInputText' , txt_t_2_1.element.style['width'] = '25px' , this$static.owner.txt_t_2_1 = txt_t_2_1 , txt_t_2_1)) , $add_10(f_HorizontalPanel27, (txt_t_2_2 = new DoubleBox_0 , txt_t_2_2.element.style['width'] = '25px' , this$static.owner.txt_t_2_2 = txt_t_2_2 , txt_t_2_2)) , $add_10(f_HorizontalPanel27, (txt_t_2_3 = new DoubleBox_0 , txt_t_2_3.element.style['width'] = '25px' , this$static.owner.txt_t_2_3 = txt_t_2_3 , txt_t_2_3)) , $add_10(f_HorizontalPanel27, (txt_t_2_4 = new DoubleBox_0 , txt_t_2_4.element.style['width'] = '25px' , this$static.owner.txt_t_2_4 = txt_t_2_4 , txt_t_2_4)) , $add_10(f_HorizontalPanel27, (txt_t_2_5 = new DoubleBox_0 , txt_t_2_5.element.style['width'] = '25px' , this$static.owner.txt_t_2_5 = txt_t_2_5 , txt_t_2_5)) , $add_10(f_HorizontalPanel27, (txtT2 = new Label_0 , txtT2.element['className'] = 'averageGrade' , $setTextOrHtml(txtT2.directionalTextHelper, '-', false) , $updateHorizontalAlignment(txtT2) , txtT2.element.style['width'] = '25px' , this$static.owner.txtT2 = txtT2 , txtT2)) , f_HorizontalPanel27.element.style['width'] = '400px' , f_HorizontalPanel27)) , $add_12(pnlT2, (txtRemarque2 = new TextArea_1 , txtRemarque2.element.style['height'] = '40px' , txtRemarque2.element.cols = 50 , txtRemarque2.element.style['width'] = '95%' , this$static.owner.txtRemarque2 = txtRemarque2 , txtRemarque2)) , pnlT2.element.style['width'] = '100%' , pnlT2.table['cellSpacing'] = 5 , this$static.owner.pnlT2 = pnlT2 , pnlT2)) , $add_12(pnlNoteInput, (f_Label29 = new Label_0 , f_Label29.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label29.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label29) , f_Label29)) , $add_12(pnlNoteInput, (pnlT3 = new VerticalPanel_0 , $add_12(pnlT3, (f_HorizontalPanel30 = new HorizontalPanel_0 , $add_10(f_HorizontalPanel30, (f_Label31 = new Label_0 , $setTextOrHtml(f_Label31.directionalTextHelper, 'Trimestre 3 :', false) , $updateHorizontalAlignment(f_Label31) , f_Label31)) , $add_10(f_HorizontalPanel30, (txt_t_3_1 = new DoubleBox_0 , txt_t_3_1.element.style['width'] = '25px' , this$static.owner.txt_t_3_1 = txt_t_3_1 , txt_t_3_1)) , $add_10(f_HorizontalPanel30, (txt_t_3_2 = new DoubleBox_0 , txt_t_3_2.element.style['width'] = '25px' , this$static.owner.txt_t_3_2 = txt_t_3_2 , txt_t_3_2)) , $add_10(f_HorizontalPanel30, (txt_t_3_3 = new DoubleBox_0 , txt_t_3_3.element.style['width'] = '25px' , this$static.owner.txt_t_3_3 = txt_t_3_3 , txt_t_3_3)) , $add_10(f_HorizontalPanel30, (txt_t_3_4 = new DoubleBox_0 , txt_t_3_4.element.style['width'] = '25px' , this$static.owner.txt_t_3_4 = txt_t_3_4 , txt_t_3_4)) , $add_10(f_HorizontalPanel30, (txt_t_3_5 = new DoubleBox_0 , txt_t_3_5.element.style['width'] = '25px' , this$static.owner.txt_t_3_5 = txt_t_3_5 , txt_t_3_5)) , $add_10(f_HorizontalPanel30, (txtT3 = new Label_0 , txtT3.element['className'] = 'averageGrade' , $setTextOrHtml(txtT3.directionalTextHelper, '-', false) , $updateHorizontalAlignment(txtT3) , txtT3.element.style['width'] = '25px' , this$static.owner.txtT3 = txtT3 , txtT3)) , f_HorizontalPanel30.element.style['width'] = '400px' , f_HorizontalPanel30)) , $add_12(pnlT3, (txtRemarque3 = new TextArea_1 , txtRemarque3.element.style['height'] = '40px' , txtRemarque3.element.cols = 50 , txtRemarque3.element.style['width'] = '95%' , this$static.owner.txtRemarque3 = txtRemarque3 , txtRemarque3)) , pnlT3.element.style['width'] = '100%' , pnlT3.table['cellSpacing'] = 5 , this$static.owner.pnlT3 = pnlT3 , pnlT3)) , $add_12(pnlNoteInput, (f_Label32 = new Label_0 , f_Label32.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label32.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label32) , f_Label32)) , $add_12(pnlNoteInput, (pnlT4 = new VerticalPanel_0 , $add_12(pnlT4, (f_HorizontalPanel33 = new HorizontalPanel_0 , $add_10(f_HorizontalPanel33, (f_Label34 = new Label_0 , $setTextOrHtml(f_Label34.directionalTextHelper, 'Trimestre 4 :', false) , $updateHorizontalAlignment(f_Label34) , f_Label34)) , $add_10(f_HorizontalPanel33, (txt_t_4_1 = new DoubleBox_0 , txt_t_4_1.element.style['width'] = '25px' , this$static.owner.txt_t_4_1 = txt_t_4_1 , txt_t_4_1)) , $add_10(f_HorizontalPanel33, (txt_t_4_2 = new DoubleBox_0 , txt_t_4_2.element.style['width'] = '25px' , this$static.owner.txt_t_4_2 = txt_t_4_2 , txt_t_4_2)) , $add_10(f_HorizontalPanel33, (txt_t_4_3 = new DoubleBox_0 , txt_t_4_3.element.style['width'] = '25px' , this$static.owner.txt_t_4_3 = txt_t_4_3 , txt_t_4_3)) , $add_10(f_HorizontalPanel33, (txt_t_4_4 = new DoubleBox_0 , txt_t_4_4.element.style['width'] = '25px' , this$static.owner.txt_t_4_4 = txt_t_4_4 , txt_t_4_4)) , $add_10(f_HorizontalPanel33, (txt_t_4_5 = new DoubleBox_0 , txt_t_4_5.element.style['width'] = '25px' , this$static.owner.txt_t_4_5 = txt_t_4_5 , txt_t_4_5)) , $add_10(f_HorizontalPanel33, (txtT4 = new Label_0 , txtT4.element['className'] = 'averageGrade' , $setTextOrHtml(txtT4.directionalTextHelper, '-', false) , $updateHorizontalAlignment(txtT4) , txtT4.element.style['width'] = '25px' , this$static.owner.txtT4 = txtT4 , txtT4)) , f_HorizontalPanel33.element.style['width'] = '400px' , f_HorizontalPanel33)) , $add_12(pnlT4, (txtRemarque4 = new TextArea_1 , txtRemarque4.element.style['height'] = '40px' , txtRemarque4.element.cols = 50 , txtRemarque4.element.style['width'] = '95%' , this$static.owner.txtRemarque4 = txtRemarque4 , txtRemarque4)) , pnlT4.element.style['width'] = '100%' , pnlT4.table['cellSpacing'] = 5 , this$static.owner.pnlT4 = pnlT4 , pnlT4)) , $add_12(pnlNoteInput, (cmdSave = new Button_0 , $setInnerText(cmdSave.element, 'Enregistrer') , cmdSave.element.style['width'] = '150px' , $addDomHandler(cmdSave, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames3, ($clinit_ClickEvent() , $clinit_ClickEvent() , TYPE_0)) , this$static.owner.cmdSave = cmdSave , cmdSave)) , pnlNoteInput.element['className'] = 'subSection' , pnlNoteInput.element.style['width'] = '100%' , pnlNoteInput)) , f_VerticalPanel19.element.style['width'] = '100%' , f_VerticalPanel19.table['cellSpacing'] = 2 , f_VerticalPanel19)) , f_HorizontalPanel9.element.style['width'] = '100%' , f_HorizontalPanel9.table['cellSpacing'] = 5 , f_HorizontalPanel9)) , f_VerticalPanel2.element.style['width'] = '100%' , f_VerticalPanel2.table['cellSpacing'] = 2 , f_VerticalPanel2), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(1704, 1, {}, FrmMarkInputView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1705, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmMarkInputView_BinderImpl$Widgets$1_0);
_.onChange = function onChange_36(event_0){
  $onLstProfsChange_1(this.this$1.owner);
}
;
_.this$1 = null;
...
defineSeed(1706, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmMarkInputView_BinderImpl$Widgets$2_0);
...
defineSeed(1707, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmMarkInputView_BinderImpl$Widgets$3_0);
...
defineSeed(1812, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
...
;
defineSeed(1813, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
...
;
defineSeed(1815, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
;
defineSeed(1816, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
defineSeed(1943, 740, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$6X_0);
...
var Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter', 1366), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$1', 1367), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$2', 1368), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$3', 1369), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$4', 1370), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$5', 1371), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$6', 1372), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$7_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$7', 1373), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$8_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$8', 1374), Lcom_lemania_sis_client_event_CheckDeadlineEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'CheckDeadlineEvent', 865), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenterMyProxyImpl$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenterMyProxyImpl$2', 1378), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenterMyProxyImpl$2$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenterMyProxyImpl$2$1', 1379), Lcom_lemania_sis_client_view_FrmMarkInputView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView', 1684), Lcom_lemania_sis_client_view_FrmMarkInputView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$1', 1685), Lcom_lemania_sis_client_view_FrmMarkInputView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$2', 1695), Lcom_lemania_sis_client_view_FrmMarkInputView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$3', 1696), Lcom_lemania_sis_client_view_FrmMarkInputView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$4', 1697), Lcom_lemania_sis_client_view_FrmMarkInputView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$5', 1698), Lcom_lemania_sis_client_view_FrmMarkInputView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$6', 1699), Lcom_lemania_sis_client_view_FrmMarkInputView$7_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$7', 1700), Lcom_lemania_sis_client_view_FrmMarkInputView$8_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$8', 1701), Lcom_lemania_sis_client_view_FrmMarkInputView$9_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$9', 1702), Lcom_lemania_sis_client_view_FrmMarkInputView$10_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$10', 1686), Lcom_lemania_sis_client_view_FrmMarkInputView$11_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$11', 1687), Lcom_lemania_sis_client_view_FrmMarkInputView$12_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$12', 1688), Lcom_lemania_sis_client_view_FrmMarkInputView$13_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$13', 1689), Lcom_lemania_sis_client_view_FrmMarkInputView$14_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$14', 1690), Lcom_lemania_sis_client_view_FrmMarkInputView$15_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$15', 1691), Lcom_lemania_sis_client_view_FrmMarkInputView$16_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$16', 1692), Lcom_lemania_sis_client_view_FrmMarkInputView$17_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$17', 1693), Lcom_lemania_sis_client_view_FrmMarkInputView$18_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$18', 1694), Lcom_lemania_sis_client_view_FrmMarkInputView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView_BinderImpl', 1703), Lcom_lemania_sis_client_view_FrmMarkInputView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView_BinderImpl$Widgets', 1704), Lcom_lemania_sis_client_view_FrmMarkInputView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView_BinderImpl$Widgets$1', 1705), Lcom_lemania_sis_client_view_FrmMarkInputView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView_BinderImpl$Widgets$2', 1706), Lcom_lemania_sis_client_view_FrmMarkInputView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView_BinderImpl$Widgets$3', 1707), Lcom_lemania_sis_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$6X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$6X', 1943);
$entry(onLoad)(17);
