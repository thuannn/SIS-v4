...
defineSeed(1052, 805, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ProfessorAgendaUiHandlers]), ProfessorAgendaPresenter_0);
...
defineSeed(1053, 736, makeCastMap([Q$Receiver]), ProfessorAgendaPresenter$1_0);
...
defineSeed(1054, 736, makeCastMap([Q$Receiver]), ProfessorAgendaPresenter$2_0);
...
defineSeed(1057, 810, makeCastMap([Q$IsWidget, Q$ProfessorAgendaPresenter$MyView]), ProfessorAgendaView_0);
_.colorIndex = 0;
_.lstProfs = null;
_.tblAgenda = null;
...
defineSeed(1058, 1, makeCastMap([Q$MouseOverHandler, Q$EventHandler]), ProfessorAgendaView$1_0);
...
defineSeed(1059, 1, makeCastMap([Q$MouseOutHandler, Q$EventHandler]), ProfessorAgendaView$2_0);
...
defineSeed(1060, 1, makeCastMap([Q$MouseOverHandler, Q$EventHandler]), ProfessorAgendaView$3_0);
...
defineSeed(1061, 1, makeCastMap([Q$MouseOutHandler, Q$EventHandler]), ProfessorAgendaView$4_0);
...
defineSeed(1062, 1, {}, ProfessorAgendaView_BinderImpl_0);
...
defineSeed(1063, 1, {}, ProfessorAgendaView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1064, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfessorAgendaView_BinderImpl$Widgets$1_0);
...
defineSeed(1885, 740, makeCastMap([Q$AbstractRequest]), MasterAgendaItemRequestFactory_MasterAgendaItemRequestContextImpl$5X_0);
...
defineSeed(1997, 740, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$4X_0);
...
;
var Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaPresenter_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaPresenter', 1052), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaPresenter$1_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaPresenter$1', 1053), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaPresenter$2_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaPresenter$2', 1054), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView', 1057), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView$1_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView$1', 1058), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView$2_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView$2', 1059), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView$3_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView$3', 1060), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView$4_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView$4', 1061), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView_BinderImpl', 1062), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView_BinderImpl$Widgets', 1063), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView_BinderImpl$Widgets$1', 1064), Lcom_lemania_sis_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$4X', 1997), Lcom_lemania_sis_shared_masteragendaitem_MasterAgendaItemRequestFactory_1MasterAgendaItemRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.masteragendaitem.', 'MasterAgendaItemRequestFactory_MasterAgendaItemRequestContextImpl$5X', 1885);
$entry(onLoad)(31);
