...
defineSeed(777, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ContactPresenter, Q$ContactUiHandler]), ContactPresenter_0);
...
defineSeed(778, 644, makeCastMap([Q$Receiver]), ContactPresenter$1_0);
...
defineSeed(1150, 710, makeCastMap([Q$IsWidget, Q$ContactPresenter$MyView]), ContactView_0);
...
defineSeed(1151, 1, {}, ContactView_BinderImpl_0);
...
defineSeed(1152, 1, {}, ContactView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1153, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ContactView_BinderImpl$Widgets$1_0);
...
defineSeed(1590, 639, {}, ContactRequestFactoryImpl_0);
...
defineSeed(1591, 649, makeCastMap([Q$AbstractRequestContext]), ContactRequestFactory_ContactRequestContextImpl_0);
...
defineSeed(1592, 648, makeCastMap([Q$AbstractRequest]), ContactRequestFactory_ContactRequestContextImpl$1X_0);
...
defineSeed(1593, 577, makeCastMap([Q$EnumMap]), ContactRequestFactory_ContactRequestContextImpl_FactoryImpl_0);
