...
defineSeed(863, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinViewSummaryPresenter, Q$FrmBulletinViewSummaryUiHandler]), FrmBulletinViewSummaryPresenter_0);
...
defineSeed(864, 630, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$1_0);
...
defineSeed(865, 630, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$2_0);
...
defineSeed(866, 630, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$3_0);
...
defineSeed(867, 630, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$4_0);
...
defineSeed(1183, 696, makeCastMap([Q$IsWidget, Q$FrmBulletinViewSummaryPresenter$MyView]), FrmBulletinViewSummaryView_0);
...
defineSeed(1184, 496, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]), FrmBulletinViewSummaryView$1_0);
...
defineSeed(1185, 1, makeCastMap([Q$CloseHandler, Q$EventHandler]), FrmBulletinViewSummaryView$2_0);
...
defineSeed(1186, 1, {}, FrmBulletinViewSummaryView_BinderImpl_0);
...
defineSeed(1187, 1, {}, FrmBulletinViewSummaryView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1188, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$1_0);
...
defineSeed(1189, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$2_0);
...
defineSeed(1190, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$3_0);
...
defineSeed(1191, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$4_0);
...
defineSeed(1437, 634, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$12X_0);
...
var Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter', 863), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter$1', 864), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter$2', 865), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter$3', 866), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter$4', 867), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView', 1183), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView$1', 1184), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView$2', 1185), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl', 1186), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets', 1187), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$1', 1188), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$2', 1189), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$3', 1190), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$4', 1191), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$12X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$12X', 1437);
$entry(onLoad)(11);
