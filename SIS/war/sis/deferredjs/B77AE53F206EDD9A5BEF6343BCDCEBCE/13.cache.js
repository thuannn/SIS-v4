...
defineSeed(898, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(899, 644, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(900, 644, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(901, 644, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(902, 644, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1261, 710, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1262, 366, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(1264, 366, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1576, 648, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1580, 648, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
