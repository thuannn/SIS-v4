...
defineSeed(965, 687, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(966, 626, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(967, 626, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(968, 626, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(985, 700, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(986, 1, {}, MainPagePresenterMyProxyImpl$5$1_0);
...
defineSeed(1355, 692, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1662, 630, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
