...
defineSeed(828, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$1_0);
...
defineSeed(829, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$10_0);
...
defineSeed(830, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$11_0);
...
defineSeed(831, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$12_0);
...
defineSeed(832, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$13_0);
...
defineSeed(833, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$14_0);
...
defineSeed(835, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$16_0);
...
defineSeed(836, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$2_0);
...
defineSeed(837, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$3_0);
...
defineSeed(838, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$4_0);
...
defineSeed(839, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$5_0);
...
defineSeed(840, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$6_0);
...
defineSeed(841, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$7_0);
...
defineSeed(842, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$8_0);
...
defineSeed(843, 626, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$9_0);
...
defineSeed(1198, 692, makeCastMap([Q$IsWidget, Q$FrmBulletinManagementPresenter$MyView]), FrmBulletinManagementView_0);
...
defineSeed(1199, 383, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$1_0);
...
defineSeed(1200, 383, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$10_0);
...
defineSeed(1201, 357, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$11_0);
...
defineSeed(1202, 1, {}, FrmBulletinManagementView$12_0);
...
defineSeed(1203, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinManagementView$13_0);
...
defineSeed(1204, 383, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$14_0);
...
defineSeed(1205, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinManagementView$15_0);
...
defineSeed(1206, 357, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$2_0);
...
defineSeed(1207, 1, {}, FrmBulletinManagementView$3_0);
...
defineSeed(1208, 357, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$4_0);
...
defineSeed(1209, 1, {}, FrmBulletinManagementView$5_0);
...
defineSeed(1210, 383, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$6_0);
...
defineSeed(1211, 357, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$7_0);
...
defineSeed(1212, 1, {}, FrmBulletinManagementView$8_0);
...
defineSeed(1213, 383, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$9_0);
...
defineSeed(1214, 1, {}, FrmBulletinManagementView_BinderImpl_0);
...
defineSeed(1215, 1, {}, FrmBulletinManagementView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1216, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$1_0);
...
defineSeed(1217, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$2_0);
...
defineSeed(1218, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$3_0);
...
defineSeed(1219, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$4_0);
...
defineSeed(1220, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$5_0);
...
defineSeed(1221, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$6_0);
...
defineSeed(1473, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
...
;
defineSeed(1474, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
_.setBrancheCoef = function setBrancheCoef_0(brancheCoef){
  $setProperty(this.this$0, 'brancheCoef', brancheCoef);
}
;
defineSeed(1479, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
;
defineSeed(1480, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
defineSeed(1539, 630, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X_0);
...
defineSeed(1543, 630, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X_0);
...
defineSeed(1559, 630, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X_0);
...
defineSeed(1562, 630, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X_0);
...
defineSeed(1654, 630, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$4X_0);
...
;
_.val$bulletin = null;
var Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter', 827), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$1', 828), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$2', 836), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$3', 837), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$4', 838), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$5', 839), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$6', 840), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$7_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$7', 841), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$8_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$8', 842), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$9_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$9', 843), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$10_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$10', 829), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$11_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$11', 830), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$12_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$12', 831), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$13_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$13', 832), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$14_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$14', 833), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$16_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$16', 835), Lcom_lemania_sis_client_view_FrmBulletinManagementView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView', 1198), Lcom_lemania_sis_client_view_FrmBulletinManagementView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$1', 1199), Lcom_lemania_sis_client_view_FrmBulletinManagementView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$2', 1206), Lcom_lemania_sis_client_view_FrmBulletinManagementView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$3', 1207), Lcom_lemania_sis_client_view_FrmBulletinManagementView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$4', 1208), Lcom_lemania_sis_client_view_FrmBulletinManagementView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$5', 1209), Lcom_lemania_sis_client_view_FrmBulletinManagementView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$6', 1210), Lcom_lemania_sis_client_view_FrmBulletinManagementView$7_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$7', 1211), Lcom_lemania_sis_client_view_FrmBulletinManagementView$8_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$8', 1212), Lcom_lemania_sis_client_view_FrmBulletinManagementView$9_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$9', 1213), Lcom_lemania_sis_client_view_FrmBulletinManagementView$10_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$10', 1200), Lcom_lemania_sis_client_view_FrmBulletinManagementView$11_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$11', 1201), Lcom_lemania_sis_client_view_FrmBulletinManagementView$12_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$12', 1202), Lcom_lemania_sis_client_view_FrmBulletinManagementView$13_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$13', 1203), Lcom_lemania_sis_client_view_FrmBulletinManagementView$14_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$14', 1204), Lcom_lemania_sis_client_view_FrmBulletinManagementView$15_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$15', 1205), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl', 1214), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets', 1215), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$1', 1216), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$2', 1217), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$3', 1218), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$4', 1219), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$5', 1220), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$6', 1221), Lcom_lemania_sis_shared_service_SubjectRequestFactory_1SubjectRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'SubjectRequestFactory_SubjectRequestContextImpl$4X', 1654), Lcom_lemania_sis_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X', 1562), Lcom_lemania_sis_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$10X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X', 1559), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X', 1543), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$10X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X', 1539);
$entry(onLoad)(9);
