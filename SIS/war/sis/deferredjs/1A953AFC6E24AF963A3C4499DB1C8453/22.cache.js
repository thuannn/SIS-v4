...
defineSeed(743, 230, {}, StudentAfterAddEvent_0);
...
defineSeed(989, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAddPresenter, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(990, 619, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(1009, 619, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(1014, 693, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1314, 685, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1507, 623, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
