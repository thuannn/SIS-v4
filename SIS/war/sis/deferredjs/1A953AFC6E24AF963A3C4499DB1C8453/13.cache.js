...
defineSeed(871, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(872, 619, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(873, 619, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(874, 619, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(875, 619, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1189, 685, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1190, 354, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(1192, 354, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1445, 623, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1449, 623, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
