...
defineSeed(737, 230, {}, DrawSchoolInterfaceEvent_0);
...
;
defineSeed(857, 711, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(858, 693, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1_0);
...
defineSeed(914, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(915, 619, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(916, 619, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(917, 619, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(934, 693, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1242, 685, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1520, 623, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
