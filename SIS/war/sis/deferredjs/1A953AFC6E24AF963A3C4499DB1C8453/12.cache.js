...
defineSeed(863, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseAddPresenter, Q$FrmClasseAddUiHandler]), FrmClasseAddPresenter_0);
...
defineSeed(864, 619, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$1_0);
...
defineSeed(865, 619, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$2_0);
...
defineSeed(866, 619, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$3_0);
...
defineSeed(1182, 685, makeCastMap([Q$IsWidget, Q$FrmClasseAddPresenter$MyView]), FrmClasseAddView_0);
...
defineSeed(1448, 623, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$8X_0);
