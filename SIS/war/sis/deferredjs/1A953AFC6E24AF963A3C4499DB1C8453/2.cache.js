...
defineSeed(736, 230, {}, CoursAddedEvent_0);
...
defineSeed(756, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursAddPresenter, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(757, 619, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(758, 619, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(768, 711, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(769, 693, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(770, 1, {}, CoursPresenterMyProxyImpl$1$1_0);
...
defineSeed(1080, 685, makeCastMap([Q$IsWidget, Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(1459, 623, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
