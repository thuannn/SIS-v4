...
defineSeed(741, 230, {}, ProfessorAfterAddEvent_0);
...
defineSeed(958, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsAddPresenter, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(959, 619, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(1010, 619, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(1016, 693, {}, UserManagementPresenterMyProxyImpl$2_0);
...
defineSeed(1280, 685, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1474, 623, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
