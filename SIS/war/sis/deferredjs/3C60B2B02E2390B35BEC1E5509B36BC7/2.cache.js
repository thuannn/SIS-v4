...
defineSeed(844, 738, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ContactPresenter, Q$ContactUiHandler]), ContactPresenter_0);
...
defineSeed(845, 677, makeCastMap([Q$Receiver]), ContactPresenter$1_0);
_.onFailure_0 = function onFailure_7(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_7(response){
  $onSuccess_5(this, throwClassCastExceptionUnlessNull(response));
}
;
_.this$0 = null;
...
function ContactView_0(){
  this.widget = $build_f_HTMLPanel1_1(new ContactView_BinderImpl$Widgets_0(this));
}

defineSeed(1220, 743, makeCastMap([Q$IsWidget, Q$ContactPresenter$MyView]), ContactView_0);
...
defineSeed(1221, 1, {}, ContactView_BinderImpl_0);
function $build_f_HTMLPanel1_1(this$static){
  ...
  $addAndReplaceElement(f_HTMLPanel1, (f_VerticalPanel2 = new VerticalPanel_0 , $add_12(f_VerticalPanel2, (f_Label3 = new Label_0 , f_Label3.element['className'] = 'pageTitle' , $setHorizontalAlignment(f_Label3, ($clinit_HasHorizontalAlignment() , ALIGN_CENTER)) , $setTextOrHtml(f_Label3.directionalTextHelper, 'CONTACT', false) , $updateHorizontalAlignment(f_Label3) , f_Label3)) , $add_12(f_VerticalPanel2, (f_VerticalPanel4 = new VerticalPanel_0 , $add_12(f_VerticalPanel4, (f_Label5 = new Label_0 , $setTextOrHtml(f_Label5.directionalTextHelper, 'Nous sommes \xE0 votre disposition pour toutes vos questions ou conseils. Merci de nous contacter en utilisant le formulaire ci-dessous.', false) , $updateHorizontalAlignment(f_Label5) , f_Label5)) , $add_12(f_VerticalPanel4, (f_Grid6 = new Grid_0 , $resizeColumns(f_Grid6, 2) , $resizeRows(f_Grid6, 5) , $setWidget_2(f_Grid6, 0, 0, (f_Label7 = new Label_0 , $setTextOrHtml(f_Label7.directionalTextHelper, 'Nom :', false) , $updateHorizontalAlignment(f_Label7) , f_Label7)) , $setWidget_2(f_Grid6, 0, 1, (txtLastName = new TextBox_0 , txtLastName.element['className'] = 'sis_textbox' , this$static.owner.txtLastName = txtLastName , txtLastName)) , $setWidget_2(f_Grid6, 1, 0, (f_Label8 = new Label_0 , $setTextOrHtml(f_Label8.directionalTextHelper, 'Pr\xE9nom :', false) , $updateHorizontalAlignment(f_Label8) , f_Label8)) , $setWidget_2(f_Grid6, 1, 1, (txtFirstName = new TextBox_0 , txtFirstName.element['className'] = 'sis_textbox' , this$static.owner.txtFirstName = txtFirstName , txtFirstName)) , $setWidget_2(f_Grid6, 2, 0, (f_Label9 = new Label_0 , $setTextOrHtml(f_Label9.directionalTextHelper, 'Email :', false) , $updateHorizontalAlignment(f_Label9) , f_Label9)) , $setWidget_2(f_Grid6, 2, 1, (txtEmail = new TextBox_0 , txtEmail.element['className'] = 'sis_textbox' , this$static.owner.txtEmail = txtEmail , txtEmail)) , $setWidget_2(f_Grid6, 3, 0, (f_Label10 = new Label_0 , $setTextOrHtml(f_Label10.directionalTextHelper, 'Message :', false) , $updateHorizontalAlignment(f_Label10) , f_Label10)) , $setWidget_2(f_Grid6, 3, 1, (txtMessage = new TextArea_1 , txtMessage.element.style['height'] = '300px' , txtMessage.element.style['width'] = '478px' , this$static.owner.txtMessage = txtMessage , txtMessage)) , $setWidget_2(f_Grid6, 4, 0, (f_Label11 = new Label_0 , f_Label11.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label11.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label11) , f_Label11)) , $setWidget_2(f_Grid6, 4, 1, (cmdSend = new Button_0 , $setHTML(cmdSend, (sb = new StringBuilder_0 , $append_1(sb.data, 'Envoyer') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb.data))).html) , cmdSend.element.style['width'] = '100px' , $addDomHandler(cmdSend, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_ClickEvent() , $clinit_ClickEvent() , TYPE_0)) , cmdSend)) , f_Grid6.element['className'] = 'subSection' , f_Grid6.element.style['width'] = '600px' , f_Grid6.tableElem['cellPadding'] = 5 , f_Grid6)) , f_VerticalPanel4.element.style['width'] = '100%' , f_VerticalPanel4.table['cellSpacing'] = 20 , f_VerticalPanel4)) , f_VerticalPanel2.element.style['width'] = '100%' , f_VerticalPanel2.table['cellSpacing'] = 2 , f_VerticalPanel2), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(1222, 1, {}, ContactView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1223, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ContactView_BinderImpl$Widgets$1_0);
...
defineSeed(1669, 672, {}, ContactRequestFactoryImpl_0);
...
defineSeed(1670, 682, makeCastMap([Q$AbstractRequestContext]), ContactRequestFactory_ContactRequestContextImpl_0);
...
defineSeed(1671, 681, makeCastMap([Q$AbstractRequest]), ContactRequestFactory_ContactRequestContextImpl$1X_0);
...
defineSeed(1672, 610, makeCastMap([Q$EnumMap]), ContactRequestFactory_ContactRequestContextImpl_FactoryImpl_0);
...
;
var Lcom_lemania_sis_client_presenter_ContactPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ContactPresenter', 844), Lcom_lemania_sis_client_presenter_ContactPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ContactPresenter$1', 845), Lcom_lemania_sis_client_view_ContactView_2_classLit = createForClass('com.lemania.sis.client.view.', 'ContactView', 1220), Lcom_lemania_sis_client_view_ContactView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'ContactView_BinderImpl', 1221), Lcom_lemania_sis_client_view_ContactView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'ContactView_BinderImpl$Widgets', 1222), Lcom_lemania_sis_client_view_ContactView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'ContactView_BinderImpl$Widgets$1', 1223), Lcom_lemania_sis_shared_service_ContactRequestFactoryImpl_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ContactRequestFactoryImpl', 1669), Lcom_lemania_sis_shared_service_ContactRequestFactory_1ContactRequestContextImpl_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl', 1670), Lcom_lemania_sis_shared_service_ContactRequestFactory_1ContactRequestContextImpl$1X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl$1X', 1671), Lcom_lemania_sis_shared_service_ContactRequestFactory_1ContactRequestContextImpl_1FactoryImpl_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl_FactoryImpl', 1672);
$entry(onLoad)(2);
