...
defineSeed(1117, 738, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$SettingsPresenter, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(1118, 677, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(1119, 677, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
;
_.this$0 = null;
function $onSuccess_122(this$static){
  $setText_0(dynamicCast(dynamicCast(this$static.this$0.view, Q$SettingsPresenter$MyView), Q$SettingsView).lblUpdateStatus, 'Setting saved.');
}
...
defineSeed(1120, 677, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
_.onFailure_0 = function onFailure_128(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_128(response){
  $onSuccess_122(this, throwClassCastExceptionUnlessNull(response));
}
;
_.this$0 = null;
function $onSuccess_123(this$static){
  $setText_0(dynamicCast(dynamicCast(this$static.this$0.view, Q$SettingsPresenter$MyView), Q$SettingsView).lblUpdateStatus, 'Setting saved.');
}
...
defineSeed(1121, 677, makeCastMap([Q$Receiver]), SettingsPresenter$4_0);
_.onFailure_0 = function onFailure_129(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_129(response){
  $onSuccess_123(this, throwClassCastExceptionUnlessNull(response));
}
;
_.this$0 = null;
...
defineSeed(1122, 677, makeCastMap([Q$Receiver]), SettingsPresenter$5_0);
...
;
function $onSuccess_124(this$static){
  $setText_0(dynamicCast(dynamicCast(this$static.this$0.view, Q$SettingsPresenter$MyView), Q$SettingsView).lblUpdateStatus, 'Setting saved.');
}
...
defineSeed(1123, 677, makeCastMap([Q$Receiver]), SettingsPresenter$6_0);
_.onFailure_0 = function onFailure_131(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_131(response){
  $onSuccess_124(this, throwClassCastExceptionUnlessNull(response));
}
;
_.this$0 = null;
...
function SettingsView_0(){
  this.widget = $build_f_HTMLPanel1_25(new SettingsView_BinderImpl$Widgets_0(this));
}

defineSeed(1513, 743, makeCastMap([Q$IsWidget, Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
function $build_f_HTMLPanel1_25(this$static){
  ...
  $addAndReplaceElement(f_HTMLPanel1, (f_VerticalPanel2 = new VerticalPanel_0 , $add_12(f_VerticalPanel2, (f_Label3 = new Label_0 , f_Label3.element['className'] = 'pageTitle' , $setHorizontalAlignment(f_Label3, ($clinit_HasHorizontalAlignment() , ALIGN_CENTER)) , $setTextOrHtml(f_Label3.directionalTextHelper, "GESTION DE L'ACCES", false) , $updateHorizontalAlignment(f_Label3) , f_Label3)) , $add_12(f_VerticalPanel2, (f_Label4 = new Label_0 , $setTextOrHtml(f_Label4.directionalTextHelper, 'Choisir la date de blocage pour chaque trimestre de chaque programme.', false) , $updateHorizontalAlignment(f_Label4) , f_Label4)) , $add_12(f_VerticalPanel2, (f_VerticalPanel5 = new VerticalPanel_0 , $add_12(f_VerticalPanel5, (f_HorizontalPanel6 = new HorizontalPanel_0 , $add_10(f_HorizontalPanel6, (f_VerticalPanel7 = new VerticalPanel_0 , $add_12(f_VerticalPanel7, (f_Label8 = new Label_0 , f_Label8.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label8.directionalTextHelper, 'Maturit\xE9 Suisse', false) , $updateHorizontalAlignment(f_Label8) , f_Label8)) , $add_12(f_VerticalPanel7, (f_Grid9 = new Grid_0 , $resizeColumns(f_Grid9, 4) , $resizeRows(f_Grid9, 5) , $setWidget_2(f_Grid9, 0, 0, (f_Label10 = new Label_0 , f_Label10.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label10.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label10) , f_Label10)) , $setWidget_2(f_Grid9, 0, 1, (f_Label11 = new Label_0 , $setTextOrHtml(f_Label11.directionalTextHelper, 'Jour', false) , $updateHorizontalAlignment(f_Label11) , f_Label11)) , $setWidget_2(f_Grid9, 0, 2, (f_Label12 = new Label_0 , $setTextOrHtml(f_Label12.directionalTextHelper, 'Mois', false) , $updateHorizontalAlignment(f_Label12) , f_Label12)) , $setWidget_2(f_Grid9, 0, 3, (f_Label13 = new Label_0 , $setTextOrHtml(f_Label13.directionalTextHelper, 'Ann\xE9e', false) , $updateHorizontalAlignment(f_Label13) , f_Label13)) , $setWidget_2(f_Grid9, 1, 0, (f_Label14 = new Label_0 , $setTextOrHtml(f_Label14.directionalTextHelper, 'Trimestre 1 :', false) , $updateHorizontalAlignment(f_Label14) , f_Label14)) , $setWidget_2(f_Grid9, 1, 1, (dayMatuT1 = new ListBox_0 , this$static.owner.dayMatuT1 = dayMatuT1 , dayMatuT1)) , $setWidget_2(f_Grid9, 1, 2, (monthMatuT1 = new ListBox_0 , this$static.owner.monthMatuT1 = monthMatuT1 , monthMatuT1)) , $setWidget_2(f_Grid9, 1, 3, (yearMatuT1 = new ListBox_0 , this$static.owner.yearMatuT1 = yearMatuT1 , yearMatuT1)) , $setWidget_2(f_Grid9, 2, 0, (f_Label15 = new Label_0 , $setTextOrHtml(f_Label15.directionalTextHelper, 'Trimestre 2 :', false) , $updateHorizontalAlignment(f_Label15) , f_Label15)) , $setWidget_2(f_Grid9, 2, 1, (dayMatuT2 = new ListBox_0 , this$static.owner.dayMatuT2 = dayMatuT2 , dayMatuT2)) , $setWidget_2(f_Grid9, 2, 2, (monthMatuT2 = new ListBox_0 , this$static.owner.monthMatuT2 = monthMatuT2 , monthMatuT2)) , $setWidget_2(f_Grid9, 2, 3, (yearMatuT2 = new ListBox_0 , this$static.owner.yearMatuT2 = yearMatuT2 , yearMatuT2)) , $setWidget_2(f_Grid9, 3, 0, (f_Label16 = new Label_0 , f_Label16.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label16.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label16) , f_Label16.element.style['height'] = '26px' , f_Label16)) , $setWidget_2(f_Grid9, 4, 0, (f_Label17 = new Label_0 , f_Label17.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label17.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label17) , f_Label17)) , $setWidget_2(f_Grid9, 4, 1, (cmdSaveDateMatu = new Button_0 , $setInnerText(cmdSaveDateMatu.element, 'Enregistrer') , $addDomHandler(cmdSaveDateMatu, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames3, ($clinit_ClickEvent() , $clinit_ClickEvent() , TYPE_0)) , cmdSaveDateMatu)) , f_Grid9.tableElem['cellSpacing'] = 5 , f_Grid9.tableElem['cellPadding'] = 5 , f_Grid9)) , f_VerticalPanel7.element['className'] = 'subSection' , f_VerticalPanel7.element.style['width'] = '' , f_VerticalPanel7)) , $add_10(f_HorizontalPanel6, (f_VerticalPanel18 = new VerticalPanel_0 , $add_12(f_VerticalPanel18, (f_Label19 = new Label_0 , f_Label19.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label19.directionalTextHelper, 'Baccalaur\xE9at Fran\xE7ais', false) , $updateHorizontalAlignment(f_Label19) , f_Label19)) , $add_12(f_VerticalPanel18, (f_Grid20 = new Grid_0 , $resizeColumns(f_Grid20, 4) , $resizeRows(f_Grid20, 5) , $setWidget_2(f_Grid20, 0, 0, (f_Label21 = new Label_0 , f_Label21.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label21.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label21) , f_Label21)) , $setWidget_2(f_Grid20, 0, 1, (f_Label22 = new Label_0 , $setTextOrHtml(f_Label22.directionalTextHelper, 'Jour', false) , $updateHorizontalAlignment(f_Label22) , f_Label22)) , $setWidget_2(f_Grid20, 0, 2, (f_Label23 = new Label_0 , $setTextOrHtml(f_Label23.directionalTextHelper, 'Mois', false) , $updateHorizontalAlignment(f_Label23) , f_Label23)) , $setWidget_2(f_Grid20, 0, 3, (f_Label24 = new Label_0 , $setTextOrHtml(f_Label24.directionalTextHelper, 'Ann\xE9e', false) , $updateHorizontalAlignment(f_Label24) , f_Label24)) , $setWidget_2(f_Grid20, 1, 0, (f_Label25 = new Label_0 , $setTextOrHtml(f_Label25.directionalTextHelper, 'Trimestre 1 :', false) , $updateHorizontalAlignment(f_Label25) , f_Label25)) , $setWidget_2(f_Grid20, 1, 1, (dayBacT1 = new ListBox_0 , this$static.owner.dayBacT1 = dayBacT1 , dayBacT1)) , $setWidget_2(f_Grid20, 1, 2, (monthBacT1 = new ListBox_0 , this$static.owner.monthBacT1 = monthBacT1 , monthBacT1)) , $setWidget_2(f_Grid20, 1, 3, (yearBacT1 = new ListBox_0 , this$static.owner.yearBacT1 = yearBacT1 , yearBacT1)) , $setWidget_2(f_Grid20, 2, 0, (f_Label26 = new Label_0 , $setTextOrHtml(f_Label26.directionalTextHelper, 'Trimestre 2 :', false) , $updateHorizontalAlignment(f_Label26) , f_Label26)) , $setWidget_2(f_Grid20, 2, 1, (dayBacT2 = new ListBox_0 , this$static.owner.dayBacT2 = dayBacT2 , dayBacT2)) , $setWidget_2(f_Grid20, 2, 2, (monthBacT2 = new ListBox_0 , this$static.owner.monthBacT2 = monthBacT2 , monthBacT2)) , $setWidget_2(f_Grid20, 2, 3, (yearBacT2 = new ListBox_0 , this$static.owner.yearBacT2 = yearBacT2 , yearBacT2)) , $setWidget_2(f_Grid20, 3, 0, (f_Label27 = new Label_0 , $setTextOrHtml(f_Label27.directionalTextHelper, 'Trimestre 3 :', false) , $updateHorizontalAlignment(f_Label27) , f_Label27)) , $setWidget_2(f_Grid20, 3, 1, (dayBacT3 = new ListBox_0 , this$static.owner.dayBacT3 = dayBacT3 , dayBacT3)) , $setWidget_2(f_Grid20, 3, 2, (monthBacT3 = new ListBox_0 , this$static.owner.monthBacT3 = monthBacT3 , monthBacT3)) , $setWidget_2(f_Grid20, 3, 3, (yearBacT3 = new ListBox_0 , this$static.owner.yearBacT3 = yearBacT3 , yearBacT3)) , $setWidget_2(f_Grid20, 4, 0, (f_Label28 = new Label_0 , f_Label28.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label28.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label28) , f_Label28)) , $setWidget_2(f_Grid20, 4, 1, (cmdSaveDateBac = new Button_0 , $setInnerText(cmdSaveDateBac.element, 'Enregistrer') , $addDomHandler(cmdSaveDateBac, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames5, TYPE_0) , cmdSaveDateBac)) , f_Grid20.tableElem['cellSpacing'] = 5 , f_Grid20.tableElem['cellPadding'] = 5 , f_Grid20)) , f_VerticalPanel18.element['className'] = 'subSection' , f_VerticalPanel18)) , f_HorizontalPanel6.table['cellSpacing'] = 5 , f_HorizontalPanel6)) , $add_12(f_VerticalPanel5, (f_HorizontalPanel29 = new HorizontalPanel_0 , $add_10(f_HorizontalPanel29, (f_VerticalPanel30 = new VerticalPanel_0 , $add_12(f_VerticalPanel30, (f_Label31 = new Label_0 , f_Label31.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label31.directionalTextHelper, 'Etudes Secondaires', false) , $updateHorizontalAlignment(f_Label31) , f_Label31)) , $add_12(f_VerticalPanel30, (f_Grid32 = new Grid_0 , $resizeColumns(f_Grid32, 4) , $resizeRows(f_Grid32, 4) , $setWidget_2(f_Grid32, 0, 0, (f_Label33 = new Label_0 , $setTextOrHtml(f_Label33.directionalTextHelper, 'Trimestre 1 :', false) , $updateHorizontalAlignment(f_Label33) , f_Label33)) , $setWidget_2(f_Grid32, 0, 1, (dayEST1 = new ListBox_0 , this$static.owner.dayEST1 = dayEST1 , dayEST1)) , $setWidget_2(f_Grid32, 0, 2, (monthEST1 = new ListBox_0 , this$static.owner.monthEST1 = monthEST1 , monthEST1)) , $setWidget_2(f_Grid32, 0, 3, (yearEST1 = new ListBox_0 , this$static.owner.yearEST1 = yearEST1 , yearEST1)) , $setWidget_2(f_Grid32, 1, 0, (f_Label34 = new Label_0 , $setTextOrHtml(f_Label34.directionalTextHelper, 'Trimestre 2 :', false) , $updateHorizontalAlignment(f_Label34) , f_Label34)) , $setWidget_2(f_Grid32, 1, 1, (dayEST2 = new ListBox_0 , this$static.owner.dayEST2 = dayEST2 , dayEST2)) , $setWidget_2(f_Grid32, 1, 2, (monthEST2 = new ListBox_0 , this$static.owner.monthEST2 = monthEST2 , monthEST2)) , $setWidget_2(f_Grid32, 1, 3, (yearEST2 = new ListBox_0 , this$static.owner.yearEST2 = yearEST2 , yearEST2)) , $setWidget_2(f_Grid32, 2, 0, (f_Label35 = new Label_0 , $setTextOrHtml(f_Label35.directionalTextHelper, 'Trimestre 3 :', false) , $updateHorizontalAlignment(f_Label35) , f_Label35)) , $setWidget_2(f_Grid32, 2, 1, (dayEST3 = new ListBox_0 , this$static.owner.dayEST3 = dayEST3 , dayEST3)) , $setWidget_2(f_Grid32, 2, 2, (monthEST3 = new ListBox_0 , this$static.owner.monthEST3 = monthEST3 , monthEST3)) , $setWidget_2(f_Grid32, 2, 3, (yearEST3 = new ListBox_0 , this$static.owner.yearEST3 = yearEST3 , yearEST3)) , $setWidget_2(f_Grid32, 3, 0, (f_Label36 = new Label_0 , f_Label36.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label36.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label36) , f_Label36)) , $setWidget_2(f_Grid32, 3, 1, (cmdSaveDateES = new Button_0 , $setInnerText(cmdSaveDateES.element, 'Enregistrer') , $addDomHandler(cmdSaveDateES, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames4, TYPE_0) , cmdSaveDateES)) , f_Grid32.tableElem['cellSpacing'] = 5 , f_Grid32.tableElem['cellPadding'] = 5 , f_Grid32)) , f_VerticalPanel30.element['className'] = 'subSection' , f_VerticalPanel30.element.style['width'] = '' , f_VerticalPanel30)) , f_HorizontalPanel29.table['cellSpacing'] = 5 , f_HorizontalPanel29)) , $add_12(f_VerticalPanel5, (pnlAdmin = new FlowPanel_0 , $add_8(pnlAdmin, (f_Label37 = new Label_0 , f_Label37.element['className'] = 'sectionTitle' , $setTextOrHtml(f_Label37.directionalTextHelper, 'Admin', false) , $updateHorizontalAlignment(f_Label37) , f_Label37)) , $add_8(pnlAdmin, (f_Grid38 = new Grid_0 , $resizeColumns(f_Grid38, 4) , $resizeRows(f_Grid38, 4) , $setWidget_2(f_Grid38, 0, 0, (f_Label39 = new Label_0 , $setTextOrHtml(f_Label39.directionalTextHelper, "Bloquer automatiquement l'acc\xE8s au syst\xE8me le", false) , $updateHorizontalAlignment(f_Label39) , f_Label39)) , $setWidget_2(f_Grid38, 0, 1, (lstDays = new ListBox_0 , this$static.owner.lstDays = lstDays , lstDays)) , $setWidget_2(f_Grid38, 0, 2, (f_Label40 = new Label_0 , $setTextOrHtml(f_Label40.directionalTextHelper, 'tous les mois.', false) , $updateHorizontalAlignment(f_Label40) , f_Label40)) , $setWidget_2(f_Grid38, 1, 0, (f_Label41 = new Label_0 , $setTextOrHtml(f_Label41.directionalTextHelper, "Bloquer l'acc\xE8s d\xE8s MAINTENANT", false) , $updateHorizontalAlignment(f_Label41) , f_Label41)) , $setWidget_2(f_Grid38, 1, 1, (blnBlock = new SimpleCheckBox_0 , this$static.owner.blnBlock = blnBlock , blnBlock)) , $setWidget_2(f_Grid38, 2, 0, (f_Label42 = new Label_0 , $setTextOrHtml(f_Label42.directionalTextHelper, 'Ecole :', false) , $updateHorizontalAlignment(f_Label42) , f_Label42)) , $setWidget_2(f_Grid38, 2, 1, (lstEcoles = new ListBox_0 , this$static.owner.lstEcoles = lstEcoles , lstEcoles)) , $setWidget_2(f_Grid38, 2, 2, (f_Label43 = new Label_0 , $setTextOrHtml(f_Label43.directionalTextHelper, '', false) , $updateHorizontalAlignment(f_Label43) , f_Label43)) , $setWidget_2(f_Grid38, 2, 3, (lblUpdateStatus = new Label_0 , this$static.owner.lblUpdateStatus = lblUpdateStatus , lblUpdateStatus)) , $setWidget_2(f_Grid38, 3, 0, new Label_0) , $setWidget_2(f_Grid38, 3, 1, (cmdSave = new Button_0 , $setInnerText(cmdSave.element, 'Enregistrer') , $addDomHandler(cmdSave, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, TYPE_0) , cmdSave)) , f_Grid38.element.style['width'] = '' , f_Grid38.tableElem['cellSpacing'] = 5 , f_Grid38.tableElem['cellPadding'] = 5 , f_Grid38)) , $add_8(pnlAdmin, (f_Label45 = new Label_0 , f_Label45.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label45.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label45) , f_Label45)) , $add_8(pnlAdmin, (f_Grid46 = new Grid_0 , $resizeColumns(f_Grid46, 2) , $resizeRows(f_Grid46, 1) , $setWidget_2(f_Grid46, 0, 0, (f_Label47 = new Label_0 , $setTextOrHtml(f_Label47.directionalTextHelper, 'Fixer le format des noms des \xE9l\xE8ves dans Users', false) , $updateHorizontalAlignment(f_Label47) , f_Label47)) , $setWidget_2(f_Grid46, 0, 1, (cmdFixStudentName = new Button_0 , $setInnerText(cmdFixStudentName.element, 'Fixer') , $addDomHandler(cmdFixStudentName, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, TYPE_0) , cmdFixStudentName)) , f_Grid46.tableElem['cellSpacing'] = 5 , f_Grid46.tableElem['cellPadding'] = 5 , f_Grid46)) , $add_8(pnlAdmin, (f_Label48 = new Label_0 , f_Label48.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label48.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label48) , f_Label48)) , pnlAdmin.element['className'] = 'subSection' , pnlAdmin.element.style['width'] = '550px' , this$static.owner.pnlAdmin = pnlAdmin , pnlAdmin)) , f_VerticalPanel5.table['cellSpacing'] = 10 , f_VerticalPanel5)) , f_VerticalPanel2.element.style['height'] = '' , f_VerticalPanel2.element.style['width'] = '939px' , f_VerticalPanel2.table['cellSpacing'] = 2 , f_VerticalPanel2), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(1515, 1, {}, SettingsView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1516, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), SettingsView_BinderImpl$Widgets$1_0);
...
defineSeed(1517, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), SettingsView_BinderImpl$Widgets$2_0);
...
defineSeed(1518, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), SettingsView_BinderImpl$Widgets$3_0);
...
defineSeed(1519, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), SettingsView_BinderImpl$Widgets$4_0);
...
defineSeed(1520, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), SettingsView_BinderImpl$Widgets$5_0);
...
defineSeed(1737, 681, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
...
defineSeed(1762, 681, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$4X_0);
...
;
var Lcom_lemania_sis_client_presenter_SettingsPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'SettingsPresenter', 1117), Lcom_lemania_sis_client_presenter_SettingsPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'SettingsPresenter$1', 1118), Lcom_lemania_sis_client_presenter_SettingsPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'SettingsPresenter$2', 1119), Lcom_lemania_sis_client_presenter_SettingsPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'SettingsPresenter$3', 1120), Lcom_lemania_sis_client_presenter_SettingsPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'SettingsPresenter$4', 1121), Lcom_lemania_sis_client_presenter_SettingsPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'SettingsPresenter$5', 1122), Lcom_lemania_sis_client_presenter_SettingsPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'SettingsPresenter$6', 1123), Lcom_lemania_sis_client_view_SettingsView_2_classLit = createForClass('com.lemania.sis.client.view.', 'SettingsView', 1513), Lcom_lemania_sis_client_view_SettingsView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'SettingsView_BinderImpl', 1514), Lcom_lemania_sis_client_view_SettingsView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'SettingsView_BinderImpl$Widgets', 1515), Lcom_lemania_sis_client_view_SettingsView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'SettingsView_BinderImpl$Widgets$1', 1516), Lcom_lemania_sis_client_view_SettingsView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'SettingsView_BinderImpl$Widgets$2', 1517), Lcom_lemania_sis_client_view_SettingsView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'SettingsView_BinderImpl$Widgets$3', 1518), Lcom_lemania_sis_client_view_SettingsView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'SettingsView_BinderImpl$Widgets$4', 1519), Lcom_lemania_sis_client_view_SettingsView_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'SettingsView_BinderImpl$Widgets$5', 1520), Lcom_lemania_sis_shared_service_SettingOptionRequestFactory_1SettingOptionRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X', 1737), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$4X', 1762);
$entry(onLoad)(25);
