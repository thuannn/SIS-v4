...
defineSeed(852, 644, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(862, 736, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(863, 718, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1061, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(1062, 644, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1063, 644, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1064, 644, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1065, 644, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1066, 644, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1078, 644, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1084, 718, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1446, 710, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1447, 366, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1449, 366, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1451, 366, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1453, 366, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1561, 648, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1656, 648, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1658, 648, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1672, 648, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
