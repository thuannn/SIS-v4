...
defineSeed(1183, 703, makeCastMap([Q$IsWidget, Q$FrmBrancheListPresenter$MyView]), FrmBrancheListView_0);
...
defineSeed(1184, 363, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$1_0);
...
defineSeed(1186, 363, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$3_0);
...
defineSeed(1188, 363, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$5_0);
...
defineSeed(1546, 641, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$5X_0);
...
defineSeed(1553, 641, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$6X_0);
