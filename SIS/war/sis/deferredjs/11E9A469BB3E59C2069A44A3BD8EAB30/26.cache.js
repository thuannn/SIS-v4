...
defineSeed(1052, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(1053, 635, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1054, 635, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1055, 635, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1056, 635, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1057, 635, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1069, 635, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1075, 709, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1076, 1, {}, UserManagementPresenterMyProxyImpl$3$1_0);
...
defineSeed(1434, 701, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1435, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1437, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1439, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1441, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1549, 639, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1644, 639, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1646, 639, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1660, 639, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
