...
defineSeed(994, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsAddPresenter, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(995, 635, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(1046, 635, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(1052, 709, {}, UserManagementPresenterMyProxyImpl$2_0);
...
defineSeed(1053, 1, {}, UserManagementPresenterMyProxyImpl$2$1_0);
...
defineSeed(1352, 701, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1563, 639, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
