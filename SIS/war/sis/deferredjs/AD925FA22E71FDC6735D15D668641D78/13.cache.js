...
defineSeed(942, 720, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseAddPresenter, Q$FrmClasseAddUiHandler]), FrmClasseAddPresenter_0);
...
defineSeed(943, 659, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$1_0);
...
defineSeed(944, 659, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$2_0);
...
defineSeed(945, 659, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$3_0);
...
function FrmClasseAddView_0(){
  this.widget = $build_f_HTMLPanel1_12(new FrmClasseAddView_BinderImpl$Widgets_0(this));
}

defineSeed(1314, 725, makeCastMap([Q$IsWidget, Q$FrmClasseAddPresenter$MyView]), FrmClasseAddView_0);
...
defineSeed(1315, 10, makeCastMap([Q$Timer]), FrmClasseAddView$1_0);
...
defineSeed(1316, 1, {}, FrmClasseAddView_BinderImpl_0);
function $build_f_HTMLPanel1_12(this$static){
  var attachRecord12, f_HTMLPanel1, f_VerticalPanel2, f_Label3, f_Grid4, f_Label5, lstEcoles, f_Label6, lstCoursList, f_Label7, txtClassName, f_Label8, chkActive, f_Label9, cmdSave, sb, f_Label10, lblStatus;
  ...
  $addAndReplaceElement(f_HTMLPanel1, (f_VerticalPanel2 = new VerticalPanel_0 , $add_12(f_VerticalPanel2, (f_Label3 = new Label_0 , f_Label3.element['className'] = 'pageTitle' , $setHorizontalAlignment(f_Label3, ($clinit_HasHorizontalAlignment() , ALIGN_CENTER)) , $setTextOrHtml(f_Label3.directionalTextHelper, 'AJOUTER UNE CLASSE', false) , $updateHorizontalAlignment(f_Label3) , f_Label3)) , $add_12(f_VerticalPanel2, (f_Grid4 = new Grid_0 , $resizeColumns(f_Grid4, 2) , $resizeRows(f_Grid4, 6) , $setWidget_2(f_Grid4, 0, 0, (f_Label5 = new Label_0 , $setTextOrHtml(f_Label5.directionalTextHelper, 'Ecole', false) , $updateHorizontalAlignment(f_Label5) , f_Label5)) , $setWidget_2(f_Grid4, 0, 1, (lstEcoles = new ListBox_0 , lstEcoles.element['className'] = 'sis_textbox' , $addDomHandler(lstEcoles, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, ($clinit_ChangeEvent() , $clinit_ChangeEvent() , TYPE)) , this$static.owner.lstEcoles = lstEcoles , lstEcoles)) , $setWidget_2(f_Grid4, 1, 0, (f_Label6 = new Label_0 , $setTextOrHtml(f_Label6.directionalTextHelper, 'Programme', false) , $updateHorizontalAlignment(f_Label6) , f_Label6)) , $setWidget_2(f_Grid4, 1, 1, (lstCoursList = new ListBox_0 , lstCoursList.element['className'] = 'sis_textbox' , this$static.owner.lstCoursList = lstCoursList , lstCoursList)) , $setWidget_2(f_Grid4, 2, 0, (f_Label7 = new Label_0 , $setTextOrHtml(f_Label7.directionalTextHelper, 'Nom de la classe', false) , $updateHorizontalAlignment(f_Label7) , f_Label7)) , $setWidget_2(f_Grid4, 2, 1, (txtClassName = new TextBox_0 , txtClassName.element['className'] = 'sis_textbox' , this$static.owner.txtClassName = txtClassName , txtClassName)) , $setWidget_2(f_Grid4, 3, 0, (f_Label8 = new Label_0 , f_Label8.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label8.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label8) , f_Label8)) , $setWidget_2(f_Grid4, 3, 1, (chkActive = new CheckBox_0 , $setTextOrHtml(chkActive.directionalTextHelper, 'Active', false) , $setValue_0(chkActive, ($clinit_Boolean() , $clinit_Boolean() , TRUE_1)) , this$static.owner.chkActive = chkActive , chkActive)) , $setWidget_2(f_Grid4, 4, 0, (f_Label9 = new Label_0 , f_Label9.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label9.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label9) , f_Label9)) , $setWidget_2(f_Grid4, 4, 1, (cmdSave = new Button_0 , $setHTML(cmdSave, (sb = new StringBuilder_0 , sb.impl.string += 'Enregistrer' , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0(sb.impl.string)).html) , $addDomHandler(cmdSave, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_ClickEvent() , $clinit_ClickEvent() , TYPE_0)) , cmdSave)) , $setWidget_2(f_Grid4, 5, 0, (f_Label10 = new Label_0 , f_Label10.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label10.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label10) , f_Label10)) , $setWidget_2(f_Grid4, 5, 1, (lblStatus = new Label_0 , this$static.owner.lblStatus = lblStatus , lblStatus)) , f_Grid4.element.style['width'] = '80%' , f_Grid4.tableElem['cellSpacing'] = 5 , f_Grid4.tableElem['cellPadding'] = 5 , f_Grid4)) , f_VerticalPanel2.element.style['width'] = '100%' , f_VerticalPanel2.table['cellSpacing'] = 2 , f_VerticalPanel2), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(1317, 1, {}, FrmClasseAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1318, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmClasseAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1319, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmClasseAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1648, 663, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$8X_0);
...
_.val$cours = null;
_.val$ecoleId = null;
var Lcom_lemania_sis_client_presenter_FrmClasseAddPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseAddPresenter', 942), Lcom_lemania_sis_client_presenter_FrmClasseAddPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseAddPresenter$1', 943), Lcom_lemania_sis_client_presenter_FrmClasseAddPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseAddPresenter$2', 944), Lcom_lemania_sis_client_presenter_FrmClasseAddPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseAddPresenter$3', 945), Lcom_lemania_sis_client_view_FrmClasseAddView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseAddView', 1314), Lcom_lemania_sis_client_view_FrmClasseAddView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseAddView$1', 1315), Lcom_lemania_sis_client_view_FrmClasseAddView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseAddView_BinderImpl', 1316), Lcom_lemania_sis_client_view_FrmClasseAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseAddView_BinderImpl$Widgets', 1317), Lcom_lemania_sis_client_view_FrmClasseAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseAddView_BinderImpl$Widgets$1', 1318), Lcom_lemania_sis_client_view_FrmClasseAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseAddView_BinderImpl$Widgets$2', 1319), Lcom_lemania_sis_shared_service_ClasseRequestFactory_1ClasseRequestContextImpl$8X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ClasseRequestFactory_ClasseRequestContextImpl$8X', 1648);
$entry(onLoad)(13);
