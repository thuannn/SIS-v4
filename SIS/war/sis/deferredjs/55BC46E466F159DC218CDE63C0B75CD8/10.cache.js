...
defineSeed(907, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$1_0);
...
defineSeed(908, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$10_0);
...
defineSeed(909, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$11_0);
...
defineSeed(910, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$12_0);
_.onFailure_0 = function onFailure_33(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_33(response){
  $onSuccess_30(this, dynamicCast(response, Q$BulletinSubjectProxy));
}
;
_.this$0 = null;
...
defineSeed(911, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$13_0);
_.onFailure_0 = function onFailure_34(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_34(response){
  $onSuccess_31(this, dynamicCast(response, Q$BulletinSubjectProxy));
}
;
_.this$0 = null;
...
defineSeed(912, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$14_0);
_.onFailure_0 = function onFailure_35(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_35(response){
  $onSuccess_32(this, dynamicCast(response, Q$BulletinBrancheProxy));
}
;
_.this$0 = null;
function $onSuccess_33(this$static, response){
  $setProfessorListData_0(dynamicCast(this$static.this$0.view, Q$FrmBulletinManagementPresenter$MyView), response);
}
...
defineSeed(914, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$16_0);
...
defineSeed(915, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$2_0);
...
defineSeed(916, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$3_0);
...
defineSeed(917, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$4_0);
...
defineSeed(918, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$5_0);
...
defineSeed(919, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$6_0);
...
defineSeed(920, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$7_0);
...
defineSeed(921, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$8_0);
_.onFailure_0 = function onFailure_44(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_44(response){
  $onSuccess_40(this, dynamicCast(response, Q$Boolean));
}
;
_.this$0 = null;
...
defineSeed(922, 668, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$9_0);
...
function $onLstSubjectsChange(this$static){
  !!this$static.uiHandlers && $loadProfessorList_0(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), $getValue_2(this$static.lstSubjects, this$static.lstSubjects.element.selectedIndex), $getValue_2(this$static.lstClasses, this$static.lstClasses.element.selectedIndex));
}
...
function FrmBulletinManagementView_0(){
  ...
  this.widget = $build_f_HTMLPanel1_9(new FrmBulletinManagementView_BinderImpl$Widgets_0(this));
}

defineSeed(1281, 734, makeCastMap([Q$IsWidget, Q$FrmBulletinManagementPresenter$MyView]), FrmBulletinManagementView_0);
...
defineSeed(1282, 413, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$1_0);
...
defineSeed(1283, 413, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$10_0);
_.getValue = function getValue_17(object){
  return $getValue_5(dynamicCast(object, Q$BulletinSubjectProxy));
}
;
...
defineSeed(1284, 386, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$11_0);
...
defineSeed(1285, 1, {}, FrmBulletinManagementView$12_0);
...
defineSeed(1286, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinManagementView$13_0);
...
defineSeed(1287, 413, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$14_0);
...
defineSeed(1288, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinManagementView$15_0);
...
defineSeed(1289, 386, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$2_0);
_.getValue = function getValue_20(object){
  return $getValue_6(dynamicCast(object, Q$BulletinBrancheProxy));
}
;
...
defineSeed(1290, 1, {}, FrmBulletinManagementView$3_0);
...
defineSeed(1291, 386, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$4_0);
...
defineSeed(1292, 1, {}, FrmBulletinManagementView$5_0);
...
defineSeed(1293, 413, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$6_0);
...
defineSeed(1294, 386, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$7_0);
...
defineSeed(1295, 1, {}, FrmBulletinManagementView$8_0);
...
defineSeed(1296, 413, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$9_0);
...
defineSeed(1297, 1, {}, FrmBulletinManagementView_BinderImpl_0);
function $build_f_HTMLPanel1_9(this$static){
  var attachRecord9, f_HTMLPanel1, f_VerticalPanel2, f_Label3, f_HorizontalPanel4, f_VerticalPanel5, f_VerticalPanel12, f_Label6, f_Grid7, f_Label8, lstEcoles, f_Label9, lstProgrammes, f_Label10, lstClasses, f_Label11, tblBulletins, f_VerticalPanel13, f_Label14, f_Label15, lblStudentName, f_HorizontalPanel16, f_VerticalPanel17, f_Label18, tblSubjects, f_Label19, f_VerticalPanel20, f_Label21, f_Grid22, f_Label23, lstSubjects, f_Label24, lstProfessors, f_Label25, txtSubjectCoef, f_Label26, cmdAddSubject, f_VerticalPanel27, f_Label28, tblBranches, f_VerticalPanel29, f_Label30, f_Grid31, f_Label32, lstBranches, f_Label33, txtBrancheCoef, f_Label34, cmdAddBranche, f_Label35;
...
defineSeed(1298, 1, {}, FrmBulletinManagementView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1299, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$1_0);
...
defineSeed(1300, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$2_0);
...
defineSeed(1301, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$3_0);
...
defineSeed(1302, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$4_0);
...
defineSeed(1303, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$5_0);
...
defineSeed(1304, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$6_0);
...
defineSeed(1625, 672, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X_0);
...
defineSeed(1629, 672, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X_0);
...
defineSeed(1646, 672, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X_0);
...
defineSeed(1649, 672, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X_0);
...
defineSeed(1741, 672, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$4X_0);
...
;
_.val$bulletin = null;
var Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter', 906), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$1', 907), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$2', 915), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$3', 916), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$4', 917), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$5', 918), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$6', 919), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$7_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$7', 920), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$8_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$8', 921), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$9_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$9', 922), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$10_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$10', 908), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$11_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$11', 909), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$12_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$12', 910), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$13_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$13', 911), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$14_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$14', 912), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$16_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$16', 914), Lcom_lemania_sis_client_view_FrmBulletinManagementView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView', 1281), Lcom_lemania_sis_client_view_FrmBulletinManagementView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$1', 1282), Lcom_lemania_sis_client_view_FrmBulletinManagementView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$2', 1289), Lcom_lemania_sis_client_view_FrmBulletinManagementView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$3', 1290), Lcom_lemania_sis_client_view_FrmBulletinManagementView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$4', 1291), Lcom_lemania_sis_client_view_FrmBulletinManagementView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$5', 1292), Lcom_lemania_sis_client_view_FrmBulletinManagementView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$6', 1293), Lcom_lemania_sis_client_view_FrmBulletinManagementView$7_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$7', 1294), Lcom_lemania_sis_client_view_FrmBulletinManagementView$8_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$8', 1295), Lcom_lemania_sis_client_view_FrmBulletinManagementView$9_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$9', 1296), Lcom_lemania_sis_client_view_FrmBulletinManagementView$10_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$10', 1283), Lcom_lemania_sis_client_view_FrmBulletinManagementView$11_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$11', 1284), Lcom_lemania_sis_client_view_FrmBulletinManagementView$12_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$12', 1285), Lcom_lemania_sis_client_view_FrmBulletinManagementView$13_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$13', 1286), Lcom_lemania_sis_client_view_FrmBulletinManagementView$14_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$14', 1287), Lcom_lemania_sis_client_view_FrmBulletinManagementView$15_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$15', 1288), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl', 1297), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets', 1298), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$1', 1299), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$2', 1300), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$3', 1301), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$4', 1302), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$5', 1303), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$6', 1304), Lcom_lemania_sis_shared_service_SubjectRequestFactory_1SubjectRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'SubjectRequestFactory_SubjectRequestContextImpl$4X', 1741), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X', 1629), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$10X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X', 1625), Lcom_lemania_sis_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X', 1649), Lcom_lemania_sis_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$10X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X', 1646);
$entry(onLoad)(10);
