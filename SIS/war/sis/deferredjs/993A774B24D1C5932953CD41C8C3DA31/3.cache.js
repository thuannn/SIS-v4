...
defineSeed(853, 272, {}, CoursAddedEvent_0);
...
defineSeed(1200, 792, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursAddPresenter, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(1201, 723, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(1202, 723, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(1212, 820, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(1213, 805, {}, CoursPresenterMyProxyImpl$1_0);
_.success = function success_20(presenter){
  $success_18(dynamicCast(presenter, Q$CoursPresenter));
}
;
function CoursPresenterMyProxyImpl$1$1_0(){
}

defineSeed(1214, 1, {}, CoursPresenterMyProxyImpl$1$1_0);
...
defineSeed(1512, 797, makeCastMap([Q$IsWidget, Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(1513, 1, {}, CoursAddView_BinderImpl_0);
...
defineSeed(1514, 1, {}, CoursAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1515, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1516, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1950, 727, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
...
_.val$cours = null;
_.val$ecoleId = null;
var Lcom_lemania_sis_client_presenter_CoursAddPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursAddPresenter', 1200), Lcom_lemania_sis_client_presenter_CoursAddPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursAddPresenter$1', 1201), Lcom_lemania_sis_client_presenter_CoursAddPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursAddPresenter$2', 1202), Lcom_lemania_sis_client_event_CoursAddedEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'CoursAddedEvent', 853), Lcom_lemania_sis_client_presenter_CoursPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursPresenterMyProxyImpl$1', 1213), Lcom_lemania_sis_client_presenter_CoursPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursPresenterMyProxyImpl$1$1', 1214), Lcom_lemania_sis_client_view_CoursAddView_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView', 1512), Lcom_lemania_sis_client_view_CoursAddView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView_BinderImpl', 1513), Lcom_lemania_sis_client_view_CoursAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView_BinderImpl$Widgets', 1514), Lcom_lemania_sis_client_view_CoursAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView_BinderImpl$Widgets$1', 1515), Lcom_lemania_sis_client_view_CoursAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView_BinderImpl$Widgets$2', 1516), Lcom_lemania_sis_shared_service_CoursRequestFactory_1CoursRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$7X', 1950);
$entry(onLoad)(3);
