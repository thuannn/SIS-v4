...
defineSeed(1034, 787, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ProfessorAgendaUiHandlers]), ProfessorAgendaPresenter_0);
...
defineSeed(1035, 718, makeCastMap([Q$Receiver]), ProfessorAgendaPresenter$1_0);
...
defineSeed(1036, 718, makeCastMap([Q$Receiver]), ProfessorAgendaPresenter$2_0);
...
defineSeed(1039, 792, makeCastMap([Q$IsWidget, Q$ProfessorAgendaPresenter$MyView]), ProfessorAgendaView_0);
_.colorIndex = 0;
_.lstProfs = null;
_.tblAgenda = null;
...
defineSeed(1040, 1, makeCastMap([Q$MouseOverHandler, Q$EventHandler]), ProfessorAgendaView$1_0);
...
defineSeed(1041, 1, makeCastMap([Q$MouseOutHandler, Q$EventHandler]), ProfessorAgendaView$2_0);
...
defineSeed(1042, 1, makeCastMap([Q$MouseOverHandler, Q$EventHandler]), ProfessorAgendaView$3_0);
...
defineSeed(1043, 1, makeCastMap([Q$MouseOutHandler, Q$EventHandler]), ProfessorAgendaView$4_0);
...
defineSeed(1044, 1, {}, ProfessorAgendaView_BinderImpl_0);
...
defineSeed(1045, 1, {}, ProfessorAgendaView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1046, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfessorAgendaView_BinderImpl$Widgets$1_0);
...
defineSeed(1865, 722, makeCastMap([Q$AbstractRequest]), MasterAgendaItemRequestFactory_MasterAgendaItemRequestContextImpl$5X_0);
...
defineSeed(1977, 722, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$4X_0);
...
;
var Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaPresenter_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaPresenter', 1034), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaPresenter$1_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaPresenter$1', 1035), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaPresenter$2_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaPresenter$2', 1036), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView', 1039), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView$1_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView$1', 1040), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView$2_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView$2', 1041), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView$3_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView$3', 1042), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView$4_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView$4', 1043), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView_BinderImpl', 1044), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView_BinderImpl$Widgets', 1045), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView_BinderImpl$Widgets$1', 1046), Lcom_lemania_sis_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$4X', 1977), Lcom_lemania_sis_shared_masteragendaitem_MasterAgendaItemRequestFactory_1MasterAgendaItemRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.masteragendaitem.', 'MasterAgendaItemRequestFactory_MasterAgendaItemRequestContextImpl$5X', 1865);
$entry(onLoad)(31);
