...
defineSeed(790, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(791, 644, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(792, 644, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(793, 644, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(794, 644, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1159, 710, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1160, 366, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1161, 1, {}, CoursView$2_0);
...
defineSeed(1162, 366, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1163, 1, {}, CoursView$4_0);
...
defineSeed(1164, 1, {}, CoursView_BinderImpl_0);
...
defineSeed(1165, 1, {}, CoursView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1166, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), CoursView_BinderImpl$Widgets$1_0);
...
defineSeed(1597, 648, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
...
;
_.val$newCours = null;
var Lcom_lemania_sis_client_presenter_CoursPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursPresenter', 790), Lcom_lemania_sis_client_presenter_CoursPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursPresenter$1', 791), Lcom_lemania_sis_client_presenter_CoursPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursPresenter$2', 792), Lcom_lemania_sis_client_presenter_CoursPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursPresenter$3', 793), Lcom_lemania_sis_client_presenter_CoursPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursPresenter$4', 794), Lcom_lemania_sis_client_view_CoursView_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursView', 1159), Lcom_lemania_sis_client_view_CoursView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursView$1', 1160), Lcom_lemania_sis_client_view_CoursView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursView$2', 1161), Lcom_lemania_sis_client_view_CoursView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursView$3', 1162), Lcom_lemania_sis_client_view_CoursView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursView$4', 1163), Lcom_lemania_sis_client_view_CoursView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursView_BinderImpl', 1164), Lcom_lemania_sis_client_view_CoursView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursView_BinderImpl$Widgets', 1165), Lcom_lemania_sis_client_view_CoursView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursView_BinderImpl$Widgets$1', 1166), Lcom_lemania_sis_shared_service_CoursRequestFactory_1CoursRequestContextImpl$8X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$8X', 1597);
$entry(onLoad)(3);
