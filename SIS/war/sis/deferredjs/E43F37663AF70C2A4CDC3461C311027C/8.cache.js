...
defineSeed(1198, 710, makeCastMap([Q$IsWidget, Q$FrmBulletinCreationPresenter$MyView]), FrmBulletinCreationView_0);
...
defineSeed(1199, 392, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$1_0);
...
defineSeed(1200, 392, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$2_0);
...
defineSeed(1201, 392, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$3_0);
...
defineSeed(1202, 366, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$4_0);
...
defineSeed(1204, 392, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$6_0);
...
defineSeed(1205, 392, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$7_0);
...
defineSeed(1206, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinCreationView$8_0);
...
defineSeed(1207, 1, {}, FrmBulletinCreationView_BinderImpl_0);
...
defineSeed(1208, 1, {}, FrmBulletinCreationView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1209, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$1_0);
...
defineSeed(1210, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$2_0);
...
defineSeed(1211, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$3_0);
...
defineSeed(1212, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$4_0);
...
defineSeed(1565, 648, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$1X_0);
...
defineSeed(1568, 648, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$7X_0);
...
defineSeed(1570, 648, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$9X_0);
...
defineSeed(1661, 648, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$3X_0);
