...
defineSeed(945, 691, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(946, 630, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(947, 630, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(948, 630, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(949, 630, makeCastMap([Q$Receiver]), SettingsPresenter$4_0);
...
defineSeed(950, 630, makeCastMap([Q$Receiver]), SettingsPresenter$5_0);
...
defineSeed(1263, 696, makeCastMap([Q$IsWidget, Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1454, 634, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
...
defineSeed(1476, 634, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$3X_0);
