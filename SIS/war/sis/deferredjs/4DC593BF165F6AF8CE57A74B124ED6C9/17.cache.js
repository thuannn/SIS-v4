...
defineSeed(887, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(888, 630, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(889, 630, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(890, 630, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(905, 704, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1200, 696, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1474, 634, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
