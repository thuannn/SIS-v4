...
defineSeed(853, 691, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(854, 630, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(855, 630, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(856, 630, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(857, 630, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1147, 696, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1399, 634, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1403, 634, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
