...
defineSeed(966, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$1_0);
...
defineSeed(967, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$2_0);
...
defineSeed(968, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$3_0);
...
defineSeed(971, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$6_0);
...
defineSeed(1288, 696, makeCastMap([Q$IsWidget, Q$UserManagementPresenter$MyView]), UserManagementView_0);
...
defineSeed(1289, 386, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$1_0);
...
defineSeed(1290, 360, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$10_0);
...
defineSeed(1292, 386, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$12_0);
...
defineSeed(1293, 386, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$2_0);
...
defineSeed(1294, 386, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$3_0);
...
defineSeed(1295, 360, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$4_0);
...
defineSeed(1297, 360, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$6_0);
...
defineSeed(1299, 360, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$8_0);
...
defineSeed(1477, 634, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$5X_0);
...
defineSeed(1478, 634, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$7X_0);
