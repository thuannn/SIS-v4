...
defineSeed(834, 685, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$FrmBulletinViewSummaryUiHandler]), FrmBulletinViewSummaryPresenter_0);
...
defineSeed(835, 624, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$1_0);
...
defineSeed(836, 624, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$2_0);
...
defineSeed(837, 624, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$3_0);
...
defineSeed(838, 624, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$4_0);
...
function $drawMatuBulletin(this$static, subjects){
  ...
  for (i = rowStart.value_0; i < subjects.size_1(); ++i) {
    ...
    if (dynamicCast(subjects.get_0(rowCount.value_0), Q$BulletinSubjectProxy).getAn().length) {
      totalCoef = valueOf_1(totalCoef.value_0 + __parseAndValidateInt('' + dynamicCast(subjects.get_0(rowCount.value_0), Q$BulletinSubjectProxy).getSubjectCoef().value_0));
      totalMoyenne = new Double_0(totalMoyenne.value_0 + __parseAndValidateDouble(dynamicCast(subjects.get_0(rowCount.value_0), Q$BulletinSubjectProxy).getAn()) * __parseAndValidateInt('' + dynamicCast(subjects.get_0(rowCount.value_0), Q$BulletinSubjectProxy).getSubjectCoef().value_0));
    }
    rowCount = valueOf_1(rowCount.value_0 + 1);
  }
  rowCount = valueOf_1(rowCount.value_0 + 1);
  ...
  for (i = 0; i < $getCellCount(this$static.tblNotes, rowCount.value_0); ++i)
    $setStyleName_1(this$static.tblNotes.cellFormatter, rowCount.value_0, i, 'bulletinHeader');
  $setText(this$static.txtDirectionRemarque, dynamicCast($get_8(this$static.bulletins, this$static.lstBulletins.element.selectedIndex - 1), Q$BulletinProxy).getRemarqueDirection());
...
defineSeed(1124, 690, makeCastMap([Q$IsWidget, Q$FrmBulletinViewSummaryPresenter$MyView]), FrmBulletinViewSummaryView_0);
...
defineSeed(1125, 490, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]), FrmBulletinViewSummaryView$1_0);
...
defineSeed(1126, 1, makeCastMap([Q$CloseHandler, Q$EventHandler]), FrmBulletinViewSummaryView$2_0);
...
defineSeed(1127, 1, {}, FrmBulletinViewSummaryView_BinderImpl_0);
function $build_f_HTMLPanel1_9(this$static){
  var attachRecord10, f_HTMLPanel1, pnlMain, f_Label2, f_HorizontalPanel3, pnlAdmin, f_HorizontalPanel5, f_Label7, f_VerticalPanel8, pnlMainBulletin, f_VerticalPanel18, f_HorizontalPanel19, cmdSaveRemarques, cmdPrint, sb, f_Label20, f_Label4, lstClasses, f_Label6, lstBulletins, pnlBulletin, f_Grid9, imgLogo, f_Label10, f_VerticalPanel11, lblStudentName, lblClassName, f_HTML12, sb_0, tblNotes, f_HorizontalPanel13, f_Label14, txtDirectionRemarque, lblSpace, f_VerticalPanel15, f_Label16, f_Label17;
  ...
  $addAndReplaceElement(f_HTMLPanel1, (pnlMain = new VerticalPanel_0 , $setHorizontalAlignment_1(pnlMain, ($clinit_HasHorizontalAlignment() , ALIGN_CENTER)) , $add_11(pnlMain, (f_Label2 = new Label_0 , f_Label2.element['className'] = 'pageTitle' , $setAutoHorizontalAlignment(f_Label2, ALIGN_CENTER) , $setTextOrHtml(f_Label2.directionalTextHelper, 'IMPRIMER LES BULLETINS', false) , $updateHorizontalAlignment(f_Label2) , f_Label2)) , $add_11(pnlMain, (f_HorizontalPanel3 = new HorizontalPanel_0 , $setVerticalAlignment(f_HorizontalPanel3, ($clinit_HasVerticalAlignment() , ALIGN_MIDDLE)) , $add_9(f_HorizontalPanel3, (pnlAdmin = new HorizontalPanel_0 , $setHorizontalAlignment_0(pnlAdmin, ALIGN_RIGHT) , $setVerticalAlignment(pnlAdmin, ALIGN_MIDDLE) , $add_9(pnlAdmin, (f_Label4 = new Label_0 , $setTextOrHtml(f_Label4.directionalTextHelper, 'Classe :', false) , $updateHorizontalAlignment(f_Label4) , f_Label4)) , $add_9(pnlAdmin, (lstClasses = new ListBox_0 , lstClasses.element.style['width'] = '300px' , $addDomHandler(lstClasses, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_ChangeEvent() , $clinit_ChangeEvent() , TYPE)) , this$static.owner.lstClasses = lstClasses , lstClasses)) , pnlAdmin.element.style['width'] = '400px' , pnlAdmin.table['cellSpacing'] = 2 , pnlAdmin)) , $add_9(f_HorizontalPanel3, (f_HorizontalPanel5 = new HorizontalPanel_0 , $setHorizontalAlignment_0(f_HorizontalPanel5, ALIGN_RIGHT) , $setVerticalAlignment(f_HorizontalPanel5, ALIGN_MIDDLE) , $add_9(f_HorizontalPanel5, (f_Label6 = new Label_0 , $setTextOrHtml(f_Label6.directionalTextHelper, 'Bulletin(s) :', false) , $updateHorizontalAlignment(f_Label6) , f_Label6)) , $add_9(f_HorizontalPanel5, (lstBulletins = new ListBox_0 , lstBulletins.element.style['width'] = '300px' , $addDomHandler(lstBulletins, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, TYPE) , this$static.owner.lstBulletins = lstBulletins , lstBulletins)) , f_HorizontalPanel5.element.style['width'] = '400px' , f_HorizontalPanel5.table['cellSpacing'] = 2 , f_HorizontalPanel5)) , f_HorizontalPanel3.element['className'] = 'subSection' , f_HorizontalPanel3.table['cellSpacing'] = 5 , f_HorizontalPanel3)) , $add_11(pnlMain, (f_Label7 = new Label_0 , f_Label7.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label7.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label7) , f_Label7)) , $add_11(pnlMain, (f_VerticalPanel8 = new VerticalPanel_0 , $setHorizontalAlignment_1(f_VerticalPanel8, ALIGN_CENTER) , $add_11(f_VerticalPanel8, (pnlMainBulletin = new VerticalPanel_0 , $setHorizontalAlignment_1(pnlMainBulletin, ALIGN_CENTER) , $add_11(pnlMainBulletin, (pnlBulletin = new VerticalPanel_0 , $setHorizontalAlignment_1(pnlBulletin, ALIGN_LEFT) , $add_11(pnlBulletin, (f_Grid9 = new Grid_0 , $resizeColumns(f_Grid9, 2) , $resizeRows(f_Grid9, 2) , $setWidget_1(f_Grid9, 0, 0, (imgLogo = new Image_1 , imgLogo.element.style['height'] = '100' , imgLogo.element.style['width'] = '292' , $setUrl(imgLogo, ($clinit_UriUtils() , new SafeUriString_0('images/logo_lemania.png'))) , this$static.owner.imgLogo = imgLogo , imgLogo)) , $setWidget_1(f_Grid9, 0, 1, (f_Label10 = new Label_0 , f_Label10.element['className'] = 'bulletinTitle' , $setTextOrHtml(f_Label10.directionalTextHelper, 'BULLETIN DE NOTES', false) , $updateHorizontalAlignment(f_Label10) , f_Label10)) , $setWidget_1(f_Grid9, 1, 0, (f_VerticalPanel11 = new VerticalPanel_0 , $add_11(f_VerticalPanel11, (lblStudentName = new Label_0 , lblStudentName.element['className'] = 'bulletinStudentName' , $setTextOrHtml(lblStudentName.directionalTextHelper, '-', false) , $updateHorizontalAlignment(lblStudentName) , this$static.owner.lblStudentName = lblStudentName , lblStudentName)) , $add_11(f_VerticalPanel11, (lblClassName = new Label_0 , lblClassName.element['className'] = 'bulletinStudentName' , $setTextOrHtml(lblClassName.directionalTextHelper, '-', false) , $updateHorizontalAlignment(lblClassName) , this$static.owner.lblClassName = lblClassName , lblClassName)) , f_VerticalPanel11.table['cellSpacing'] = 5 , f_VerticalPanel11)) , $setWidget_1(f_Grid9, 1, 1, (f_HTML12 = new HTML_0 , $setHTML_0(f_HTML12, (sb_0 = new StringBuilder_0 , sb_0.impl.string += 'Crit\xE8re de r\xE9ussite : <ul> <li>Meilleure note : 6<\/li> <li>Moyenne : 4<\/li> <\/ul> La note moyenne indiqu\xE9e est calcul\xE9e en fonction des crit\xE8res de r\xE9ussite du dipl\xF4me postul\xE9.' , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0(sb_0.impl.string)).html) , f_HTML12.element['className'] = 'bulletinNote' , f_HTML12.element.style['whiteSpace'] = ($clinit_Style$WhiteSpace() , 'normal') , f_HTML12)) , f_Grid9.element.style['width'] = '100%' , f_Grid9)) , $add_11(pnlBulletin, (tblNotes = new FlexTable_0 , tblNotes.element.style['width'] = '100%' , tblNotes.tableElem['cellPadding'] = 3 , this$static.owner.tblNotes = tblNotes , tblNotes)) , $add_11(pnlBulletin, (f_HorizontalPanel13 = new HorizontalPanel_0 , $add_9(f_HorizontalPanel13, (f_Label14 = new Label_0 , $setTextOrHtml(f_Label14.directionalTextHelper, 'Direction :', false) , $updateHorizontalAlignment(f_Label14) , f_Label14.element.style['width'] = '' , f_Label14)) , $add_9(f_HorizontalPanel13, (txtDirectionRemarque = new TextArea_1 , txtDirectionRemarque.element['className'] = 'sis-TextArea' , txtDirectionRemarque.element.rows = 5 , txtDirectionRemarque.element.cols = 90 , txtDirectionRemarque.element.style['width'] = '' , this$static.owner.txtDirectionRemarque = txtDirectionRemarque , txtDirectionRemarque)) , f_HorizontalPanel13.element['className'] = 'subSection' , f_HorizontalPanel13.element.style['width'] = '100%' , f_HorizontalPanel13)) , $add_11(pnlBulletin, (lblSpace = new Label_0 , setStylePrimaryName(lblSpace.element, 'hiddenText') , $setTextOrHtml(lblSpace.directionalTextHelper, '.', false) , $updateHorizontalAlignment(lblSpace) , this$static.owner.lblSpace = lblSpace , lblSpace)) , $add_11(pnlBulletin, (f_VerticalPanel15 = new VerticalPanel_0 , $setHorizontalAlignment_1(f_VerticalPanel15, ALIGN_CENTER) , $add_11(f_VerticalPanel15, (f_Label16 = new Label_0 , f_Label16.element['className'] = 'bulletinFooter' , $setTextOrHtml(f_Label16.directionalTextHelper, 'Chemin de Pr\xE9ville 3 - CP 550, 1003 Lausanne, Suisse - Tel.: +41 21 320 15 01 - Fax.: +41 312 67 00', false) , $updateHorizontalAlignment(f_Label16) , f_Label16)) , $add_11(f_VerticalPanel15, (f_Label17 = new Label_0 , f_Label17.element['className'] = 'bulletinFooter' , $setTextOrHtml(f_Label17.directionalTextHelper, 'Email: info@lemania.ch - Site internet : www.lemania.ch', false) , $updateHorizontalAlignment(f_Label17) , f_Label17)) , f_VerticalPanel15.element.style['width'] = '100%' , f_VerticalPanel15.table['cellSpacing'] = 2 , f_VerticalPanel15)) , pnlBulletin.element['className'] = 'bulletin' , pnlBulletin.element.style['width'] = '100%' , pnlBulletin.table['cellSpacing'] = 5 , this$static.owner.pnlBulletin = pnlBulletin , pnlBulletin)) , pnlMainBulletin.element.style['width'] = '80%' , this$static.owner.pnlMainBulletin = pnlMainBulletin , pnlMainBulletin)) , $add_11(f_VerticalPanel8, (f_VerticalPanel18 = new VerticalPanel_0 , $setHorizontalAlignment_1(f_VerticalPanel18, ALIGN_RIGHT) , $add_11(f_VerticalPanel18, (f_HorizontalPanel19 = new HorizontalPanel_0 , $add_9(f_HorizontalPanel19, (cmdSaveRemarques = new Button_0 , $setInnerText(cmdSaveRemarques.element, 'Enregistrer les remarques') , $addDomHandler(cmdSaveRemarques, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames4, ($clinit_ClickEvent() , $clinit_ClickEvent() , TYPE_0)) , cmdSaveRemarques)) , $add_9(f_HorizontalPanel19, (cmdPrint = new Button_0 , $setHTML(cmdPrint, (sb = new StringBuilder_0 , sb.impl.string += 'Imprimer' , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0(sb.impl.string)).html) , $setInnerText(cmdPrint.element, 'Afficher la version \xE0 imprimer') , $addDomHandler(cmdPrint, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames3, TYPE_0) , cmdPrint)) , f_HorizontalPanel19.element.style['width'] = '400px' , f_HorizontalPanel19)) , f_VerticalPanel18.element.style['width'] = '80%' , f_VerticalPanel18.table['cellSpacing'] = 5 , f_VerticalPanel18)) , f_VerticalPanel8.element.style['width'] = '100%' , f_VerticalPanel8)) , $add_11(pnlMain, (f_Label20 = new Label_0 , f_Label20.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label20.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label20) , f_Label20)) , pnlMain.element.style['width'] = '100%' , pnlMain.table['cellSpacing'] = 2 , pnlMain), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(1128, 1, {}, FrmBulletinViewSummaryView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1129, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$1_0);
...
defineSeed(1130, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$2_0);
...
defineSeed(1131, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$3_0);
...
defineSeed(1132, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$4_0);
...
defineSeed(1373, 628, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$12X_0);
...
defineSeed(1392, 628, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$2X_0);
...
;
var Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter', 834), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter$1', 835), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter$2', 836), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter$3', 837), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter$4', 838), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView', 1124), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView$1', 1125), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView$2', 1126), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl', 1127), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets', 1128), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$1', 1129), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$2', 1130), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$3', 1131), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$4', 1132), Lcom_lemania_sis_shared_service_ClasseRequestFactory_1ClasseRequestContextImpl$2X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ClasseRequestFactory_ClasseRequestContextImpl$2X', 1392), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$12X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$12X', 1373);
$entry(onLoad)(11);
