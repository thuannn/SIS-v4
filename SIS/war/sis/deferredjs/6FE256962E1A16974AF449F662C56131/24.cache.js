...
defineSeed(1026, 687, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$SettingsPresenter, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(1027, 626, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(1028, 626, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(1029, 626, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1030, 626, makeCastMap([Q$Receiver]), SettingsPresenter$4_0);
...
defineSeed(1031, 626, makeCastMap([Q$Receiver]), SettingsPresenter$5_0);
...
defineSeed(1032, 626, makeCastMap([Q$Receiver]), SettingsPresenter$6_0);
...
defineSeed(1409, 692, makeCastMap([Q$IsWidget, Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1631, 630, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
...
defineSeed(1655, 630, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$4X_0);
