...
defineSeed(882, 689, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$FrmSubjectListUiHandler]), FrmSubjectListPresenter_0);
...
defineSeed(883, 628, makeCastMap([Q$Receiver]), FrmSubjectListPresenter$1_0);
...
defineSeed(884, 628, makeCastMap([Q$Receiver]), FrmSubjectListPresenter$2_0);
...
defineSeed(1190, 694, makeCastMap([Q$IsWidget, Q$FrmSubjectListPresenter$MyView]), FrmSubjectListView_0);
...
defineSeed(1464, 632, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$2X_0);
...
defineSeed(1468, 632, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$7X_0);
