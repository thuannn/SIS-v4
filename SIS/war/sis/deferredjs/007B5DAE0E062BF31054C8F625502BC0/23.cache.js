...
defineSeed(959, 691, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(960, 630, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(961, 630, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(962, 630, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(963, 630, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(964, 630, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(974, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(980, 704, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1278, 696, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1382, 634, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1459, 634, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1461, 634, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1474, 634, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$11X_0);
