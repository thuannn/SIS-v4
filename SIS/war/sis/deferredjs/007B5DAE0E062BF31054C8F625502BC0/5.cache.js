...
defineSeed(781, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$EcoleAddedEvent$EcoleAddedHandler, Q$EcolePresenter, Q$EcoleListUiHandler]), EcolePresenter_0);
...
defineSeed(782, 630, makeCastMap([Q$Receiver]), EcolePresenter$1_0);
...
defineSeed(783, 630, makeCastMap([Q$Receiver]), EcolePresenter$2_0);
...
defineSeed(1061, 696, makeCastMap([Q$IsWidget, Q$EcolePresenter$MyView]), EcoleView_0);
...
defineSeed(1421, 634, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$6X_0);
