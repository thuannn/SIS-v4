...
defineSeed(763, 691, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(764, 630, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(765, 630, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(773, 722, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CoursAddedEvent$CoursAddedHandler]));
...
defineSeed(774, 704, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(1040, 696, makeCastMap([Q$IsWidget, Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(1414, 634, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
