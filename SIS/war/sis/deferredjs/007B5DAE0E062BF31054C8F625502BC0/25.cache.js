...
defineSeed(968, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$1_0);
...
defineSeed(969, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$2_0);
...
defineSeed(970, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$3_0);
...
defineSeed(973, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$6_0);
...
defineSeed(1290, 696, makeCastMap([Q$IsWidget, Q$UserManagementPresenter$MyView]), UserManagementView_0);
...
defineSeed(1291, 386, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$1_0);
...
defineSeed(1292, 360, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$10_0);
...
defineSeed(1294, 386, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$12_0);
...
defineSeed(1295, 386, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$2_0);
...
defineSeed(1296, 386, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$3_0);
...
defineSeed(1297, 360, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$4_0);
...
defineSeed(1299, 360, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$6_0);
...
defineSeed(1301, 360, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$8_0);
...
defineSeed(1478, 634, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$5X_0);
...
defineSeed(1479, 634, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$7X_0);
