...
;
defineSeed(845, 722, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler]));
...
defineSeed(889, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(890, 630, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(891, 630, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(892, 630, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(907, 704, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1202, 696, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1475, 634, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
