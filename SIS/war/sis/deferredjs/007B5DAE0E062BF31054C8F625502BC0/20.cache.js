...
defineSeed(933, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(934, 630, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(935, 630, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(936, 630, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(937, 630, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(938, 630, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(939, 630, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(940, 630, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(941, 630, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(942, 630, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1248, 696, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1359, 634, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1360, 634, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1361, 634, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1430, 634, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
