...
defineSeed(849, 691, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$FrmClasseAddUiHandler]), FrmClasseAddPresenter_0);
...
defineSeed(850, 630, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$1_0);
...
defineSeed(851, 630, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$2_0);
...
defineSeed(852, 630, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$3_0);
...
defineSeed(1142, 696, makeCastMap([Q$IsWidget, Q$FrmClasseAddPresenter$MyView]), FrmClasseAddView_0);
...
defineSeed(1403, 634, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$8X_0);
