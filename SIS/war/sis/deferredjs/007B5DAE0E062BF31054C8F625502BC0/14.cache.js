...
defineSeed(862, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmMarkInputPresenter, Q$FrmMarkInputUiHandler]), FrmMarkInputPresenter_0);
...
defineSeed(863, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$1_0);
...
defineSeed(864, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$2_0);
...
defineSeed(865, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$3_0);
...
defineSeed(866, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$4_0);
...
defineSeed(867, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$5_0);
...
defineSeed(868, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$6_0);
...
defineSeed(869, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$7_0);
...
defineSeed(1159, 696, makeCastMap([Q$IsWidget, Q$FrmMarkInputPresenter$MyView]), FrmMarkInputView_0);
...
defineSeed(1362, 634, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$5X_0);
...
defineSeed(1394, 634, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$6X_0);
...
defineSeed(1427, 634, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$1X_0);
