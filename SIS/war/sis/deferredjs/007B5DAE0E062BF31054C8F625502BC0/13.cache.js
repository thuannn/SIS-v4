...
defineSeed(855, 691, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(856, 630, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(857, 630, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(858, 630, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(859, 630, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1149, 696, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1150, 360, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(1152, 360, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1400, 634, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1404, 634, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
