...
defineSeed(773, 687, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(774, 626, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(775, 626, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(776, 626, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(777, 626, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1147, 692, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1148, 357, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1150, 357, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1590, 630, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
