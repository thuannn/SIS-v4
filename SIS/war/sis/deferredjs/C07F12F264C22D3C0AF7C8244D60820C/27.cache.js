...
function $updateSubject(this$static, subject, subjectName, subjectCoef, isActive){
  ...
  $fire((x_0 = new SubjectRequestFactory_SubjectRequestContextImpl$7X_0(rc, subject) , $addInvocation(rc.state.dialect, x_0) , x_0), new FrmSubjectListPresenter$1_0(this$static));
}
...
defineSeed(977, 702, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmSubjectListPresenter, Q$FrmSubjectListUiHandler]), FrmSubjectListPresenter_0);
...
_.onReset = function onReset_19(){
  ...
  $fire((x_0 = new SubjectRequestFactory_SubjectRequestContextImpl$2X_0(rc) , $addInvocation(rc.state.dialect, x_0) , x_0), new FrmSubjectListPresenter$2_0(this));
}
;
...
defineSeed(978, 641, makeCastMap([Q$Receiver]), FrmSubjectListPresenter$1_0);
...
defineSeed(979, 641, makeCastMap([Q$Receiver]), FrmSubjectListPresenter$2_0);
...
function $setSubjectListData_0(this$static, subjectList){
  ...
  $setHeight_0(this$static.tblSubjectList, '' + subjectList.size_1() * ($clinit_NotificationTypes() , lineHeight).value_0 + 'px');
}
...
defineSeed(1370, 707, makeCastMap([Q$IsWidget, Q$FrmSubjectListPresenter$MyView]), FrmSubjectListView_0);
...
defineSeed(1371, 363, makeCastMap([Q$HasCell, Q$Column]), FrmSubjectListView$1_0);
_.getValue = function getValue_61(object){
  return dynamicCast(object, Q$SubjectProxy).getSubjectName();
}
;
function $update_21(this$static, index_0, subject, value_0){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedSubject = index_0;
    $updateSubject(dynamicCast(this$static.this$0.uiHandlers, Q$FrmSubjectListUiHandler), subject, value_0, ($clinit_Double() , '' + subject.getDefaultCoef().value_0), subject.getIsActive());
  }
}
...
defineSeed(1372, 1, {}, FrmSubjectListView$2_0);
_.update = function update_22(index_0, subject, value_0){
  $update_21(this, index_0, dynamicCast(subject, Q$SubjectProxy), dynamicCast(value_0, Q$String));
}
;
...
defineSeed(1373, 363, makeCastMap([Q$HasCell, Q$Column]), FrmSubjectListView$3_0);
_.getValue = function getValue_62(object){
  return $getValue_8(dynamicCast(object, Q$SubjectProxy));
}
;
function $update_22(this$static, index_0, subject, value_0){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedSubject = index_0;
    $updateSubject(dynamicCast(this$static.this$0.uiHandlers, Q$FrmSubjectListUiHandler), subject, subject.getSubjectName(), value_0, subject.getIsActive());
  }
}
...
defineSeed(1374, 1, {}, FrmSubjectListView$4_0);
_.update = function update_23(index_0, subject, value_0){
  $update_22(this, index_0, dynamicCast(subject, Q$SubjectProxy), dynamicCast(value_0, Q$String));
}
;
...
defineSeed(1375, 363, makeCastMap([Q$HasCell, Q$Column]), FrmSubjectListView$5_0);
_.getValue = function getValue_63(subject){
  return dynamicCast(subject, Q$SubjectProxy).getIsActive();
}
;
function $update_23(this$static, index_0, subject, value_0){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedSubject = index_0;
    $updateSubject(dynamicCast(this$static.this$0.uiHandlers, Q$FrmSubjectListUiHandler), subject, subject.getSubjectName(), ($clinit_Double() , '' + subject.getDefaultCoef().value_0), value_0);
  }
}
...
defineSeed(1376, 1, {}, FrmSubjectListView$6_0);
_.update = function update_24(index_0, subject, value_0){
  $update_23(this, index_0, dynamicCast(subject, Q$SubjectProxy), dynamicCast(value_0, Q$Boolean));
}
;
function FrmSubjectListView_BinderImpl_0(){
}

defineSeed(1377, 1, {}, FrmSubjectListView_BinderImpl_0);
...
defineSeed(1378, 1, {}, FrmSubjectListView_BinderImpl$Widgets_0);
...
defineSeed(1678, 645, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$2X_0);
...
defineSeed(1682, 645, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$7X_0);
...
;
var Lcom_lemania_sis_client_presenter_FrmSubjectListPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmSubjectListPresenter', 977), Lcom_lemania_sis_client_presenter_FrmSubjectListPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmSubjectListPresenter$1', 978), Lcom_lemania_sis_client_presenter_FrmSubjectListPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmSubjectListPresenter$2', 979), Lcom_lemania_sis_client_view_FrmSubjectListView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectListView', 1370), Lcom_lemania_sis_client_view_FrmSubjectListView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectListView$1', 1371), Lcom_lemania_sis_client_view_FrmSubjectListView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectListView$2', 1372), Lcom_lemania_sis_client_view_FrmSubjectListView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectListView$3', 1373), Lcom_lemania_sis_client_view_FrmSubjectListView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectListView$4', 1374), Lcom_lemania_sis_client_view_FrmSubjectListView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectListView$5', 1375), Lcom_lemania_sis_client_view_FrmSubjectListView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectListView$6', 1376), Lcom_lemania_sis_client_view_FrmSubjectListView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectListView_BinderImpl', 1377), Lcom_lemania_sis_client_view_FrmSubjectListView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectListView_BinderImpl$Widgets', 1378), Lcom_lemania_sis_shared_service_SubjectRequestFactory_1SubjectRequestContextImpl$2X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'SubjectRequestFactory_SubjectRequestContextImpl$2X', 1678), Lcom_lemania_sis_shared_service_SubjectRequestFactory_1SubjectRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'SubjectRequestFactory_SubjectRequestContextImpl$7X', 1682);
$entry(onLoad)(27);
