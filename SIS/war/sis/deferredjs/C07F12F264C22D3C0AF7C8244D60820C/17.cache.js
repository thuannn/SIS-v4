...
defineSeed(758, 237, {}, CheckDeadlineEvent_0);
...
function $onAssignmentSelected_0(this$static, assignmentId){
  ...
  $fire((x_0 = new BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$6X_0(rc, assignmentId) , $addInvocation(rc.state.dialect, x_0) , x_0), new FrmMarkInputPresenter$4_0(this$static));
}
...
defineSeed(950, 702, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CheckDeadlineEvent$CheckDeadlineHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmMarkInputPresenter, Q$FrmMarkInputUiHandler]), FrmMarkInputPresenter_0);
...
defineSeed(951, 641, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$1_0);
...
defineSeed(952, 641, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$2_0);
...
defineSeed(953, 641, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$3_0);
...
defineSeed(954, 641, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$4_0);
...
defineSeed(955, 641, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$5_0);
...
defineSeed(956, 641, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$6_0);
...
defineSeed(957, 641, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$7_0);
...
defineSeed(958, 641, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$8_0);
...
;
defineSeed(959, 733, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CheckDeadlineEvent$CheckDeadlineHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(962, 715, {}, FrmMarkInputPresenterMyProxyImpl$2_0);
...
defineSeed(963, 1, {}, FrmMarkInputPresenterMyProxyImpl$2$1_0);
...
function $modifyUiByDeadline(this$static, settings, currentUser){
  ...
  for (setting$iterator = settings.iterator(); setting$iterator.hasNext();) {
    ...
    if ($getItemText(this$static.lstAssignments, $getSelectElement(this$static.lstAssignments).selectedIndex).toLowerCase().indexOf('maturit\xE9 suisse') != -1) {
      if ($getItemText(this$static.lstAssignments, $getSelectElement(this$static.lstAssignments).selectedIndex).toLowerCase().indexOf('pr\xE9alable') == -1) {
    ...
    if ($getItemText(this$static.lstAssignments, $getSelectElement(this$static.lstAssignments).selectedIndex).toLowerCase().indexOf('baccalaur\xE9at fran\xE7ais') != -1) {
    ...
    if ($getItemText(this$static.lstAssignments, $getSelectElement(this$static.lstAssignments).selectedIndex).toLowerCase().indexOf('etudes secondaires') != -1) {
...
function $modifyUiByProgramme(this$static){
  ...
  if ($getItemText(this$static.lstAssignments, $getSelectElement(this$static.lstAssignments).selectedIndex).toLowerCase().indexOf('pr\xE9maturit\xE9') != -1) {
    ...
    if (this$static.selectedBulletinBrancheIndex > -1) {
      $isVisible(this$static.pnlT3) || $setVisible_0(this$static.pnlT3, true);
      $isVisible(this$static.pnlT4) || $setVisible_0(this$static.pnlT4, true);
    }
    return;
  }
  if ($getItemText(this$static.lstAssignments, $getSelectElement(this$static.lstAssignments).selectedIndex).toLowerCase().indexOf('matu') != -1) {
    ...
    $setColumnWidth(this$static.tblBranches, 4, '15%');
    $setColumnWidth(this$static.tblBranches, 5, '0px');
    this$static.selectedBulletinBrancheIndex > -1 && ($isVisible(this$static.pnlT3) || $setVisible_0(this$static.pnlT3, true));
    $setVisible_0(this$static.pnlT4, false);
  }
}

function $onCmdSaveClick_3(this$static){
  !!this$static.uiHandlers && $saveNotes(dynamicCast(this$static.uiHandlers, Q$FrmMarkInputUiHandler), this$static.selectedBulletinBranche, this$static.selectedBulletinSubject, $getPropertyString($getElement(this$static.txt_t_1_1), 'value'), $getPropertyString($getElement(this$static.txt_t_1_2), 'value'), $getPropertyString($getElement(this$static.txt_t_1_3), 'value'), $getPropertyString($getElement(this$static.txt_t_1_4), 'value'), $getPropertyString($getElement(this$static.txt_t_1_5), 'value'), $getPropertyString($getElement(this$static.txt_t_2_1), 'value'), $getPropertyString($getElement(this$static.txt_t_2_2), 'value'), $getPropertyString($getElement(this$static.txt_t_2_3), 'value'), $getPropertyString($getElement(this$static.txt_t_2_4), 'value'), $getPropertyString($getElement(this$static.txt_t_2_5), 'value'), $getPropertyString($getElement(this$static.txt_t_3_1), 'value'), $getPropertyString($getElement(this$static.txt_t_3_2), 'value'), $getPropertyString($getElement(this$static.txt_t_3_3), 'value'), $getPropertyString($getElement(this$static.txt_t_3_4), 'value'), $getPropertyString($getElement(this$static.txt_t_3_5), 'value'), $getPropertyString($getElement(this$static.txt_t_4_1), 'value'), $getPropertyString($getElement(this$static.txt_t_4_2), 'value'), $getPropertyString($getElement(this$static.txt_t_4_3), 'value'), $getPropertyString($getElement(this$static.txt_t_4_4), 'value'), $getPropertyString($getElement(this$static.txt_t_4_5), 'value'), $getPropertyString($getElement(this$static.txtRemarque1), 'value'), $getPropertyString($getElement(this$static.txtRemarque2), 'value'), $getPropertyString($getElement(this$static.txtRemarque3), 'value'), $getPropertyString($getElement(this$static.txtRemarque4), 'value'));
}
...
function $onLstAssignmentsChange_0(this$static){
  ...
  !!this$static.uiHandlers && $onAssignmentSelected_0(dynamicCast(this$static.uiHandlers, Q$FrmMarkInputUiHandler), $getValue_1(this$static.lstAssignments, $getSelectElement(this$static.lstAssignments).selectedIndex));
}

function $onLstProfsChange_0(this$static){
  $resetForm_10(this$static);
  !!this$static.uiHandlers && $onProfessorSelected_0(dynamicCast(this$static.uiHandlers, Q$FrmMarkInputUiHandler), $getValue_1(this$static.lstProfs, $getSelectElement(this$static.lstProfs).selectedIndex));
}

function $resetForm_10(this$static){
  $selectClear($getSelectElement(this$static.lstAssignments));
  $clear_3(this$static.bulletinSubjectDataProvider.listWrapper);
  $clear_3(this$static.bulletinBrancheDataProvider.listWrapper);
  $setText_1(this$static.lblStudentName, '');
  $clearInputFields(this$static);
...
defineSeed(1334, 707, makeCastMap([Q$IsWidget, Q$FrmMarkInputPresenter$MyView]), FrmMarkInputView_0);
...
defineSeed(1335, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$1_0);
...
defineSeed(1336, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$10_0);
...
defineSeed(1337, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$11_0);
...
defineSeed(1338, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$12_0);
...
defineSeed(1339, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$13_0);
...
defineSeed(1340, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$14_0);
...
defineSeed(1341, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$15_0);
...
defineSeed(1342, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmMarkInputView$16_0);
...
defineSeed(1343, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$17_0);
...
defineSeed(1344, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmMarkInputView$18_0);
...
defineSeed(1345, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$2_0);
...
defineSeed(1346, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$3_0);
...
defineSeed(1347, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$4_0);
...
defineSeed(1348, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$5_0);
...
defineSeed(1349, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$6_0);
...
defineSeed(1350, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$7_0);
...
defineSeed(1351, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$8_0);
...
defineSeed(1352, 389, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$9_0);
...
defineSeed(1353, 1, {}, FrmMarkInputView_BinderImpl_0);
...
defineSeed(1354, 1, {}, FrmMarkInputView_BinderImpl$Widgets_0);
function FrmMarkInputView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1355, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmMarkInputView_BinderImpl$Widgets$1_0);
...
defineSeed(1356, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmMarkInputView_BinderImpl$Widgets$2_0);
...
defineSeed(1357, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmMarkInputView_BinderImpl$Widgets$3_0);
...
defineSeed(1587, 645, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$6X_0);
...
;
var Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter', 950), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$1', 951), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$2', 952), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$3', 953), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$4', 954), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$5', 955), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$6', 956), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$7_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$7', 957), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenter$8_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenter$8', 958), Lcom_lemania_sis_client_event_CheckDeadlineEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'CheckDeadlineEvent', 758), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenterMyProxyImpl$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenterMyProxyImpl$2', 962), Lcom_lemania_sis_client_presenter_FrmMarkInputPresenterMyProxyImpl$2$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmMarkInputPresenterMyProxyImpl$2$1', 963), Lcom_lemania_sis_client_view_FrmMarkInputView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView', 1334), Lcom_lemania_sis_client_view_FrmMarkInputView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$1', 1335), Lcom_lemania_sis_client_view_FrmMarkInputView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$2', 1345), Lcom_lemania_sis_client_view_FrmMarkInputView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$3', 1346), Lcom_lemania_sis_client_view_FrmMarkInputView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$4', 1347), Lcom_lemania_sis_client_view_FrmMarkInputView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$5', 1348), Lcom_lemania_sis_client_view_FrmMarkInputView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$6', 1349), Lcom_lemania_sis_client_view_FrmMarkInputView$7_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$7', 1350), Lcom_lemania_sis_client_view_FrmMarkInputView$8_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$8', 1351), Lcom_lemania_sis_client_view_FrmMarkInputView$9_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$9', 1352), Lcom_lemania_sis_client_view_FrmMarkInputView$10_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$10', 1336), Lcom_lemania_sis_client_view_FrmMarkInputView$11_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$11', 1337), Lcom_lemania_sis_client_view_FrmMarkInputView$12_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$12', 1338), Lcom_lemania_sis_client_view_FrmMarkInputView$13_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$13', 1339), Lcom_lemania_sis_client_view_FrmMarkInputView$14_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$14', 1340), Lcom_lemania_sis_client_view_FrmMarkInputView$15_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$15', 1341), Lcom_lemania_sis_client_view_FrmMarkInputView$16_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$16', 1342), Lcom_lemania_sis_client_view_FrmMarkInputView$17_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$17', 1343), Lcom_lemania_sis_client_view_FrmMarkInputView$18_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView$18', 1344), Lcom_lemania_sis_client_view_FrmMarkInputView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView_BinderImpl', 1353), Lcom_lemania_sis_client_view_FrmMarkInputView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView_BinderImpl$Widgets', 1354), Lcom_lemania_sis_client_view_FrmMarkInputView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView_BinderImpl$Widgets$1', 1355), Lcom_lemania_sis_client_view_FrmMarkInputView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView_BinderImpl$Widgets$2', 1356), Lcom_lemania_sis_client_view_FrmMarkInputView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmMarkInputView_BinderImpl$Widgets$3', 1357), Lcom_lemania_sis_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$6X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$6X', 1587);
$entry(onLoad)(17);
