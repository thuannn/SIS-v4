...
defineSeed(788, 702, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(789, 641, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(790, 641, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(791, 641, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(792, 641, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1162, 707, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1163, 363, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1165, 363, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1608, 645, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
