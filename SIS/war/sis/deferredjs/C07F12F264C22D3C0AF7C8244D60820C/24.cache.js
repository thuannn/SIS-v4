...
defineSeed(1048, 702, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$SettingsPresenter, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(1049, 641, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(1050, 641, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(1051, 641, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1052, 641, makeCastMap([Q$Receiver]), SettingsPresenter$4_0);
...
defineSeed(1053, 641, makeCastMap([Q$Receiver]), SettingsPresenter$5_0);
...
defineSeed(1054, 641, makeCastMap([Q$Receiver]), SettingsPresenter$6_0);
...
defineSeed(1443, 707, makeCastMap([Q$IsWidget, Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1667, 645, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
...
defineSeed(1691, 645, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$4X_0);
