...
function $saveBulletinSubject(this$static, bulletinBranche, bulletinSubject, remarque1, remarque2, remarque3){
  ...
  $initialize_0(rfSubject, this$static.eventBus, new EventSourceRequestTransport_1(this$static.eventBus));
...
function $saveNotes(this$static, bulletinBranche, bulletinSubject, t_1_1, t_1_2, t_1_3, t_1_4, t_1_5, t_2_1, t_2_2, t_2_3, t_2_4, t_2_5, t_3_1, t_3_2, t_3_3, t_3_4, t_3_5, remarque1, remarque2, remarque3){
  ...
  $initialize_0(rfBranche, this$static.eventBus, new EventSourceRequestTransport_1(this$static.eventBus));
...
defineSeed(886, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmMarkInputPresenter, Q$FrmMarkInputUiHandler]), FrmMarkInputPresenter_0);
...
defineSeed(887, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$1_0);
...
defineSeed(888, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$2_0);
...
defineSeed(889, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$3_0);
...
defineSeed(890, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$4_0);
...
defineSeed(891, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$5_0);
...
defineSeed(892, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$6_0);
...
defineSeed(893, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$7_0);
...
defineSeed(1199, 696, makeCastMap([Q$IsWidget, Q$FrmMarkInputPresenter$MyView]), FrmMarkInputView_0);
...
defineSeed(1200, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$1_0);
...
defineSeed(1201, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$10_0);
...
defineSeed(1202, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$11_0);
...
defineSeed(1203, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$12_0);
...
defineSeed(1205, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$14_0);
...
defineSeed(1207, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$2_0);
...
defineSeed(1208, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$3_0);
...
defineSeed(1209, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$4_0);
...
defineSeed(1210, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$5_0);
...
defineSeed(1211, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$6_0);
...
defineSeed(1212, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$7_0);
...
defineSeed(1213, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$8_0);
...
defineSeed(1214, 386, makeCastMap([Q$HasCell, Q$Column]), FrmMarkInputView$9_0);
...
defineSeed(1402, 634, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$5X_0);
...
defineSeed(1434, 634, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$6X_0);
...
defineSeed(1467, 634, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$1X_0);
