...
defineSeed(1010, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(1016, 704, {}, UserManagementPresenterMyProxyImpl$2_0);
...
defineSeed(1280, 696, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1374, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$ProfessorProxy]));
...
defineSeed(1469, 634, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
