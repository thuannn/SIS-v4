...
defineSeed(1006, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$1_0);
...
defineSeed(1007, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$2_0);
...
defineSeed(1008, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$3_0);
...
defineSeed(1011, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$6_0);
...
defineSeed(1330, 696, makeCastMap([Q$IsWidget, Q$UserManagementPresenter$MyView]), UserManagementView_0);
...
defineSeed(1332, 360, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$10_0);
...
defineSeed(1333, 1, {}, UserManagementView$11_0);
...
defineSeed(1334, 386, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$12_0);
...
defineSeed(1335, 386, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$2_0);
...
defineSeed(1336, 386, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$3_0);
...
defineSeed(1337, 360, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$4_0);
...
defineSeed(1339, 360, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$6_0);
...
defineSeed(1341, 360, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$8_0);
...
defineSeed(1342, 1, {}, UserManagementView$9_0);
...
defineSeed(1518, 634, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$5X_0);
...
defineSeed(1519, 634, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$7X_0);
