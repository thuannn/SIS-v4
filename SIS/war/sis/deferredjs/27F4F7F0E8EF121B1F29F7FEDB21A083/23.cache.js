...
defineSeed(1334, 703, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1335, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1336, 1, {}, StudentView$2_0);
...
defineSeed(1337, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1338, 1, {}, StudentView$4_0);
...
defineSeed(1339, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1340, 1, {}, StudentView$6_0);
...
defineSeed(1341, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1342, 1, {}, StudentView$8_0);
...
defineSeed(1343, 1, {}, StudentView_BinderImpl_0);
...
defineSeed(1344, 1, {}, StudentView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1406, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
defineSeed(1439, 641, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1516, 641, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1518, 641, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1531, 641, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$11X_0);
