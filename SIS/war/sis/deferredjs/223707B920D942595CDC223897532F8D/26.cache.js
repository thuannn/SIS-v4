...
defineSeed(840, 631, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(850, 723, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(851, 705, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
...
defineSeed(852, 1, {}, FrmBulletinManagementPresenterMyProxyImpl$1$1_0);
...
defineSeed(1052, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(1053, 631, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1054, 631, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1055, 631, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1056, 631, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1057, 631, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1069, 631, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1075, 705, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1442, 697, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1443, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1445, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1447, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1449, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1558, 635, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1654, 635, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1656, 635, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1670, 635, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
