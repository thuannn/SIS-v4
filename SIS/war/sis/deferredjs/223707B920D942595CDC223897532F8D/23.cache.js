...
defineSeed(1021, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(1022, 631, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(1023, 631, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(1024, 631, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(1025, 631, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(1026, 631, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(1027, 631, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(1028, 631, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(1029, 631, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(1030, 631, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1409, 697, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1410, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1411, 359, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1414, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1415, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1416, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1417, 359, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1533, 635, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1534, 635, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1535, 635, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1625, 635, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
