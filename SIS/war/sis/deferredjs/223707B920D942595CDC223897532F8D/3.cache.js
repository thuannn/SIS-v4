...
defineSeed(777, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(778, 631, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(779, 631, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(780, 631, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(781, 631, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1149, 697, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1150, 359, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1152, 359, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1591, 635, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
