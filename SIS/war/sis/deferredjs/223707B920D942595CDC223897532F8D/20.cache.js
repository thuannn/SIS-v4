...
;
defineSeed(872, 723, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(873, 705, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1_0);
...
defineSeed(874, 1, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1$1_0);
...
defineSeed(971, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(972, 631, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(973, 631, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(974, 631, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(991, 705, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1363, 697, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1671, 635, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
