...
defineSeed(868, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseAddPresenter, Q$FrmClasseAddUiHandler]), FrmClasseAddPresenter_0);
...
defineSeed(869, 628, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$1_0);
...
defineSeed(870, 628, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$2_0);
...
defineSeed(871, 628, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$3_0);
...
defineSeed(1187, 694, makeCastMap([Q$IsWidget, Q$FrmClasseAddPresenter$MyView]), FrmClasseAddView_0);
...
defineSeed(1188, 10, makeCastMap([Q$Timer]), FrmClasseAddView$1_0);
...
defineSeed(1451, 632, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$8X_0);
