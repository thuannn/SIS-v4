...
defineSeed(1137, 697, makeCastMap([Q$IsWidget, Q$ContactPresenter$MyView]), ContactView_0);
...
defineSeed(1138, 1, {}, ContactView_BinderImpl_0);
...
defineSeed(1139, 1, {}, ContactView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1140, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ContactView_BinderImpl$Widgets$1_0);
...
defineSeed(1577, 626, {}, ContactRequestFactoryImpl_0);
...
defineSeed(1578, 636, makeCastMap([Q$AbstractRequestContext]), ContactRequestFactory_ContactRequestContextImpl_0);
...
defineSeed(1579, 635, makeCastMap([Q$AbstractRequest]), ContactRequestFactory_ContactRequestContextImpl$1X_0);
...
defineSeed(1580, 564, makeCastMap([Q$EnumMap]), ContactRequestFactory_ContactRequestContextImpl_FactoryImpl_0);
