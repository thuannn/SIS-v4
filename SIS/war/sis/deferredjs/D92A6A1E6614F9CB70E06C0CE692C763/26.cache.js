...
defineSeed(772, 235, {}, StudentAfterStatusChangeEvent_0);
...
defineSeed(856, 644, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(866, 736, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(867, 718, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1068, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(1069, 644, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1070, 644, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1071, 644, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1072, 644, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1073, 644, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1085, 644, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1091, 718, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1459, 710, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1460, 366, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1462, 366, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1464, 366, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1466, 366, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1575, 648, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1671, 648, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1673, 648, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1687, 648, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
