...
;
defineSeed(888, 736, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(889, 718, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1_0);
...
defineSeed(987, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(988, 644, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(989, 644, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(990, 644, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(1007, 718, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1380, 710, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1688, 648, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
