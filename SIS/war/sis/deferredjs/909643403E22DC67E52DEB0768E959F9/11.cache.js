...
defineSeed(477, 433, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]));
...
defineSeed(925, 725, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinViewDetailPresenter, Q$FrmBulletinViewDetailUiHandler]), FrmBulletinViewDetailPresenter_0);
...
defineSeed(926, 664, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$1_0);
...
defineSeed(927, 664, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$2_0);
...
defineSeed(928, 664, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$3_0);
...
defineSeed(929, 664, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$4_0);
...
defineSeed(930, 664, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$5_0);
...
defineSeed(931, 664, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$6_0);
...
function FrmBulletinViewDetailView_0(){
  this.widget = $build_f_HTMLPanel1_10(new FrmBulletinViewDetailView_BinderImpl$Widgets_0(this));
}

defineSeed(1302, 730, makeCastMap([Q$IsWidget, Q$FrmBulletinViewDetailPresenter$MyView]), FrmBulletinViewDetailView_0);
...
defineSeed(1303, 1, {}, FrmBulletinViewDetailView_BinderImpl_0);
function $build_f_HTMLPanel1_10(this$static){
  var attachRecord10, f_HTMLPanel1, f_VerticalPanel2, f_Label3, f_VerticalPanel4, f_VerticalPanel5, tblBulletin, pnlAdmin, f_Label6, lstClasses, f_HorizontalPanel7, f_Label8, lstBulletins;
...
defineSeed(1304, 1, {}, FrmBulletinViewDetailView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1305, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewDetailView_BinderImpl$Widgets$1_0);
...
defineSeed(1306, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewDetailView_BinderImpl$Widgets$2_0);
...
defineSeed(1623, 668, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X_0);
...
defineSeed(1634, 668, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$2X_0);
...
defineSeed(1637, 668, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$8X_0);
...
;
_.val$email = null;
var Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter', 925), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$1', 926), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$2', 927), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$3', 928), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$4', 929), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$5', 930), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$6', 931), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView', 1302), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl', 1303), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets', 1304), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets$1', 1305), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets$2', 1306), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$2X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$2X', 1634), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$8X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$8X', 1637), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X', 1623);
$entry(onLoad)(11);
