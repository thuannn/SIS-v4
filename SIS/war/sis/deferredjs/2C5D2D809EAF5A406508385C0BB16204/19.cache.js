...
defineSeed(791, 232, {}, DrawSchoolInterfaceEvent_0);
...
;
defineSeed(911, 765, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(912, 747, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1_0);
...
defineSeed(913, 1, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1$1_0);
...
defineSeed(974, 734, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(975, 674, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(976, 674, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(977, 674, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(994, 747, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1314, 739, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1319, 1, makeCastMap([Q$FocusHandler, Q$EventHandler]), HomeView_HomeViewUiBinderImpl$Widgets$3_0);
...
defineSeed(1592, 678, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
