...
defineSeed(798, 232, {}, StudentAfterStatusChangeEvent_0);
...
defineSeed(879, 674, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(889, 765, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(890, 747, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
...
defineSeed(891, 1, {}, FrmBulletinManagementPresenterMyProxyImpl$1$1_0);
...
defineSeed(1055, 734, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(1056, 674, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1057, 674, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1058, 674, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1059, 674, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1060, 674, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1072, 674, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1078, 747, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1393, 739, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1394, 373, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1396, 373, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1398, 373, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1400, 373, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1465, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
;
defineSeed(1466, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
defineSeed(1499, 678, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1576, 678, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1578, 678, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1591, 678, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$11X_0);
