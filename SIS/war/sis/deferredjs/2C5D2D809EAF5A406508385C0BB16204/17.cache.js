...
defineSeed(955, 734, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmPasswordPresenter, Q$FrmPasswordUiHandler]), FrmPasswordPresenter_0);
...
defineSeed(956, 674, makeCastMap([Q$Receiver]), FrmPasswordPresenter$1_0);
_.onFailure_0 = function onFailure_64(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_64(response){
  $onSuccess_62(this, dynamicCast(response, Q$UserProxy));
}
;
_.this$0 = null;
...
function FrmPasswordView_0(){
  this.widget = $build_f_HTMLPanel1_15(new FrmPasswordView_BinderImpl$Widgets_0(this));
}

defineSeed(1293, 739, makeCastMap([Q$IsWidget, Q$FrmPasswordPresenter$MyView]), FrmPasswordView_0);
...
defineSeed(1294, 1, {}, FrmPasswordView_BinderImpl_0);
function $build_f_HTMLPanel1_15(this$static){
  var attachRecord16, f_HTMLPanel1, f_VerticalPanel2, f_Label3, f_Grid4, f_Label5, f_Label6, txtCurrentPassword, f_Label7, txtNewPassword1, f_Label8, txtNewPassword2, f_Label9, cmdSave;
...
defineSeed(1295, 1, {}, FrmPasswordView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1296, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmPasswordView_BinderImpl$Widgets$1_0);
...
defineSeed(1593, 678, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$2X_0);
...
_.val$password = null;
_.val$userName = null;
var Lcom_lemania_sis_client_presenter_FrmPasswordPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmPasswordPresenter', 955), Lcom_lemania_sis_client_presenter_FrmPasswordPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmPasswordPresenter$1', 956), Lcom_lemania_sis_client_view_FrmPasswordView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmPasswordView', 1293), Lcom_lemania_sis_client_view_FrmPasswordView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmPasswordView_BinderImpl', 1294), Lcom_lemania_sis_client_view_FrmPasswordView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmPasswordView_BinderImpl$Widgets', 1295), Lcom_lemania_sis_client_view_FrmPasswordView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmPasswordView_BinderImpl$Widgets$1', 1296), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$2X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$2X', 1593);
$entry(onLoad)(17);
