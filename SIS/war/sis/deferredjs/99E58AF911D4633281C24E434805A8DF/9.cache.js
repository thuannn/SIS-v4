...
defineSeed(769, 663, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(770, 602, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(771, 602, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(772, 602, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(773, 602, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(961, 668, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(962, 346, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(964, 346, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1147, 606, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$8X_0);
