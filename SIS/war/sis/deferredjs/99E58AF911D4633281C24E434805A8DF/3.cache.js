...
defineSeed(734, 663, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(735, 602, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(736, 602, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(737, 602, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(738, 602, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(915, 668, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(916, 346, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(918, 346, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1153, 606, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
