...
defineSeed(763, 663, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$FrmClasseAddUiHandler]), FrmClasseAddPresenter_0);
...
defineSeed(764, 602, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$1_0);
...
defineSeed(765, 602, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$2_0);
...
defineSeed(766, 602, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$3_0);
...
defineSeed(954, 668, makeCastMap([Q$IsWidget, Q$FrmClasseAddPresenter$MyView]), FrmClasseAddView_0);
...
defineSeed(955, 12, makeCastMap([Q$Timer]), FrmClasseAddView$1_0);
...
defineSeed(1146, 606, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$7X_0);
