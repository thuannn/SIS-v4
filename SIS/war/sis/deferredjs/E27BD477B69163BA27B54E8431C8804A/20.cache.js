...
defineSeed(1284, 690, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1285, 382, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1286, 356, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1289, 382, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1290, 382, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1291, 382, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1292, 356, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1347, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$AssignmentProxy]));
...
defineSeed(1396, 628, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1397, 628, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1398, 628, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1467, 628, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
