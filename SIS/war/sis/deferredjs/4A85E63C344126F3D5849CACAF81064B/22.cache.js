...
defineSeed(955, 689, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(956, 628, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(971, 628, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(976, 702, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1271, 694, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1462, 632, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
