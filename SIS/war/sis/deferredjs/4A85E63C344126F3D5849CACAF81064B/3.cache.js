...
defineSeed(766, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(767, 628, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(768, 628, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(769, 628, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(770, 628, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1046, 694, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1415, 632, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
