...
defineSeed(1406, 697, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1407, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1408, 359, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1411, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1412, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1413, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1414, 359, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1530, 635, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1531, 635, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1532, 635, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1621, 635, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
