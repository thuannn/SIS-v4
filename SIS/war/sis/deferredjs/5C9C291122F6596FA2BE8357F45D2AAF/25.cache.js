...
defineSeed(1045, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAddPresenter, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(1046, 631, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(1065, 631, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(1070, 705, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1432, 697, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1653, 635, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
