...
defineSeed(871, 276, {}, StudentAfterStatusChangeEvent_0);
...
defineSeed(1082, 796, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentListUiHandler, Q$StudentPresenter]), StudentPresenter_0);
...
defineSeed(1083, 727, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1084, 727, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1085, 727, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1086, 727, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1087, 727, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1092, 801, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1093, 427, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1094, 1, {}, StudentView$2_0);
...
defineSeed(1095, 427, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1096, 1, {}, StudentView$4_0);
...
defineSeed(1097, 427, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1098, 1, {}, StudentView$6_0);
...
defineSeed(1099, 427, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1100, 1, {}, StudentView$8_0);
...
defineSeed(1101, 1, {}, StudentView_BinderImpl_0);
...
defineSeed(1102, 1, {}, StudentView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1114, 727, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1120, 809, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1121, 1, {}, UserManagementPresenterMyProxyImpl$3$1_0);
...
defineSeed(1248, 796, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler, Q$FrmBulletinManagementPresenter, Q$FrmBulletinManagementUiHandler]));
...
defineSeed(1255, 727, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(1265, 824, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(1266, 809, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
_.success = function success_27(presenter){
  $success_25(this, dynamicCast(presenter, Q$FrmBulletinManagementPresenter));
}
;
_.val$event = null;
...
defineSeed(1267, 1, {}, FrmBulletinManagementPresenterMyProxyImpl$1$1_0);
...
defineSeed(1850, 731, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$14X_0);
...
defineSeed(2026, 731, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
...
defineSeed(2035, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
;
defineSeed(2036, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
defineSeed(2039, 731, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
_.makeRequestData = function makeRequestData_99(){
...
defineSeed(2042, 731, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
var Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$15_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$15', 1255), Lcom_lemania_sis_client_event_StudentAfterStatusChangeEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'StudentAfterStatusChangeEvent', 871), Lcom_lemania_sis_client_form_studentmgt_StudentPresenter_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentPresenter', 1082), Lcom_lemania_sis_client_form_studentmgt_StudentPresenter$1_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentPresenter$1', 1083), Lcom_lemania_sis_client_form_studentmgt_StudentPresenter$2_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentPresenter$2', 1084), Lcom_lemania_sis_client_form_studentmgt_StudentPresenter$3_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentPresenter$3', 1085), Lcom_lemania_sis_client_form_studentmgt_StudentPresenter$4_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentPresenter$4', 1086), Lcom_lemania_sis_client_form_studentmgt_StudentPresenter$5_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentPresenter$5', 1087), Lcom_lemania_sis_client_form_usermgt_UserManagementPresenter$7_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementPresenter$7', 1114), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenterMyProxyImpl$1', 1266), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenterMyProxyImpl$1$1', 1267), Lcom_lemania_sis_client_form_usermgt_UserManagementPresenterMyProxyImpl$3_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementPresenterMyProxyImpl$3', 1120), Lcom_lemania_sis_client_form_usermgt_UserManagementPresenterMyProxyImpl$3$1_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementPresenterMyProxyImpl$3$1', 1121), Lcom_lemania_sis_client_form_studentmgt_StudentView_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView', 1092), Lcom_lemania_sis_client_form_studentmgt_StudentView$1_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$1', 1093), Lcom_lemania_sis_client_form_studentmgt_StudentView$2_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$2', 1094), Lcom_lemania_sis_client_form_studentmgt_StudentView$3_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$3', 1095), Lcom_lemania_sis_client_form_studentmgt_StudentView$4_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$4', 1096), Lcom_lemania_sis_client_form_studentmgt_StudentView$5_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$5', 1097), Lcom_lemania_sis_client_form_studentmgt_StudentView$6_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$6', 1098), Lcom_lemania_sis_client_form_studentmgt_StudentView$7_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$7', 1099), Lcom_lemania_sis_client_form_studentmgt_StudentView$8_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$8', 1100), Lcom_lemania_sis_client_form_studentmgt_StudentView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView_BinderImpl', 1101), Lcom_lemania_sis_client_form_studentmgt_StudentView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView_BinderImpl$Widgets', 1102), Lcom_lemania_sis_shared_bulletin_BulletinRequestFactory_1BulletinRequestContextImpl$14X_2_classLit = createForClass('com.lemania.sis.shared.bulletin.', 'BulletinRequestFactory_BulletinRequestContextImpl$14X', 1850), Lcom_lemania_sis_shared_student_StudentRequestFactory_1StudentRequestContextImpl$1X_2_classLit = createForClass('com.lemania.sis.shared.student.', 'StudentRequestFactory_StudentRequestContextImpl$1X', 2039), Lcom_lemania_sis_shared_student_StudentRequestFactory_1StudentRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.student.', 'StudentRequestFactory_StudentRequestContextImpl$7X', 2042), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$12X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$12X', 2026);
$entry(onLoad)(33);
