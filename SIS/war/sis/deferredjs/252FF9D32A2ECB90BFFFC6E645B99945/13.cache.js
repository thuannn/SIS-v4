...
defineSeed(878, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(879, 630, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(880, 630, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(881, 630, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(882, 630, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1196, 696, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1197, 360, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(1199, 360, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1450, 634, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1454, 634, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
