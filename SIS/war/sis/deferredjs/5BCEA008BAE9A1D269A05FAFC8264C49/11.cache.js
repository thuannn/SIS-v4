...
function $drawPrematurite(this$static, subjects, redraw){
  ...
  for (i = rowStart.value_0; i < subjects.size_1() + rowStart.value_0; i++) {
    ...
    $setText_0(this$static.tblNotes, i, 8, dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getT4());
    $setText_0(this$static.tblNotes, i, 9, dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getExamT4());
    $setText_0(this$static.tblNotes, i, 10, dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getAn());
