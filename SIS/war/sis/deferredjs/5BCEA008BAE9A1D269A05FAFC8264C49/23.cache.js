...
function $saveAssignment(this$static, professorId, classId, subjectId, isActive){
  ...
  $initialize_0(rf, this$static.eventBus, new EventSourceRequestTransport_0(this$static.eventBus));
  rc = new AssignmentRequestFactory_AssignmentRequestContextImpl_0(rf);
  $fire((x_0 = new AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0(rc, professorId, classId, subjectId, isActive) , $addInvocation(rc.state.dialect, x_0) , x_0), new ProfsPresenter$8_0(this$static));
}

function $updateAssignmentStatus(this$static, assignment, value_0){
  var a4update, rc, rf, x_0;
  if (this$static.currentUser.isReadOnly) {
    alert_0(($clinit_NotificationTypes() , "Vous avez l'acc\xE8s en lecture seule - La modification n'a pas \xE9t\xE9 effectu\xE9e"));
    return;
  }
  ...
  a4update.setActive(value_0);
  $fire((x_0 = new AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0(rc, a4update) , $addInvocation(rc.state.dialect, x_0) , x_0), new ProfsPresenter$9_0(this$static));
}
...
function $updateProfessorStatus(this$static, prof, status_0){
  ...
  $fire((x_0 = new ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0(rc, profForUpdate) , $addInvocation(rc.state.dialect, x_0) , x_0), new ProfsPresenter$3_0(this$static));
}
...
defineSeed(1036, 704, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(1037, 643, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(1038, 643, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(1039, 643, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(1040, 643, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
_.onFailure_0 = function onFailure_114(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_114(response){
  $onSuccess_110(this, dynamicCast(response, Q$ProfessorProxy));
}
;
...
defineSeed(1041, 643, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(1042, 643, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(1043, 643, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(1044, 643, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(1045, 643, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
_.onFailure_0 = function onFailure_119(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_119(response){
  $onSuccess_115(this, dynamicCast(response, Q$AssignmentProxy));
}
;
...
function $onCmdAssignerClick(this$static){
  !!this$static.uiHandlers && $saveAssignment(dynamicCast(this$static.uiHandlers, Q$ProfessorListUiHandler), '' + toString_6(this$static.selectedProfessor.getId_0().value_0), $getValue_1(this$static.lstClasses, $getSelectElement(this$static.lstClasses).selectedIndex), $getValue_1(this$static.lstSubjects, $getSelectElement(this$static.lstSubjects).selectedIndex), ($clinit_Boolean() , $clinit_Boolean() , TRUE_1));
}
...
function $onLstCoursChange_0(this$static){
  if (!$getValue_1(this$static.lstCours, $getSelectElement(this$static.lstCours).selectedIndex).length) {
    $selectClear($getSelectElement(this$static.lstClasses));
    $setSelectedIndex_0(this$static.lstSubjects, 0);
    return;
  }
  !!this$static.uiHandlers && $onProgrammeSelected_3(dynamicCast(this$static.uiHandlers, Q$ProfessorListUiHandler), $getValue_1(this$static.lstCours, $getSelectElement(this$static.lstCours).selectedIndex));
}
...
function $onLstEcolesChange_5(this$static){
  ...
  !!this$static.uiHandlers && $onEcoleSelected_5(dynamicCast(this$static.uiHandlers, Q$ProfessorListUiHandler), $getValue_1(this$static.lstEcoles, $getSelectElement(this$static.lstEcoles).selectedIndex));
}
...
defineSeed(1428, 709, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1429, 390, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1430, 364, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
_.getValue = function getValue_74(ecole){
  return dynamicCast(ecole, Q$ProfessorProxy).getProfActive();
}
;
function $update_29(this$static, index_0, prof, value_0){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedProf = index_0;
...
defineSeed(1431, 1, {}, ProfsView$3_0);
_.update = function update_30(index_0, prof, value_0){
  $update_29(this, index_0, dynamicCast(prof, Q$ProfessorProxy), dynamicCast(value_0, Q$Boolean));
}
;
...
defineSeed(1432, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), ProfsView$4_0);
...
defineSeed(1433, 390, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1434, 390, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1435, 390, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1436, 364, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
_.getValue = function getValue_78(ecole){
  return dynamicCast(ecole, Q$AssignmentProxy).getActive();
}
;
function $update_30(this$static, index_0, assignment, value_0){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedAssignmentIndex = index_0;
    $updateAssignmentStatus(dynamicCast(this$static.this$0.uiHandlers, Q$ProfessorListUiHandler), assignment, value_0);
  }
}
...
defineSeed(1437, 1, {}, ProfsView$9_0);
_.update = function update_31(index_0, assignment, value_0){
  $update_30(this, index_0, dynamicCast(assignment, Q$AssignmentProxy), dynamicCast(value_0, Q$Boolean));
}
;
function ProfsView_BinderImpl_0(){
}

defineSeed(1438, 1, {}, ProfsView_BinderImpl_0);
function $build_f_HTMLPanel1_22(this$static){
  ...
  $addAndReplaceElement(f_HTMLPanel1, (f_VerticalPanel2 = new VerticalPanel_0 , $add_11(f_VerticalPanel2, (f_Label3 = new Label_0 , $setClassName(f_Label3.element, 'pageTitle') , $setAutoHorizontalAlignment(f_Label3, ($clinit_HasHorizontalAlignment() , ALIGN_CENTER)) , $setTextOrHtml(f_Label3.directionalTextHelper, 'LISTE DES PROFESSEURS', false) , $updateHorizontalAlignment(f_Label3) , f_Label3)) , $add_11(f_VerticalPanel2, (f_HorizontalPanel4 = new HorizontalPanel_0 , $add_9(f_HorizontalPanel4, (f_VerticalPanel5 = new VerticalPanel_0 , $add_11(f_VerticalPanel5, (tblProfessors = this$static.owner.tblProfessors , $setKeyboardPagingPolicy(tblProfessors, ($clinit_HasKeyboardPagingPolicy$KeyboardPagingPolicy() , INCREASE_RANGE)) , tblProfessors.element.style['height'] = '700px' , tblProfessors.element.style['width'] = '300px' , $setVisibleRange(tblProfessors, new Range_1($getVisibleRange(tblProfessors.presenter).start_0, 1000)) , $setKeyboardSelectionPolicy(tblProfessors, ($clinit_HasKeyboardSelectionPolicy$KeyboardSelectionPolicy() , DISABLED)) , tblProfessors)) , f_VerticalPanel5.element.style['width'] = '' , $setPropertyInt(f_VerticalPanel5.table, 'cellSpacing', 2) , f_VerticalPanel5)) , $add_9(f_HorizontalPanel4, (f_VerticalPanel6 = new VerticalPanel_0 , $add_11(f_VerticalPanel6, (lblProfNameAssign = new Label_0 , $setClassName(lblProfNameAssign.element, 'header') , $setTextOrHtml(lblProfNameAssign.directionalTextHelper, '-', false) , $updateHorizontalAlignment(lblProfNameAssign) , this$static.owner.lblProfNameAssign = lblProfNameAssign , lblProfNameAssign)) , $add_11(f_VerticalPanel6, (f_Label7 = new Label_0 , $setClassName(f_Label7.element, 'sectionTitle') , $setTextOrHtml(f_Label7.directionalTextHelper, 'Assigner une classe', false) , $updateHorizontalAlignment(f_Label7) , f_Label7.element.style['width'] = '' , f_Label7)) , $add_11(f_VerticalPanel6, (f_Grid8 = new Grid_0 , $resizeColumns(f_Grid8, 2) , $resizeRows(f_Grid8, 5) , $setWidget_1(f_Grid8, 0, 0, (f_Label9 = new Label_0 , $setTextOrHtml(f_Label9.directionalTextHelper, 'Ecole :', false) , $updateHorizontalAlignment(f_Label9) , f_Label9.element.style['width'] = '' , f_Label9)) , $setWidget_1(f_Grid8, 0, 1, (lstEcoles = new ListBox_0 , $setClassName(lstEcoles.element, 'sis_textbox') , $addDomHandler(lstEcoles, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, ($clinit_ChangeEvent() , $clinit_ChangeEvent() , TYPE)) , this$static.owner.lstEcoles = lstEcoles , lstEcoles)) , $setWidget_1(f_Grid8, 1, 0, (f_Label10 = new Label_0 , $setTextOrHtml(f_Label10.directionalTextHelper, 'Programme :', false) , $updateHorizontalAlignment(f_Label10) , f_Label10.element.style['width'] = '' , f_Label10)) , $setWidget_1(f_Grid8, 1, 1, (lstCours = new ListBox_0 , $setClassName(lstCours.element, 'sis_textbox') , $addDomHandler(lstCours, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames3, TYPE) , this$static.owner.lstCours = lstCours , lstCours)) , $setWidget_1(f_Grid8, 2, 0, (f_Label11 = new Label_0 , $setTextOrHtml(f_Label11.directionalTextHelper, 'Classe :', false) , $updateHorizontalAlignment(f_Label11) , f_Label11)) , $setWidget_1(f_Grid8, 2, 1, (lstClasses = new ListBox_0 , $setClassName(lstClasses.element, 'sis_textbox') , $addDomHandler(lstClasses, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames4, TYPE) , this$static.owner.lstClasses = lstClasses , lstClasses)) , $setWidget_1(f_Grid8, 3, 0, (f_Label12 = new Label_0 , $setTextOrHtml(f_Label12.directionalTextHelper, 'Mati\xE8re :', false) , $updateHorizontalAlignment(f_Label12) , f_Label12)) , $setWidget_1(f_Grid8, 3, 1, (lstSubjects = new ListBox_0 , $setClassName(lstSubjects.element, 'sis_textbox') , this$static.owner.lstSubjects = lstSubjects , lstSubjects)) , $setWidget_1(f_Grid8, 4, 0, new Label_0) , $setWidget_1(f_Grid8, 4, 1, (cmdAssigner = new Button_0 , $setHTML(cmdAssigner, (sb = new StringBuilder_0 , $append_2(sb.impl, 'Ajouter') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0(sb.impl.string)).html) , cmdAssigner.element.style['width'] = '100px' , $addDomHandler(cmdAssigner, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_ClickEvent() , $clinit_ClickEvent() , TYPE_0)) , cmdAssigner)) , $setClassName(f_Grid8.element, 'subSection') , f_Grid8.element.style['width'] = '100%' , $setPropertyInt(f_Grid8.tableElem, 'cellSpacing', 2) , $setPropertyInt(f_Grid8.tableElem, 'cellPadding', 2) , f_Grid8)) , $add_11(f_VerticalPanel6, (f_Label14 = new Label_0 , $setClassName(f_Label14.element, 'hiddenText') , $setTextOrHtml(f_Label14.directionalTextHelper, '.', false) , $updateHorizontalAlignment(f_Label14) , f_Label14)) , $add_11(f_VerticalPanel6, (f_Label15 = new Label_0 , $setClassName(f_Label15.element, 'sectionTitle') , $setTextOrHtml(f_Label15.directionalTextHelper, 'Liste des classes assign\xE9s', false) , $updateHorizontalAlignment(f_Label15) , f_Label15)) , $add_11(f_VerticalPanel6, (tblAssignments = this$static.owner.tblAssignments , $setClassName(tblAssignments.element, 'subSection') , tblAssignments.element.style['height'] = '425PX' , tblAssignments.element.style['width'] = '650px' , tblAssignments)) , f_VerticalPanel6.element.style['width'] = '' , $setPropertyInt(f_VerticalPanel6.table, 'cellSpacing', 2) , f_VerticalPanel6)) , f_HorizontalPanel4.element.style['width'] = '850px' , $setPropertyInt(f_HorizontalPanel4.table, 'cellSpacing', 5) , f_HorizontalPanel4)) , f_VerticalPanel2.element.style['width'] = '100%' , $setPropertyInt(f_VerticalPanel2.table, 'cellSpacing', 2) , f_VerticalPanel2), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(1439, 1, {}, ProfsView_BinderImpl$Widgets_0);
function ProfsView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1440, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$1_0);
...
defineSeed(1441, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$2_0);
...
defineSeed(1442, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$3_0);
...
defineSeed(1443, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfsView_BinderImpl$Widgets$4_0);
...
defineSeed(1494, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$AssignmentProxy]));
_.setActive = function setActive(active){
  dynamicCast($getWrapped(this.this$0), Q$AssignmentProxy).setActive(active);
}
;
defineSeed(1495, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$AssignmentProxy]));
...
defineSeed(1552, 647, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1553, 647, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1554, 647, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1644, 647, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
...
;
var Lcom_lemania_sis_client_presenter_ProfsPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsPresenter', 1036), Lcom_lemania_sis_client_presenter_ProfsPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsPresenter$1', 1037), Lcom_lemania_sis_client_presenter_ProfsPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsPresenter$2', 1039), Lcom_lemania_sis_client_presenter_ProfsPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsPresenter$3', 1040), Lcom_lemania_sis_client_presenter_ProfsPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsPresenter$5', 1041), Lcom_lemania_sis_client_presenter_ProfsPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsPresenter$6', 1042), Lcom_lemania_sis_client_presenter_ProfsPresenter$7_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsPresenter$7', 1043), Lcom_lemania_sis_client_presenter_ProfsPresenter$8_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsPresenter$8', 1044), Lcom_lemania_sis_client_presenter_ProfsPresenter$9_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsPresenter$9', 1045), Lcom_lemania_sis_client_presenter_ProfsPresenter$10_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsPresenter$10', 1038), Lcom_lemania_sis_client_view_ProfsView_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView', 1428), Lcom_lemania_sis_client_view_ProfsView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView$1', 1429), Lcom_lemania_sis_client_view_ProfsView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView$2', 1430), Lcom_lemania_sis_client_view_ProfsView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView$3', 1431), Lcom_lemania_sis_client_view_ProfsView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView$4', 1432), Lcom_lemania_sis_client_view_ProfsView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView$5', 1433), Lcom_lemania_sis_client_view_ProfsView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView$6', 1434), Lcom_lemania_sis_client_view_ProfsView$7_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView$7', 1435), Lcom_lemania_sis_client_view_ProfsView$8_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView$8', 1436), Lcom_lemania_sis_client_view_ProfsView$9_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView$9', 1437), Lcom_lemania_sis_client_view_ProfsView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView_BinderImpl', 1438), Lcom_lemania_sis_client_view_ProfsView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView_BinderImpl$Widgets', 1439), Lcom_lemania_sis_client_view_ProfsView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView_BinderImpl$Widgets$1', 1440), Lcom_lemania_sis_client_view_ProfsView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView_BinderImpl$Widgets$2', 1441), Lcom_lemania_sis_client_view_ProfsView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView_BinderImpl$Widgets$3', 1442), Lcom_lemania_sis_client_view_ProfsView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsView_BinderImpl$Widgets$4', 1443), Lcom_lemania_sis_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$6X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$6X', 1644), Lcom_lemania_sis_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$3X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$3X', 1554), Lcom_lemania_sis_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$10X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$10X', 1552), Lcom_lemania_sis_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$11X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'AssignmentRequestFactory_AssignmentRequestContextImpl$11X', 1553);
$entry(onLoad)(23);
