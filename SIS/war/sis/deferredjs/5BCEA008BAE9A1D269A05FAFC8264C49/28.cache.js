...
function $loadUsersByType(this$static, type_0){
  var rc, rf, rf_0, rc_0, x_0, x_1;
  if ($equals_5(type_0, ''))
    return;
  if ($equals_5(type_0, 'tout')) {
    ...
    $fire((x_0 = new UserRequestFactory_UserRequestContextImpl$6X_0(rc_0) , $addInvocation(rc_0.state.dialect, x_0) , x_0), new UserManagementPresenter$1_0(this$static));
    return;
  }
  rf = new UserRequestFactoryImpl_0;
  $initialize_0(rf, this$static.eventBus, new EventSourceRequestTransport_0(this$static.eventBus));
  rc = new UserRequestFactory_UserRequestContextImpl_0(rf);
  $fire((x_1 = new UserRequestFactory_UserRequestContextImpl$8X_0(rc, type_0) , $addInvocation(rc.state.dialect, x_1) , x_1), new UserManagementPresenter$6_0(this$static));
}
...
defineSeed(1078, 643, makeCastMap([Q$Receiver]), UserManagementPresenter$1_0);
...
defineSeed(1079, 643, makeCastMap([Q$Receiver]), UserManagementPresenter$2_0);
...
;
function $onSuccess_129(this$static){
...
defineSeed(1080, 643, makeCastMap([Q$Receiver]), UserManagementPresenter$3_0);
_.onFailure_0 = function onFailure_134(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_134(response){
  $onSuccess_129(this, throwClassCastExceptionUnlessNull(response));
}
;
...
defineSeed(1083, 643, makeCastMap([Q$Receiver]), UserManagementPresenter$6_0);
...
function $onLstUserTypesChange(this$static){
  !!this$static.uiHandlers && $loadUsersByType(dynamicCast(this$static.uiHandlers, Q$UserManagementUiHandler), $getValue_1(this$static.lstUserTypes, $getSelectElement(this$static.lstUserTypes).selectedIndex));
}
...
function $setUserData(this$static, list){
  ...
  $setHeight_0(this$static.tblUser, '' + (list.size_1() + 1) * ($clinit_NotificationTypes() , lineHeightShortList).value_0 + 'px');
}
...
defineSeed(1473, 709, makeCastMap([Q$IsWidget, Q$UserManagementPresenter$MyView, Q$UserManagementView]), UserManagementView_0);
...
defineSeed(1474, 390, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$1_0);
_.getValue = function getValue_83(object){
  return dynamicCast(object, Q$UserProxy).getFullName();
}
;
function $update_35(this$static, index_0, user, value_0){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedUserIndex = index_0;
    $updateUserStatus(dynamicCast(this$static.this$0.uiHandlers, Q$UserManagementUiHandler), user, user.getActive(), user.getAdmin(), value_0, user.getIsStudent());
  }
}
...
defineSeed(1475, 1, {}, UserManagementView$10_0);
_.update = function update_36(index_0, user, value_0){
  $update_35(this, index_0, dynamicCast(user, Q$UserProxy), dynamicCast(value_0, Q$Boolean));
}
;
...
defineSeed(1476, 364, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$11_0);
_.getValue = function getValue_84(user){
  return dynamicCast(user, Q$UserProxy).getIsStudent();
}
;
function $update_36(this$static, index_0, user, value_0){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedUserIndex = index_0;
    $updateUserStatus(dynamicCast(this$static.this$0.uiHandlers, Q$UserManagementUiHandler), user, user.getActive(), user.getAdmin(), user.getIsProf(), value_0);
  }
}
...
defineSeed(1477, 1, {}, UserManagementView$12_0);
_.update = function update_37(index_0, user, value_0){
  $update_36(this, index_0, dynamicCast(user, Q$UserProxy), dynamicCast(value_0, Q$Boolean));
}
;
...
defineSeed(1478, 390, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$13_0);
...
defineSeed(1479, 390, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$2_0);
...
defineSeed(1480, 390, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$3_0);
...
defineSeed(1481, 364, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$4_0);
_.getValue = function getValue_88(ecole){
  return dynamicCast(ecole, Q$UserProxy).getActive();
}
;
function $update_37(this$static, index_0, user, value_0){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedUserIndex = index_0;
    $updateUserStatus(dynamicCast(this$static.this$0.uiHandlers, Q$UserManagementUiHandler), user, value_0, user.getAdmin(), user.getIsProf(), user.getIsStudent());
  }
}
...
defineSeed(1482, 1, {}, UserManagementView$5_0);
_.update = function update_38(index_0, user, value_0){
  $update_37(this, index_0, dynamicCast(user, Q$UserProxy), dynamicCast(value_0, Q$Boolean));
}
;
...
defineSeed(1483, 364, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$6_0);
_.getValue = function getValue_89(user){
  return dynamicCast(user, Q$UserProxy).getAdmin();
}
;
function $update_38(this$static, index_0, user, value_0){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedUserIndex = index_0;
    $updateUserStatus(dynamicCast(this$static.this$0.uiHandlers, Q$UserManagementUiHandler), user, user.getActive(), value_0, user.getIsProf(), user.getIsStudent());
  }
}
...
defineSeed(1484, 1, {}, UserManagementView$7_0);
_.update = function update_39(index_0, user, value_0){
  $update_38(this, index_0, dynamicCast(user, Q$UserProxy), dynamicCast(value_0, Q$Boolean));
}
;
...
defineSeed(1485, 364, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$8_0);
...
defineSeed(1486, 364, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$9_0);
...
defineSeed(1487, 1, {}, UserManagementView_BinderImpl_0);
...
function UserManagementView_BinderImpl$Widgets_0(owner){
  ...
  $setHeight_0(this.tblUser, '450px');
  $setWidth_0(this.tblUser, '100%');
  this.domId0Element = new LazyDomElement_0(this.domId0);
}

defineSeed(1488, 1, {}, UserManagementView_BinderImpl$Widgets_0);
function UserManagementView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1489, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), UserManagementView_BinderImpl$Widgets$1_0);
...
defineSeed(1490, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), UserManagementView_BinderImpl$Widgets$2_0);
...
defineSeed(1694, 647, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$6X_0);
...
defineSeed(1695, 647, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$8X_0);
...
;
var Lcom_lemania_sis_client_presenter_UserManagementPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter', 1077), Lcom_lemania_sis_client_presenter_UserManagementPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$1', 1078), Lcom_lemania_sis_client_presenter_UserManagementPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$2', 1079), Lcom_lemania_sis_client_presenter_UserManagementPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$3', 1080), Lcom_lemania_sis_client_presenter_UserManagementPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$6', 1083), Lcom_lemania_sis_client_view_UserManagementView_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView', 1473), Lcom_lemania_sis_client_view_UserManagementView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$1', 1474), Lcom_lemania_sis_client_view_UserManagementView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$2', 1479), Lcom_lemania_sis_client_view_UserManagementView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$3', 1480), Lcom_lemania_sis_client_view_UserManagementView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$4', 1481), Lcom_lemania_sis_client_view_UserManagementView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$5', 1482), Lcom_lemania_sis_client_view_UserManagementView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$6', 1483), Lcom_lemania_sis_client_view_UserManagementView$7_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$7', 1484), Lcom_lemania_sis_client_view_UserManagementView$8_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$8', 1485), Lcom_lemania_sis_client_view_UserManagementView$9_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$9', 1486), Lcom_lemania_sis_client_view_UserManagementView$10_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$10', 1475), Lcom_lemania_sis_client_view_UserManagementView$11_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$11', 1476), Lcom_lemania_sis_client_view_UserManagementView$12_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$12', 1477), Lcom_lemania_sis_client_view_UserManagementView$13_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$13', 1478), Lcom_lemania_sis_client_view_UserManagementView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView_BinderImpl', 1487), Lcom_lemania_sis_client_view_UserManagementView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView_BinderImpl$Widgets', 1488), Lcom_lemania_sis_client_view_UserManagementView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView_BinderImpl$Widgets$1', 1489), Lcom_lemania_sis_client_view_UserManagementView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView_BinderImpl$Widgets$2', 1490), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$6X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$6X', 1694), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$8X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$8X', 1695);
$entry(onLoad)(28);
