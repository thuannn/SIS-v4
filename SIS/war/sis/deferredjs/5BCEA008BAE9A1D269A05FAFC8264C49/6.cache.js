function $addNewBranche(this$static, brancheName, brancheCoef, brancheActive){
  ...
  $fire((x_0 = new BrancheRequestFactory_BrancheRequestContextImpl$4X_0(rc, ep) , $addInvocation(rc.state.dialect, x_0) , x_0), new FrmBrancheAddPresenter$1_0(this$static));
}
...
defineSeed(816, 704, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBrancheAddPresenter, Q$FrmBrancheAddUiHandler]), FrmBrancheAddPresenter_0);
...
defineSeed(817, 643, makeCastMap([Q$Receiver]), FrmBrancheAddPresenter$1_0);
...
function $onCmdSaveClick(this$static){
  !!this$static.uiHandlers && $addNewBranche(dynamicCast(this$static.uiHandlers, Q$FrmBrancheAddUiHandler), $getPropertyString($getElement(this$static.txtBrancheName), 'value'), $getPropertyString($getElement(this$static.txtBrancheCoef), 'value'), $getValue_0(this$static.chkBrancheActive));
}
...
defineSeed(1187, 709, makeCastMap([Q$IsWidget, Q$FrmBrancheAddPresenter$MyView]), FrmBrancheAddView_0);
...
defineSeed(1188, 10, {}, FrmBrancheAddView$1_0);
...
defineSeed(1189, 1, {}, FrmBrancheAddView_BinderImpl_0);
...
defineSeed(1190, 1, {}, FrmBrancheAddView_BinderImpl$Widgets_0);
function FrmBrancheAddView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1191, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBrancheAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1561, 647, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$4X_0);
...
;
var Lcom_lemania_sis_client_presenter_FrmBrancheAddPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheAddPresenter', 816), Lcom_lemania_sis_client_presenter_FrmBrancheAddPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheAddPresenter$1', 817), Lcom_lemania_sis_client_view_FrmBrancheAddView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView', 1187), Lcom_lemania_sis_client_view_FrmBrancheAddView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView$1', 1188), Lcom_lemania_sis_client_view_FrmBrancheAddView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView_BinderImpl', 1189), Lcom_lemania_sis_client_view_FrmBrancheAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets', 1190), Lcom_lemania_sis_client_view_FrmBrancheAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets$1', 1191), Lcom_lemania_sis_shared_service_BrancheRequestFactory_1BrancheRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BrancheRequestFactory_BrancheRequestContextImpl$4X', 1561);
$entry(onLoad)(6);
