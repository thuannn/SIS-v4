...
defineSeed(768, 237, {}, ProfessorAfterAddEvent_0);
...
function $professorAddCancelled(){
  $clinit_History();
  !!impl_3 && $newItem(impl_3, '!profs', true);
}
...
defineSeed(1030, 704, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsAddPresenter, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(1031, 643, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(1082, 643, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(1088, 717, {}, UserManagementPresenterMyProxyImpl$2_0);
...
function $onCmdAddClicked(this$static){
  !!this$static.uiHandlers && $professorAdd(dynamicCast(this$static.uiHandlers, Q$ProfessorAddUiHandler), $trim($getPropertyString($getElement(this$static.txtProfName), 'value')) + ' ' + $trim($getPropertyString($getElement(this$static.txtProfFirstName), 'value')), $trim($getPropertyString($getElement(this$static.txtProfEmail), 'value')), $getValue_0(this$static.chkProfStatus));
}
...
function $onTxtProfFirstNameKeyUp(this$static){
  $equals_5($getPropertyString($getElement(this$static.txtProfFirstName), 'value'), '')?$setText(this$static.txtProfEmail, $trim($getPropertyString($getElement(this$static.txtProfName), 'value')).toLowerCase() + '@eprofil.ch'):$equals_5($getPropertyString($getElement(this$static.txtProfName), 'value'), '')?$setText(this$static.txtProfEmail, $getPropertyString($getElement(this$static.txtProfFirstName), 'value').substr(0, 1 - 0).toLowerCase() + '@eprofil.ch'):$setText(this$static.txtProfEmail, $getPropertyString($getElement(this$static.txtProfFirstName), 'value').substr(0, 1 - 0).toLowerCase() + '.' + $trim($getPropertyString($getElement(this$static.txtProfName), 'value')).toLowerCase() + '@eprofil.ch');
}
...
defineSeed(1420, 709, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1421, 1, {}, ProfsAddView_BinderImpl_0);
...
defineSeed(1422, 1, {}, ProfsAddView_BinderImpl$Widgets_0);
function ProfsAddView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1423, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1424, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1425, 1, makeCastMap([Q$KeyUpHandler, Q$EventHandler]), ProfsAddView_BinderImpl$Widgets$3_0);
...
defineSeed(1426, 1, makeCastMap([Q$KeyUpHandler, Q$EventHandler]), ProfsAddView_BinderImpl$Widgets$4_0);
...
defineSeed(1527, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$ProfessorProxy]));
...
;
defineSeed(1528, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$ProfessorProxy]));
...
function $save_1(this$static, prof){
  var x_0;
  x_0 = new ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0(this$static, prof);
...
defineSeed(1643, 647, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
...
;
var Lcom_lemania_sis_client_presenter_ProfsAddPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsAddPresenter', 1030), Lcom_lemania_sis_client_presenter_ProfsAddPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsAddPresenter$1', 1031), Lcom_lemania_sis_client_presenter_UserManagementPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$5', 1082), Lcom_lemania_sis_client_event_ProfessorAfterAddEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'ProfessorAfterAddEvent', 768), Lcom_lemania_sis_client_presenter_UserManagementPresenterMyProxyImpl$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenterMyProxyImpl$2', 1088), Lcom_lemania_sis_client_presenter_UserManagementPresenterMyProxyImpl$2$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenterMyProxyImpl$2$1', 1089), Lcom_lemania_sis_client_view_ProfsAddView_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView', 1420), Lcom_lemania_sis_client_view_ProfsAddView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView_BinderImpl', 1421), Lcom_lemania_sis_client_view_ProfsAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView_BinderImpl$Widgets', 1422), Lcom_lemania_sis_client_view_ProfsAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView_BinderImpl$Widgets$1', 1423), Lcom_lemania_sis_client_view_ProfsAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView_BinderImpl$Widgets$2', 1424), Lcom_lemania_sis_client_view_ProfsAddView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView_BinderImpl$Widgets$3', 1425), Lcom_lemania_sis_client_view_ProfsAddView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView_BinderImpl$Widgets$4', 1426), Lcom_lemania_sis_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$5X', 1643);
$entry(onLoad)(22);
