...
defineSeed(758, 237, {}, BrancheNameAfterChangeEvent_0);
...
defineSeed(822, 704, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$BrancheNameAfterChangeEvent$BrancheNameAfterChangeHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBrancheListPresenter, Q$FrmBrancheListUiHandler]), FrmBrancheListPresenter_0);
...
defineSeed(823, 643, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$1_0);
...
defineSeed(824, 643, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$2_0);
...
defineSeed(825, 643, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$3_0);
...
;
defineSeed(826, 735, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$BrancheNameAfterChangeEvent$BrancheNameAfterChangeHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(829, 717, {}, FrmBrancheListPresenterMyProxyImpl$2_0);
...
defineSeed(1193, 709, makeCastMap([Q$IsWidget, Q$FrmBrancheListPresenter$MyView]), FrmBrancheListView_0);
...
defineSeed(1194, 364, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$1_0);
...
defineSeed(1195, 1, {}, FrmBrancheListView$2_0);
...
defineSeed(1196, 364, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$3_0);
...
defineSeed(1197, 1, {}, FrmBrancheListView$4_0);
...
defineSeed(1198, 364, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$5_0);
...
defineSeed(1199, 1, {}, FrmBrancheListView$6_0);
...
defineSeed(1200, 1, {}, FrmBrancheListView_BinderImpl_0);
...
defineSeed(1201, 1, {}, FrmBrancheListView_BinderImpl$Widgets_0);
...
defineSeed(1562, 647, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$5X_0);
...
defineSeed(1569, 647, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$6X_0);
...
;
var Lcom_lemania_sis_client_presenter_FrmBrancheListPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheListPresenter', 822), Lcom_lemania_sis_client_presenter_FrmBrancheListPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheListPresenter$1', 823), Lcom_lemania_sis_client_presenter_FrmBrancheListPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheListPresenter$2', 824), Lcom_lemania_sis_client_presenter_FrmBrancheListPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheListPresenter$3', 825), Lcom_lemania_sis_client_event_BrancheNameAfterChangeEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'BrancheNameAfterChangeEvent', 758), Lcom_lemania_sis_client_presenter_FrmBrancheListPresenterMyProxyImpl$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheListPresenterMyProxyImpl$2', 829), Lcom_lemania_sis_client_presenter_FrmBrancheListPresenterMyProxyImpl$2$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheListPresenterMyProxyImpl$2$1', 830), Lcom_lemania_sis_client_view_FrmBrancheListView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView', 1193), Lcom_lemania_sis_client_view_FrmBrancheListView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView$1', 1194), Lcom_lemania_sis_client_view_FrmBrancheListView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView$2', 1195), Lcom_lemania_sis_client_view_FrmBrancheListView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView$3', 1196), Lcom_lemania_sis_client_view_FrmBrancheListView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView$4', 1197), Lcom_lemania_sis_client_view_FrmBrancheListView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView$5', 1198), Lcom_lemania_sis_client_view_FrmBrancheListView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView$6', 1199), Lcom_lemania_sis_client_view_FrmBrancheListView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView_BinderImpl', 1200), Lcom_lemania_sis_client_view_FrmBrancheListView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheListView_BinderImpl$Widgets', 1201), Lcom_lemania_sis_shared_service_BrancheRequestFactory_1BrancheRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BrancheRequestFactory_BrancheRequestContextImpl$5X', 1562), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$6X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$6X', 1569);
$entry(onLoad)(7);
