...
defineSeed(1121, 809, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1122, 1, {}, UserManagementPresenterMyProxyImpl$3$1_0);
...
defineSeed(1253, 796, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler, Q$FrmBulletinManagementPresenter, Q$FrmBulletinManagementUiHandler]));
...
defineSeed(1260, 727, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(1270, 824, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(1271, 809, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1272, 1, {}, FrmBulletinManagementPresenterMyProxyImpl$1$1_0);
...
defineSeed(1852, 731, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$14X_0);
...
defineSeed(2030, 731, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(2033, 731, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(2042, 731, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
