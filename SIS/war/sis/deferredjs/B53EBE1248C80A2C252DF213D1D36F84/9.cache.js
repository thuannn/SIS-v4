...
defineSeed(793, 235, {}, LoadNonAttribuedStudentEvent_0);
...
defineSeed(892, 731, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoadNonAttribuedStudentEvent$LoadNonAttribuedStudentHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinCreationPresenter, Q$FrmBulletinCreationUiHandler]), FrmBulletinCreationPresenter_0);
...
defineSeed(893, 670, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$1_0);
...
defineSeed(894, 670, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$2_0);
...
defineSeed(895, 670, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$3_0);
...
defineSeed(896, 670, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$4_0);
...
defineSeed(897, 670, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$5_0);
...
defineSeed(898, 670, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$6_0);
...
defineSeed(899, 670, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$7_0);
...
defineSeed(900, 670, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$8_0);
...
defineSeed(901, 670, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$9_0);
...
;
_.this$0 = null;
defineSeed(902, 762, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoadNonAttribuedStudentEvent$LoadNonAttribuedStudentHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(905, 744, {}, FrmBulletinCreationPresenterMyProxyImpl$2_0);
...
defineSeed(906, 1, {}, FrmBulletinCreationPresenterMyProxyImpl$2$1_0);
...
defineSeed(1263, 736, makeCastMap([Q$IsWidget, Q$FrmBulletinCreationPresenter$MyView]), FrmBulletinCreationView_0);
...
defineSeed(1264, 413, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$1_0);
...
defineSeed(1265, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinCreationView$10_0);
...
defineSeed(1266, 413, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$2_0);
...
defineSeed(1267, 413, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$3_0);
...
defineSeed(1268, 386, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$4_0);
...
defineSeed(1269, 1, {}, FrmBulletinCreationView$5_0);
...
defineSeed(1270, 386, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$6_0);
...
defineSeed(1271, 1, {}, FrmBulletinCreationView$7_0);
...
defineSeed(1272, 413, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$8_0);
...
defineSeed(1273, 413, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$9_0);
...
defineSeed(1274, 1, {}, FrmBulletinCreationView_BinderImpl_0);
...
defineSeed(1275, 1, {}, FrmBulletinCreationView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1276, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$1_0);
...
defineSeed(1277, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$2_0);
...
defineSeed(1278, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$3_0);
...
defineSeed(1279, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$4_0);
...
defineSeed(1280, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$5_0);
...
defineSeed(1281, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$6_0);
...
defineSeed(1564, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinProxy]));
...
;
defineSeed(1565, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinProxy]));
...
defineSeed(1636, 674, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$11X_0);
...
defineSeed(1639, 674, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$1X_0);
...
defineSeed(1642, 674, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$7X_0);
...
defineSeed(1644, 674, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$9X_0);
...
defineSeed(1735, 674, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$3X_0);
...
;
var Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinCreationPresenter', 892), Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinCreationPresenter$1', 893), Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinCreationPresenter$2', 894), Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBullet