...
defineSeed(772, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(773, 628, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(774, 628, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(775, 628, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(776, 628, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1095, 694, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1096, 359, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1098, 359, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1469, 632, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
