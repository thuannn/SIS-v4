...
defineSeed(750, 231, {}, ProfessorAfterAddEvent_0);
...
defineSeed(967, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsAddPresenter, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(968, 628, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(1019, 628, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(1025, 702, {}, UserManagementPresenterMyProxyImpl$2_0);
...
defineSeed(1289, 694, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1387, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$ProfessorProxy]));
...
;
defineSeed(1388, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$ProfessorProxy]));
...
defineSeed(1483, 632, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
