...
defineSeed(872, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseAddPresenter, Q$FrmClasseAddUiHandler]), FrmClasseAddPresenter_0);
...
defineSeed(873, 628, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$1_0);
...
defineSeed(874, 628, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$2_0);
...
defineSeed(875, 628, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$3_0);
...
defineSeed(1191, 694, makeCastMap([Q$IsWidget, Q$FrmClasseAddPresenter$MyView]), FrmClasseAddView_0);
...
defineSeed(1457, 632, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$8X_0);
