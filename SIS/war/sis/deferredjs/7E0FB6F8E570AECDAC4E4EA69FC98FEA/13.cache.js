...
defineSeed(880, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(881, 628, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(882, 628, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(883, 628, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(884, 628, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1198, 694, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1199, 359, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(1201, 359, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1454, 632, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1458, 632, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
