...
defineSeed(1200, 710, makeCastMap([Q$IsWidget, Q$FrmBulletinCreationPresenter$MyView]), FrmBulletinCreationView_0);
...
defineSeed(1201, 392, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$1_0);
...
defineSeed(1202, 392, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$2_0);
...
defineSeed(1203, 392, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$3_0);
...
defineSeed(1204, 366, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$4_0);
...
defineSeed(1205, 1, {}, FrmBulletinCreationView$5_0);
...
defineSeed(1206, 392, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$6_0);
...
defineSeed(1207, 392, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$7_0);
...
defineSeed(1208, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinCreationView$8_0);
...
defineSeed(1568, 648, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$1X_0);
...
defineSeed(1571, 648, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$7X_0);
...
defineSeed(1573, 648, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$9X_0);
...
defineSeed(1664, 648, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$3X_0);
