...
defineSeed(1064, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(1065, 644, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1066, 644, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1067, 644, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1068, 644, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1069, 644, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1081, 644, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1087, 718, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1452, 710, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1453, 366, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1455, 366, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1457, 366, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1459, 366, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1567, 648, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1663, 648, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1665, 648, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1679, 648, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
