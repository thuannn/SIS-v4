...
defineSeed(1173, 710, makeCastMap([Q$IsWidget, Q$EcolePresenter$MyView]), EcoleView_0);
...
defineSeed(1174, 392, makeCastMap([Q$HasCell, Q$Column]), EcoleView$1_0);
...
defineSeed(1175, 392, makeCastMap([Q$HasCell, Q$Column]), EcoleView$2_0);
...
defineSeed(1176, 366, makeCastMap([Q$HasCell, Q$Column]), EcoleView$3_0);
...
defineSeed(1597, 648, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$6X_0);
