...
defineSeed(1037, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(1038, 644, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(1039, 644, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(1040, 644, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(1041, 644, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(1042, 644, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(1043, 644, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(1044, 644, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(1045, 644, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(1046, 644, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1426, 710, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1427, 392, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1428, 366, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1431, 392, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1432, 392, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1433, 392, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1434, 366, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1550, 648, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1551, 648, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1552, 648, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1642, 648, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
