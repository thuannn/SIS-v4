...
defineSeed(969, 685, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(970, 624, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(971, 624, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(972, 624, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(973, 624, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(974, 624, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(975, 624, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(976, 624, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(977, 624, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(978, 624, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1293, 690, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1294, 382, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1295, 356, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1298, 382, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1299, 382, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1300, 382, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1301, 356, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1408, 628, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1409, 628, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1410, 628, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1480, 628, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
