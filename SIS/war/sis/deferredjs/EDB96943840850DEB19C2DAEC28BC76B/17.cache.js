...
defineSeed(742, 231, {}, DrawSchoolInterfaceEvent_0);
...
;
defineSeed(862, 716, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(863, 698, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1_0);
...
defineSeed(919, 685, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(920, 624, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(921, 624, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(922, 624, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(939, 698, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1247, 690, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1525, 628, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
