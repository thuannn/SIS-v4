...
defineSeed(748, 231, {}, StudentAfterAddEvent_0);
...
defineSeed(994, 685, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAddPresenter, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(995, 624, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(1014, 624, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(1019, 698, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1319, 690, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1512, 628, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
