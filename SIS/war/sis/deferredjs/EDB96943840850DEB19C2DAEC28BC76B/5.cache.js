...
defineSeed(785, 685, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$EcoleAddedEvent$EcoleAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$EcolePresenter, Q$EcoleListUiHandler]), EcolePresenter_0);
...
defineSeed(786, 624, makeCastMap([Q$Receiver]), EcolePresenter$1_0);
...
defineSeed(787, 624, makeCastMap([Q$Receiver]), EcolePresenter$2_0);
...
defineSeed(1106, 690, makeCastMap([Q$IsWidget, Q$EcolePresenter$MyView]), EcoleView_0);
...
defineSeed(1107, 382, makeCastMap([Q$HasCell, Q$Column]), EcoleView$1_0);
...
defineSeed(1108, 382, makeCastMap([Q$HasCell, Q$Column]), EcoleView$2_0);
...
defineSeed(1109, 356, makeCastMap([Q$HasCell, Q$Column]), EcoleView$3_0);
...
defineSeed(1471, 628, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$6X_0);
