...
defineSeed(983, 685, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$SettingsPresenter, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(984, 624, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(985, 624, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(986, 624, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(987, 624, makeCastMap([Q$Receiver]), SettingsPresenter$4_0);
...
defineSeed(988, 624, makeCastMap([Q$Receiver]), SettingsPresenter$5_0);
...
defineSeed(989, 624, makeCastMap([Q$Receiver]), SettingsPresenter$6_0);
...
defineSeed(1310, 690, makeCastMap([Q$IsWidget, Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1317, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), SettingsView_BinderImpl$Widgets$5_0);
...
defineSeed(1505, 628, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
...
defineSeed(1527, 628, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$3X_0);
