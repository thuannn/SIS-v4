...
defineSeed(749, 231, {}, StudentAfterStatusChangeEvent_0);
...
defineSeed(830, 624, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(840, 716, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(841, 698, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1000, 685, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(1001, 624, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1002, 624, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1003, 624, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1004, 624, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1005, 624, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1017, 624, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1023, 698, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1326, 690, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1327, 356, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1329, 356, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1331, 356, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1333, 356, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1432, 628, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1509, 628, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1511, 628, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1524, 628, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$11X_0);
