...
defineSeed(768, 685, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(769, 624, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(770, 624, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(771, 624, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(772, 624, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1091, 690, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1092, 356, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1094, 356, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1465, 628, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
