...
defineSeed(876, 685, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(877, 624, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(878, 624, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(879, 624, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(880, 624, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1194, 690, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1195, 356, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(1197, 356, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1450, 628, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1454, 628, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
