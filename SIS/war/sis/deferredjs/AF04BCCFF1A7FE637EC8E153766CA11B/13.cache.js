...
defineSeed(891, 698, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(892, 637, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(893, 637, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(894, 637, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(895, 637, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1254, 703, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1255, 363, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(1257, 363, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1569, 641, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1573, 641, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
