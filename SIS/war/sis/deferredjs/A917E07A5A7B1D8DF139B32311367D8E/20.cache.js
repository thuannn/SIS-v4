...
defineSeed(745, 233, {}, DrawSchoolInterfaceEvent_0);
...
;
defineSeed(870, 718, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(871, 700, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1_0);
...
defineSeed(969, 687, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(970, 626, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(971, 626, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(972, 626, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(989, 700, {}, MainPagePresenterMyProxyImpl$5_0);
...
function $drawPierreViretInterface(this$static){
  $setUrl(this$static.imgLogo, ($clinit_UriUtils() , new SafeUriString_0('/images/logo-pv.jpg')));
...
defineSeed(1362, 692, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1363, 1, {}, HomeView_BinderImpl_0);
...
defineSeed(1364, 1, {}, HomeView_HomeViewUiBinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1365, 1, makeCastMap([Q$KeyPressHandler, Q$EventHandler]), HomeView_HomeViewUiBinderImpl$Widgets$1_0);
_.this$1 = null;
function HomeView_HomeViewUiBinderImpl$Widgets$2_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1366, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), HomeView_HomeViewUiBinderImpl$Widgets$2_0);
...
defineSeed(1367, 1, makeCastMap([Q$FocusHandler, Q$EventHandler, Q$HomeView_HomeViewUiBinderImpl$Widgets$3]), HomeView_HomeViewUiBinderImpl$Widgets$3_0);
_.this$1 = null;
...
defineSeed(1670, 630, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
