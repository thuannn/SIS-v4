...
defineSeed(870, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseAddPresenter, Q$FrmClasseAddUiHandler]), FrmClasseAddPresenter_0);
...
defineSeed(871, 630, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$1_0);
...
defineSeed(872, 630, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$2_0);
...
defineSeed(873, 630, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$3_0);
...
defineSeed(1189, 696, makeCastMap([Q$IsWidget, Q$FrmClasseAddPresenter$MyView]), FrmClasseAddView_0);
...
defineSeed(1454, 634, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$8X_0);
