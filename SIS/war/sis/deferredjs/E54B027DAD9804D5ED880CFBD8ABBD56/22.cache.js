...
defineSeed(989, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAddPresenter, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(1009, 628, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(1014, 702, {}, UserManagementPresenterMyProxyImpl$1_0);
_.success = function success_36(presenter){
  $success_34(this, dynamicCast(presenter, Q$UserManagementPresenter));
}
;
_.val$event = null;
...
defineSeed(1311, 694, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1503, 632, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
