...
defineSeed(995, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(996, 628, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(997, 628, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(998, 628, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(999, 628, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1000, 628, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1012, 628, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1018, 702, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1318, 694, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1319, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1321, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1323, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1325, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
;
defineSeed(1391, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
defineSeed(1423, 632, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1500, 632, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1502, 632, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1515, 632, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$11X_0);
