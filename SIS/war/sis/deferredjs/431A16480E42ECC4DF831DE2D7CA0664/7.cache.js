...
defineSeed(794, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBrancheListPresenter, Q$FrmBrancheListUiHandler]), FrmBrancheListPresenter_0);
...
defineSeed(795, 619, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$1_0);
...
defineSeed(796, 619, makeCastMap([Q$Receiver]), FrmBrancheListPresenter$2_0);
...
defineSeed(1111, 685, makeCastMap([Q$IsWidget, Q$FrmBrancheListPresenter$MyView]), FrmBrancheListView_0);
...
defineSeed(1112, 354, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$1_0);
...
defineSeed(1114, 354, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$3_0);
...
defineSeed(1116, 354, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$5_0);
...
defineSeed(1408, 623, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$5X_0);
