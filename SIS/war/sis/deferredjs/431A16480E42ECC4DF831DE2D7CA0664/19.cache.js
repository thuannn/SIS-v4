...
defineSeed(740, 230, {}, ProfessorAfterAddEvent_0);
...
defineSeed(954, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsAddPresenter, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(955, 619, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(1006, 619, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(1012, 693, {}, UserManagementPresenterMyProxyImpl$2_0);
...
defineSeed(1276, 685, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1468, 623, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
