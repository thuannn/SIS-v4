...
defineSeed(762, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(763, 619, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(764, 619, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(765, 619, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(766, 619, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1082, 685, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1083, 354, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1085, 354, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1454, 623, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
