...
defineSeed(1012, 687, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(1013, 626, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(1014, 626, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(1015, 626, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(1016, 626, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(1017, 626, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(1018, 626, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(1019, 626, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(1020, 626, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(1021, 626, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1392, 692, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1393, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1394, 357, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1397, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1398, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1399, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1400, 357, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1516, 630, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1517, 630, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1518, 630, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1606, 630, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
