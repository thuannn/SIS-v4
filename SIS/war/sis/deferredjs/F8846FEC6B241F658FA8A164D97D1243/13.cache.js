...
defineSeed(1046, 731, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
_.onBind = function onBind_17(){
  dynamicCast(this.view, Q$FrmClasseListPresenter$MyView).setUiHandlers(this);
  $initializeTable_3(dynamicCast(this.view, Q$FrmClasseListPresenter$MyView));
}
;
...
defineSeed(1047, 670, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(1048, 670, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
_.onFailure_0 = function onFailure_73(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_73(response){
  $onSuccess_66(this, dynamicCast(response, Q$ClasseProxy));
}
;
_.this$0 = null;
...
defineSeed(1049, 670, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(1050, 670, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
function FrmClasseListView_0(){
  ...
  this.widget = $build_f_HTMLPanel1_14(new FrmClasseListView_BinderImpl$Widgets_0(this));
}

defineSeed(1382, 736, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1383, 386, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
_.getValue = function getValue_33(object){
  return dynamicCast(object, Q$ClasseProxy).getClassName();
}
;
function $update_20(this$static, index, classe, value){
...
defineSeed(1384, 1, {}, FrmClasseListView$2_0);
_.update = function update_21(index, classe, value){
  $update_20(this, index, dynamicCast(classe, Q$ClasseProxy), dynamicCast(value, Q$String));
}
;
_.this$0 = null;
...
defineSeed(1385, 386, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
_.getValue = function getValue_34(classe){
  return dynamicCast(classe, Q$ClasseProxy).getIsActive();
}
;
function $update_21(this$static, index, classe, value){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedClasse = index;
...
defineSeed(1386, 1, {}, FrmClasseListView$4_0);
_.update = function update_22(index, classe, value){
  $update_21(this, index, dynamicCast(classe, Q$ClasseProxy), dynamicCast(value, Q$Boolean));
}
;
_.this$0 = null;
...
defineSeed(1387, 1, {}, FrmClasseListView_BinderImpl_0);
function $build_f_HTMLPanel1_14(this$static){
  ...
  $addAndReplaceElement(f_HTMLPanel1, (f_VerticalPanel2 = new VerticalPanel_0 , $add_12(f_VerticalPanel2, (f_Label3 = new Label_0 , f_Label3.element['className'] = 'pageTitle' , $setHorizontalAlignment(f_Label3, ($clinit_HasHorizontalAlignment() , ALIGN_CENTER)) , $setTextOrHtml(f_Label3.directionalTextHelper, 'LISTE DES CLASSES', false) , $updateHorizontalAlignment(f_Label3) , f_Label3)) , $add_12(f_VerticalPanel2, (f_Grid4 = new Grid_0 , $resizeColumns(f_Grid4, 2) , $resizeRows(f_Grid4, 2) , $setWidget_2(f_Grid4, 0, 0, (f_Label5 = new Label_0 , $setTextOrHtml(f_Label5.directionalTextHelper, 'Ecole :', false) , $updateHorizontalAlignment(f_Label5) , f_Label5)) , $setWidget_2(f_Grid4, 0, 1, (lstEcoles = new ListBox_0 , lstEcoles.element['className'] = 'sis_textbox' , $addDomHandler(lstEcoles, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_ChangeEvent() , $clinit_ChangeEvent() , TYPE)) , this$static.owner.lstEcoles = lstEcoles , lstEcoles)) , $setWidget_2(f_Grid4, 1, 0, (f_Label6 = new Label_0 , $setTextOrHtml(f_Label6.directionalTextHelper, 'Programme :', false) , $updateHorizontalAlignment(f_Label6) , f_Label6)) , $setWidget_2(f_Grid4, 1, 1, (lstCours = new ListBox_0 , lstCours.element['className'] = 'sis_textbox' , $addDomHandler(lstCours, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, TYPE) , this$static.owner.lstCours = lstCours , lstCours)) , f_Grid4.element.style['width'] = '80%' , f_Grid4.tableElem['cellSpacing'] = 5 , f_Grid4.tableElem['cellPadding'] = 5 , f_Grid4)) , $add_12(f_VerticalPanel2, (tblClasseList = this$static.owner.tblClasseList , tblClasseList.element.style['height'] = '500px' , tblClasseList.element.style['width'] = '80%' , tblClasseList)) , f_VerticalPanel2.element.style['width'] = '100%' , f_VerticalPanel2.table['cellSpacing'] = 2 , f_VerticalPanel2), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(1388, 1, {}, FrmClasseListView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1389, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmClasseListView_BinderImpl$Widgets$1_0);
...
defineSeed(1390, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmClasseListView_BinderImpl$Widgets$2_0);
...
defineSeed(1728, 674, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1732, 674, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
...
var Lcom_lemania_sis_client_presenter_FrmClasseListPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseListPresenter', 1046), Lcom_lemania_sis_client_presenter_FrmClasseListPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseListPresenter$1', 1047), Lcom_lemania_sis_client_presenter_FrmClasseListPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseListPresenter$2', 1048), Lcom_lemania_sis_client_presenter_FrmClasseListPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseListPresenter$3', 1049), Lcom_lemania_sis_client_presenter_FrmClasseListPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmClasseListPresenter$4', 1050), Lcom_lemania_sis_client_view_FrmClasseListView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView', 1382), Lcom_lemania_sis_client_view_FrmClasseListView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView$1', 1383), Lcom_lemania_sis_client_view_FrmClasseListView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView$2', 1384), Lcom_lemania_sis_client_view_FrmClasseListView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView$3', 1385), Lcom_lemania_sis_client_view_FrmClasseListView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView$4', 1386), Lcom_lemania_sis_client_view_FrmClasseListView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView_BinderImpl', 1387), Lcom_lemania_sis_client_view_FrmClasseListView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView_BinderImpl$Widgets', 1388), Lcom_lemania_sis_client_view_FrmClasseListView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView_BinderImpl$Widgets$1', 1389), Lcom_lemania_sis_client_view_FrmClasseListView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmClasseListView_BinderImpl$Widgets$2', 1390), Lcom_lemania_sis_shared_service_ClasseRequestFactory_1ClasseRequestContextImpl$3X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ClasseRequestFactory_ClasseRequestContextImpl$3X', 1728), Lcom_lemania_sis_shared_service_ClasseRequestFactory_1ClasseRequestContextImpl$9X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ClasseRequestFactory_ClasseRequestContextImpl$9X', 1732);
$entry(onLoad)(13);
