...
defineSeed(801, 235, {}, StudentAfterStatusChangeEvent_0);
...
defineSeed(1000, 670, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(1010, 762, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(1011, 744, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
_.success = function success_19(presenter){
  $success_17(this, dynamicCast(presenter, Q$FrmBulletinManagementPresenter));
}
;
_.val$event = null;
...
defineSeed(1012, 1, {}, FrmBulletinManagementPresenterMyProxyImpl$1$1_0);
...
defineSeed(1200, 731, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
_.onBind = function onBind_31(){
  $initializeTable_5(dynamicCast(this.view, Q$StudentPresenter$MyView));
}
;
...
defineSeed(1201, 670, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1202, 670, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
_.onFailure_0 = function onFailure_147(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_147(response){
  $onSuccess_137(this, dynamicCast(response, Q$StudentProxy));
}
;
_.this$0 = null;
_.val$student = null;
_.val$value = null;
function $onSuccess_138(this$static, response){
  $updateEditedStudent(dynamicCast(this$static.this$0.view, Q$StudentPresenter$MyView), response);
}
...
defineSeed(1203, 670, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
_.onFailure_0 = function onFailure_148(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_148(response){
  $onSuccess_138(this, dynamicCast(response, Q$StudentProxy));
}
;
_.this$0 = null;
...
defineSeed(1204, 670, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
_.onFailure_0 = function onFailure_149(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_149(response){
  $onSuccess_139(this, dynamicCast(response, Q$StudentProxy));
}
;
_.this$0 = null;
...
defineSeed(1205, 670, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
_.onFailure_0 = function onFailure_150(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_150(response){
  $onSuccess_140(this, dynamicCast(response, Q$StudentProxy));
}
;
_.this$0 = null;
...
defineSeed(1217, 670, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1223, 744, {}, UserManagementPresenterMyProxyImpl$3_0);
_.success = function success_47(presenter){
  $success_45(this, dynamicCast(presenter, Q$UserManagementPresenter));
}
;
_.val$event = null;
...
defineSeed(1224, 1, {}, UserManagementPresenterMyProxyImpl$3$1_0);
...
function StudentView_0(){
  ...
  this.widget = $build_f_HTMLPanel1_28(new StudentView_BinderImpl$Widgets_0(this));
}

defineSeed(1567, 736, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1568, 386, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
_.getValue = function getValue_87(object){
  return dynamicCast(object, Q$StudentProxy).getLastName();
}
;
function $update_39(this$static, index, student, value){
...
defineSeed(1569, 1, {}, StudentView$2_0);
_.update = function update_40(index, student, value){
  $update_39(this, index, dynamicCast(student, Q$StudentProxy), dynamicCast(value, Q$String));
}
;
_.this$0 = null;
...
defineSeed(1570, 386, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
_.getValue = function getValue_88(object){
  return dynamicCast(object, Q$StudentProxy).getFirstName();
}
;
function $update_40(this$static, index, student, value){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedStudent = index;
...
defineSeed(1571, 1, {}, StudentView$4_0);
_.update = function update_41(index, student, value){
  $update_40(this, index, dynamicCast(student, Q$StudentProxy), dynamicCast(value, Q$String));
}
;
_.this$0 = null;
...
defineSeed(1572, 386, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
_.getValue = function getValue_89(object){
  return dynamicCast(object, Q$StudentProxy).getEmail();
}
;
function $update_41(this$static, index, student, value){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedStudent = index;
...
defineSeed(1573, 1, {}, StudentView$6_0);
_.update = function update_42(index, student, value){
  $update_41(this, index, dynamicCast(student, Q$StudentProxy), dynamicCast(value, Q$String));
}
;
_.this$0 = null;
...
defineSeed(1574, 386, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
_.getValue = function getValue_90(student){
  return dynamicCast(student, Q$StudentProxy).getIsActive();
}
;
function $update_42(this$static, index, student, value){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedStudent = index;
...
defineSeed(1575, 1, {}, StudentView$8_0);
_.update = function update_43(index, student, value){
  $update_42(this, index, dynamicCast(student, Q$StudentProxy), dynamicCast(value, Q$Boolean));
}
;
_.this$0 = null;
...
defineSeed(1576, 1, {}, StudentView_BinderImpl_0);
...
defineSeed(1577, 1, {}, StudentView_BinderImpl$Widgets_0);
_.domId0 = null;
...
;
defineSeed(1649, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
defineSeed(1710, 674, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1806, 674, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1808, 674, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1822, 674, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
...
var Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$15_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$15', 1000), Lcom_lemania_sis_client_event_StudentAfterStatusChangeEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'StudentAfterStatusChangeEvent', 801), Lcom_lemania_sis_client_presenter_StudentPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentPresenter', 1200), Lcom_lemania_sis_client_presenter_StudentPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentPresenter$1', 1201), Lcom_lemania_sis_client_presenter_StudentPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentPresenter$2', 1202), Lcom_lemania_sis_client_presenter_StudentPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentPresenter$3', 1203), Lcom_lemania_sis_client_presenter_StudentPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentPresenter$4', 1204), Lcom_lemania_sis_client_presenter_StudentPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentPresenter$5', 1205), Lcom_lemania_sis_client_presenter_UserManagementPresenter$7_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$7', 1217), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenterMyProxyImpl$1', 1011), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenterMyProxyImpl$1$1', 1012), Lcom_lemania_sis_client_presenter_UserManagementPresenterMyProxyImpl$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenterMyProxyImpl$3', 1223), Lcom_lemania_sis_client_presenter_UserManagementPresenterMyProxyImpl$3$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenterMyProxyImpl$3$1', 1224), Lcom_lemania_sis_client_view_StudentView_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView', 1567), Lcom_lemania_sis_client_view_StudentView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$1', 1568), Lcom_lemania_sis_client_view_StudentView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$2', 1569), Lcom_lemania_sis_client_view_StudentView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$3', 1570), Lcom_lemania_sis_client_view_StudentView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$4', 1571), Lcom_lemania_sis_client_view_StudentView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$5', 1572), Lcom_lemania_sis_client_view_StudentView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$6', 1573), Lcom_lemania_sis_client_view_StudentView$7_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$7', 1574), Lcom_lemania_sis_client_view_StudentView$8_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$8', 1575), Lcom_lemania_sis_client_view_StudentView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView_BinderImpl', 1576), Lcom_lemania_sis_client_view_StudentView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView_BinderImpl$Widgets', 1577), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$13X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$13X', 1710), Lcom_lemania_sis_shared_service_StudentRequestFactory_1StudentRequestContextImpl$1X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'StudentRequestFactory_StudentRequestContextImpl$1X', 1806), Lcom_lemania_sis_shared_service_StudentRequestFactory_1StudentRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'StudentRequestFactory_StudentRequestContextImpl$7X', 1808), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$12X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$12X', 1822);
$entry(onLoad)(26);
