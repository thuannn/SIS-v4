...
defineSeed(771, 235, {}, StudentAfterAddEvent_0);
...
defineSeed(1062, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAddPresenter, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(1063, 644, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(1082, 644, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(1087, 718, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1452, 710, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1674, 648, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
