...
defineSeed(749, 231, {}, ProfessorAfterAddEvent_0);
...
defineSeed(963, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsAddPresenter, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(964, 628, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(1015, 628, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(1021, 702, {}, UserManagementPresenterMyProxyImpl$2_0);
...
defineSeed(1285, 694, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1478, 632, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
