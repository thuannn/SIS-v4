...
function $addNewUser(this$static, fullName, userName, password, email){
  ...
  newUser.setActive(($clinit_Boolean() , $clinit_Boolean() , TRUE_2));
...
defineSeed(1079, 687, makeCastMap([Q$Receiver]), UserManagementPresenter$1_0);
...
defineSeed(1080, 687, makeCastMap([Q$Receiver]), UserManagementPresenter$2_0);
...
defineSeed(1081, 687, makeCastMap([Q$Receiver]), UserManagementPresenter$3_0);
...
defineSeed(1084, 687, makeCastMap([Q$Receiver]), UserManagementPresenter$6_0);
...
defineSeed(1418, 752, makeCastMap([Q$IsWidget, Q$UserManagementPresenter$MyView, Q$UserManagementView]), UserManagementView_0);
...
defineSeed(1419, 406, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$1_0);
...
defineSeed(1420, 1, {}, UserManagementView$10_0);
...
defineSeed(1421, 380, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$11_0);
_.getValue = function getValue_64(user){
...
defineSeed(1422, 1, {}, UserManagementView$12_0);
...
defineSeed(1423, 406, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$13_0);
...
defineSeed(1424, 406, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$2_0);
...
defineSeed(1425, 406, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$3_0);
...
defineSeed(1426, 380, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$4_0);
_.getValue = function getValue_68(ecole){
...
defineSeed(1427, 1, {}, UserManagementView$5_0);
...
defineSeed(1428, 380, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$6_0);
_.getValue = function getValue_69(user){
  return dynamicCast(user, Q$UserProxy).getAdmin();
}
;
function $update_31(this$static, index, user, value){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedUserIndex = index;
...
defineSeed(1429, 1, {}, UserManagementView$7_0);
_.update = function update_31(index, user, value){
  $update_31(this, index, dynamicCast(user, Q$UserProxy), dynamicCast(value, Q$Boolean));
}
;
_.this$0 = null;
...
defineSeed(1430, 380, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$8_0);
_.getValue = function getValue_70(user){
...
defineSeed(1431, 380, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$9_0);
...
defineSeed(1432, 1, {}, UserManagementView_BinderImpl_0);
...
defineSeed(1433, 1, {}, UserManagementView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1434, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), UserManagementView_BinderImpl$Widgets$1_0);
...
defineSeed(1435, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), UserManagementView_BinderImpl$Widgets$2_0);
...
defineSeed(1608, 691, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$5X_0);
...
defineSeed(1609, 691, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$7X_0);
...
;
_.val$type = null;
var Lcom_lemania_sis_client_presenter_UserManagementPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter', 1078), Lcom_lemania_sis_client_presenter_UserManagementPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$1', 1079), Lcom_lemania_sis_client_presenter_UserManagementPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$2', 1080), Lcom_lemania_sis_client_presenter_UserManagementPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$3', 1081), Lcom_lemania_sis_client_presenter_UserManagementPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$6', 1084), Lcom_lemania_sis_client_view_UserManagementView_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView', 1418), Lcom_lemania_sis_client_view_UserManagementView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$1', 1419), Lcom_lemania_sis_client_view_UserManagementView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$2', 1424), Lcom_lemania_sis_client_view_UserManagementView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$3', 1425), Lcom_lemania_sis_client_view_UserManagementView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$4', 1426), Lcom_lemania_sis_client_view_UserManagementView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$5', 1427), Lcom_lemania_sis_client_view_UserManagementView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$6', 1428), Lcom_lemania_sis_client_view_UserManagementView$7_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$7', 1429), Lcom_lemania_sis_client_view_UserManagementView$8_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$8', 1430), Lcom_lemania_sis_client_view_UserManagementView$9_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$9', 1431), Lcom_lemania_sis_client_view_UserManagementView$10_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$10', 1420), Lcom_lemania_sis_client_view_UserManagementView$11_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$11', 1421), Lcom_lemania_sis_client_view_UserManagementView$12_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$12', 1422), Lcom_lemania_sis_client_view_UserManagementView$13_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$13', 1423), Lcom_lemania_sis_client_view_UserManagementView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView_BinderImpl', 1432), Lcom_lemania_sis_client_view_UserManagementView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView_BinderImpl$Widgets', 1433), Lcom_lemania_sis_client_view_UserManagementView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView_BinderImpl$Widgets$1', 1434), Lcom_lemania_sis_client_view_UserManagementView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView_BinderImpl$Widgets$2', 1435), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$5X', 1608), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$7X', 1609);
$entry(onLoad)(27);
