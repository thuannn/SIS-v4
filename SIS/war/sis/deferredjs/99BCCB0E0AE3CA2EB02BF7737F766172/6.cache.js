...
defineSeed(856, 747, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBrancheAddPresenter, Q$FrmBrancheAddUiHandler]), FrmBrancheAddPresenter_0);
...
defineSeed(857, 687, makeCastMap([Q$Receiver]), FrmBrancheAddPresenter$1_0);
...
function $resetForm_0(this$static){
  ...
  $setValue_0(this$static.chkBrancheActive, ($clinit_Boolean() , $clinit_Boolean() , TRUE_2));
}
...
defineSeed(1186, 752, makeCastMap([Q$IsWidget, Q$FrmBrancheAddPresenter$MyView]), FrmBrancheAddView_0);
...
defineSeed(1187, 10, makeCastMap([Q$Timer]), FrmBrancheAddView$1_0);
...
defineSeed(1188, 1, {}, FrmBrancheAddView_BinderImpl_0);
...
defineSeed(1189, 1, {}, FrmBrancheAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1190, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBrancheAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1497, 691, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$4X_0);
...
;
_.val$branche = null;
var Lcom_lemania_sis_client_presenter_FrmBrancheAddPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheAddPresenter', 856), Lcom_lemania_sis_client_presenter_FrmBrancheAddPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheAddPresenter$1', 857), Lcom_lemania_sis_client_view_FrmBrancheAddView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView', 1186), Lcom_lemania_sis_client_view_FrmBrancheAddView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView$1', 1187), Lcom_lemania_sis_client_view_FrmBrancheAddView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView_BinderImpl', 1188), Lcom_lemania_sis_client_view_FrmBrancheAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets', 1189), Lcom_lemania_sis_client_view_FrmBrancheAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets$1', 1190), Lcom_lemania_sis_shared_service_BrancheRequestFactory_1BrancheRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BrancheRequestFactory_BrancheRequestContextImpl$4X', 1497);
$entry(onLoad)(6);
