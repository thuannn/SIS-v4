...
defineSeed(762, 235, {}, StudentAfterStatusChangeEvent_0);
...
defineSeed(843, 637, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(853, 729, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(854, 711, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1043, 698, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(1044, 637, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1045, 637, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1046, 637, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1047, 637, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1048, 637, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1060, 637, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1066, 711, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1425, 703, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1426, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1428, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1430, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1432, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1503, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
;
defineSeed(1504, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
defineSeed(1537, 641, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1627, 641, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1629, 641, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1642, 641, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$11X_0);
