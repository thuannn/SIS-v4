...
defineSeed(755, 235, {}, DrawSchoolInterfaceEvent_0);
...
defineSeed(962, 698, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(963, 637, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(964, 637, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(965, 637, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(982, 711, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1346, 703, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1643, 641, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
