...
defineSeed(761, 235, {}, StudentAfterAddEvent_0);
...
defineSeed(1037, 698, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAddPresenter, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(1038, 637, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(1057, 637, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(1062, 711, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1418, 703, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1630, 641, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
