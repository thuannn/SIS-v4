...
defineSeed(1038, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$SettingsPresenter, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(1039, 631, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(1040, 631, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(1041, 631, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1042, 631, makeCastMap([Q$Receiver]), SettingsPresenter$4_0);
...
defineSeed(1043, 631, makeCastMap([Q$Receiver]), SettingsPresenter$5_0);
...
defineSeed(1044, 631, makeCastMap([Q$Receiver]), SettingsPresenter$6_0);
...
defineSeed(1430, 697, makeCastMap([Q$IsWidget, Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1654, 635, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
...
defineSeed(1678, 635, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$4X_0);
