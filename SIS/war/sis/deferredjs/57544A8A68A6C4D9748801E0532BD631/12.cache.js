...
defineSeed(881, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseAddPresenter, Q$FrmClasseAddUiHandler]), FrmClasseAddPresenter_0);
...
defineSeed(882, 631, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$1_0);
...
defineSeed(883, 631, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$2_0);
...
defineSeed(884, 631, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$3_0);
...
defineSeed(1252, 697, makeCastMap([Q$IsWidget, Q$FrmClasseAddPresenter$MyView]), FrmClasseAddView_0);
...
defineSeed(1253, 12, makeCastMap([Q$Timer]), FrmClasseAddView$1_0);
...
defineSeed(1583, 635, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$8X_0);
