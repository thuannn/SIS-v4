...
defineSeed(246, 244, {}, KeyPressEvent_0);
...
function $setCurrentMonth_1(this$static, currentMonth){
...
defineSeed(797, 233, {}, DrawSchoolInterfaceEvent_0);
...
;
defineSeed(917, 771, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(918, 753, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1_0);
...
defineSeed(919, 1, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1$1_0);
...
function $authenticateUser(this$static, userName, password){
  ...
  if ($equals_5(userName, 'thuannn@gmail.com') && $equals_5(password, 'Suisse2011-')) {
    ...
    $toggleLoginPanel(dynamicCast(this$static.view, Q$HomePresenter$MyView), ($clinit_Boolean() , $clinit_Boolean() , FALSE_2));
  }
   else {
...
function $checkAccessBlock(this$static, response){
  ...
  response.getId_0();
  $setCurrentMonth_1(currentUser, response.getCurrentMonth());
...
function HomePresenter_0(eventBus, view, proxy){
  ...
  this.systemBlocked = ($clinit_Boolean() , $clinit_Boolean() , FALSE_2);
  rf = new SettingOptionRequestFactoryImpl_0;
...
defineSeed(980, 740, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
_.onAfterUserLogOut = function onAfterUserLogOut(event_0){
  $toggleLoginPanel(dynamicCast(this.view, Q$HomePresenter$MyView), ($clinit_Boolean() , $clinit_Boolean() , TRUE_2));
}
;
...
function $onSuccess_66(this$static, response){
  ...
  for (setting$iterator = response.iterator(); setting$iterator.hasNext();) {
    ...
    $equals_5(setting.getOptionName(), 'BLOCK') && (this$static.this$0.systemBlocked = ($clinit_Boolean() , $clinit_Boolean() , $equalsIgnoreCase('true', setting.getOptionValue())?TRUE_2:FALSE_2));
  }
...
defineSeed(981, 680, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(982, 680, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(983, 680, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(1000, 753, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1001, 1, {}, MainPagePresenterMyProxyImpl$5$1_0);
...
defineSeed(1320, 745, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1321, 1, {}, HomeView_BinderImpl_0);
...
defineSeed(1322, 1, {}, HomeView_HomeViewUiBinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1323, 1, makeCastMap([Q$KeyPressHandler, Q$EventHandler]), HomeView_HomeViewUiBinderImpl$Widgets$1_0);
_.this$1 = null;
function HomeView_HomeViewUiBinderImpl$Widgets$2_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1324, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), HomeView_HomeViewUiBinderImpl$Widgets$2_0);
...
defineSeed(1325, 1, makeCastMap([Q$FocusHandler, Q$EventHandler]), HomeView_HomeViewUiBinderImpl$Widgets$3_0);
_.onFocus = function onFocus_0(event_0){
  $onTxtPasswordFocus(this.this$1.owner);
}
;
_.this$1 = null;
...
defineSeed(1598, 684, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
...
_.val$password = null;
_.val$userName = null;
var Lcom_lemania_sis_client_event_DrawSchoolInterfaceEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'DrawSchoolInterfaceEvent', 797), Lcom_lemania_sis_client_presenter_HomePresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'HomePresenter', 980), Lcom_lemania_sis_client_presenter_HomePresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'HomePresenter$1', 981), Lcom_lemania_sis_client_presenter_HomePresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'HomePresenter$2', 982), Lcom_lemania_sis_client_presenter_HomePresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'HomePresenter$3', 983), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenterMyProxyImpl$1', 918), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenterMyProxyImpl$1$1', 919), Lcom_lemania_sis_client_presenter_MainPagePresenterMyProxyImpl$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'MainPagePresenterMyProxyImpl$5', 1000), Lcom_lemania_sis_client_presenter_MainPagePresenterMyProxyImpl$5$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'MainPagePresenterMyProxyImpl$5$1', 1001), Lcom_lemania_sis_client_view_HomeView_2_classLit = createForClass('com.lemania.sis.client.view.', 'HomeView', 1320), Lcom_lemania_sis_client_view_HomeView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'HomeView_BinderImpl', 1321), Lcom_lemania_sis_client_view_HomeView_1HomeViewUiBinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'HomeView_HomeViewUiBinderImpl$Widgets', 1322), Lcom_lemania_sis_client_view_HomeView_1HomeViewUiBinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'HomeView_HomeViewUiBinderImpl$Widgets$1', 1323), Lcom_lemania_sis_client_view_HomeView_1HomeViewUiBinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'HomeView_HomeViewUiBinderImpl$Widgets$2', 1324), Lcom_lemania_sis_client_view_HomeView_1HomeViewUiBinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'HomeView_HomeViewUiBinderImpl$Widgets$3', 1325), Lcom_google_gwt_user_client_ui_PasswordTextBox_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'PasswordTextBox', 513), Lcom_google_gwt_event_dom_client_KeyPressEvent_2_classLit = createForClass('com.google.gwt.event.dom.client.', 'KeyPressEvent', 246), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$1X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$1X', 1598);
$entry(onLoad)(19);
