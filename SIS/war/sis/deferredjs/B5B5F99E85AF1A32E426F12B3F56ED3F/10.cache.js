...
defineSeed(854, 687, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinViewDetailPresenter, Q$FrmBulletinViewDetailUiHandler]), FrmBulletinViewDetailPresenter_0);
...
defineSeed(855, 626, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$1_0);
...
defineSeed(856, 626, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$2_0);
...
defineSeed(857, 626, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$3_0);
...
defineSeed(858, 626, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$4_0);
...
defineSeed(859, 626, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$5_0);
...
function $onSuccess_43(this$static, response){
  response.getProgrammeName().toLowerCase().indexOf('matu') != -1 && response.getClasseName().toLowerCase().indexOf('pr\xE9maturit\xE9') == -1?$drawGradeTableMatu(dynamicCast(this$static.this$0.view, Q$FrmBulletinViewDetailPresenter$MyView), this$static.val$subjects, this$static.val$branches, ($clinit_Boolean() , this$static.this$0.currentUser.isStudent?TRUE_1:FALSE_1)):$drawGradeTableNormal(dynamicCast(this$static.this$0.view, Q$FrmBulletinViewDetailPresenter$MyView), this$static.val$subjects, this$static.val$branches, ($clinit_Boolean() , this$static.this$0.currentUser.isStudent?TRUE_1:FALSE_1));
}
...
defineSeed(860, 626, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$6_0);
...
defineSeed(1230, 692, makeCastMap([Q$IsWidget, Q$FrmBulletinViewDetailPresenter$MyView]), FrmBulletinViewDetailView_0);
...
defineSeed(1548, 630, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X_0);
...
defineSeed(1559, 630, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$2X_0);
...
defineSeed(1562, 630, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$8X_0);
