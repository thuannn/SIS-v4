...
defineSeed(855, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinViewDetailPresenter, Q$FrmBulletinViewDetailUiHandler]), FrmBulletinViewDetailPresenter_0);
...
defineSeed(856, 631, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$1_0);
...
defineSeed(857, 631, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$2_0);
...
defineSeed(858, 631, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$3_0);
...
defineSeed(859, 631, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$4_0);
...
defineSeed(860, 631, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$5_0);
...
defineSeed(861, 631, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$6_0);
...
defineSeed(1225, 697, makeCastMap([Q$IsWidget, Q$FrmBulletinViewDetailPresenter$MyView]), FrmBulletinViewDetailView_0);
...
defineSeed(1537, 635, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X_0);
...
defineSeed(1547, 635, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$2X_0);
...
defineSeed(1550, 635, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$8X_0);
