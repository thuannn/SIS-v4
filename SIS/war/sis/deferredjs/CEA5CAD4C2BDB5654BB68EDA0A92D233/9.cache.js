...
defineSeed(1200, 697, makeCastMap([Q$IsWidget, Q$FrmBulletinManagementPresenter$MyView]), FrmBulletinManagementView_0);
...
defineSeed(1201, 385, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$1_0);
...
defineSeed(1202, 385, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$10_0);
...
defineSeed(1203, 359, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$11_0);
...
defineSeed(1206, 385, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$14_0);
...
defineSeed(1208, 359, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$2_0);
...
defineSeed(1210, 359, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$4_0);
...
defineSeed(1212, 385, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$6_0);
...
defineSeed(1213, 359, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$7_0);
...
defineSeed(1215, 385, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$9_0);
...
defineSeed(1469, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
...
;
defineSeed(1470, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
_.setBrancheCoef = function setBrancheCoef_0(brancheCoef){
  $setProperty(this.this$0, 'brancheCoef', brancheCoef);
}
;
defineSeed(1475, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
;
defineSeed(1476, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
defineSeed(1535, 635, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X_0);
...
defineSeed(1539, 635, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X_0);
...
defineSeed(1555, 635, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X_0);
...
defineSeed(1558, 635, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X_0);
...
defineSeed(1649, 635, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$4X_0);
