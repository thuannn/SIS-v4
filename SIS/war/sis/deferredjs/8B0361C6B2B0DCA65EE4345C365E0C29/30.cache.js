...
defineSeed(1170, 793, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$PeriodListPopupUiHandlers]), PeriodListPopupPresenter_0);
...
defineSeed(1171, 723, makeCastMap([Q$Receiver]), PeriodListPopupPresenter$1_0);
...
defineSeed(1172, 723, makeCastMap([Q$Receiver]), PeriodListPopupPresenter$2_0);
...
defineSeed(1173, 791, makeCastMap([Q$IsWidget, Q$PopupView, Q$PeriodListPopupPresenter$MyView]), PeriodListPopupView_0);
_.lstFromHour = null;
...
defineSeed(1174, 423, makeCastMap([Q$HasCell, Q$Column]), PeriodListPopupView$1_0);
...
defineSeed(1175, 423, makeCastMap([Q$HasCell, Q$Column]), PeriodListPopupView$2_0);
...
defineSeed(1176, 423, makeCastMap([Q$HasCell, Q$Column]), PeriodListPopupView$3_0);
...
defineSeed(1177, 423, makeCastMap([Q$HasCell, Q$Column]), PeriodListPopupView$4_0);
...
defineSeed(1178, 423, makeCastMap([Q$HasCell, Q$Column]), PeriodListPopupView$5_0);
...
defineSeed(1179, 423, makeCastMap([Q$HasCell, Q$Column]), PeriodListPopupView$6_0);
...
_.injector = null;
defineSeed(1884, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$PeriodProxy]));
...
;
defineSeed(1885, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$PeriodProxy]));
...
defineSeed(1888, 727, makeCastMap([Q$AbstractRequest]), PeriodRequestFactory_PeriodRequestContextImpl$1X_0);
...
defineSeed(1891, 727, makeCastMap([Q$AbstractRequest]), PeriodRequestFactory_PeriodRequestContextImpl$8X_0);
...
defineSeed(1893, 684, makeCastMap([Q$AutoBean, Q$AbstractAutoBean, Q$HasSplittable]), PeriodItemProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory_0, PeriodItemProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory_1);
_.as = function as_30(){
  return this.shim;
}
;
...
defineSeed(1894, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$PeriodItemProxy]), PeriodItemProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory$1_0);
...
defineSeed(1895, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$PeriodItemProxy]), PeriodItemProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory$2_0);
...
defineSeed(1896, 718, {}, PeriodItemRequestFactoryImpl_0);
...
defineSeed(1897, 728, makeCastMap([Q$AbstractRequestContext]), PeriodItemRequestFactory_PeriodItemRequestContextImpl_0);
...
defineSeed(1898, 727, makeCastMap([Q$AbstractRequest]), PeriodItemRequestFactory_PeriodItemRequestContextImpl$1X_0);
...
defineSeed(1899, 727, makeCastMap([Q$AbstractRequest]), PeriodItemRequestFactory_PeriodItemRequestContextImpl$3X_0);
...
defineSeed(1900, 656, makeCastMap([Q$EnumMap]), PeriodItemRequestFactory_PeriodItemRequestContextImpl_FactoryImpl_0);
