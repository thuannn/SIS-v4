...
defineSeed(867, 272, {}, StudentAfterStatusChangeEvent_0);
...
defineSeed(1078, 792, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentListUiHandler, Q$StudentPresenter]), StudentPresenter_0);
...
defineSeed(1079, 723, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1080, 723, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1081, 723, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1082, 723, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1083, 723, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1088, 797, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1089, 423, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1090, 1, {}, StudentView$2_0);
...
defineSeed(1091, 423, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1092, 1, {}, StudentView$4_0);
...
defineSeed(1093, 423, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1094, 1, {}, StudentView$6_0);
...
defineSeed(1095, 423, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1096, 1, {}, StudentView$8_0);
...
defineSeed(1097, 1, {}, StudentView_BinderImpl_0);
...
defineSeed(1098, 1, {}, StudentView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1110, 723, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1116, 805, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1117, 1, {}, UserManagementPresenterMyProxyImpl$3$1_0);
...
defineSeed(1244, 792, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler, Q$FrmBulletinManagementPresenter, Q$FrmBulletinManagementUiHandler]));
...
defineSeed(1251, 723, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(1261, 820, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(1262, 805, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1263, 1, {}, FrmBulletinManagementPresenterMyProxyImpl$1$1_0);
...
defineSeed(1846, 727, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$14X_0);
...
defineSeed(2022, 727, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
...
defineSeed(2031, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
;
defineSeed(2032, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
defineSeed(2035, 727, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(2038, 727, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
var Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$15_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$15', 1251), Lcom_lemania_sis_client_event_StudentAfterStatusChangeEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'StudentAfterStatusChangeEvent', 867), Lcom_lemania_sis_client_form_studentmgt_StudentPresenter_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentPresenter', 1078), Lcom_lemania_sis_client_form_studentmgt_StudentPresenter$1_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentPresenter$1', 1079), Lcom_lemania_sis_client_form_studentmgt_StudentPresenter$2_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentPresenter$2', 1080), Lcom_lemania_sis_client_form_studentmgt_StudentPresenter$3_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentPresenter$3', 1081), Lcom_lemania_sis_client_form_studentmgt_StudentPresenter$4_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentPresenter$4', 1082), Lcom_lemania_sis_client_form_studentmgt_StudentPresenter$5_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentPresenter$5', 1083), Lcom_lemania_sis_client_form_usermgt_UserManagementPresenter$7_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementPresenter$7', 1110), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenterMyProxyImpl$1', 1262), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenterMyProxyImpl$1$1', 1263), Lcom_lemania_sis_client_form_usermgt_UserManagementPresenterMyProxyImpl$3_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementPresenterMyProxyImpl$3', 1116), Lcom_lemania_sis_client_form_usermgt_UserManagementPresenterMyProxyImpl$3$1_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementPresenterMyProxyImpl$3$1', 1117), Lcom_lemania_sis_client_form_studentmgt_StudentView_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView', 1088), Lcom_lemania_sis_client_form_studentmgt_StudentView$1_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$1', 1089), Lcom_lemania_sis_client_form_studentmgt_StudentView$2_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$2', 1090), Lcom_lemania_sis_client_form_studentmgt_StudentView$3_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$3', 1091), Lcom_lemania_sis_client_form_studentmgt_StudentView$4_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$4', 1092), Lcom_lemania_sis_client_form_studentmgt_StudentView$5_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$5', 1093), Lcom_lemania_sis_client_form_studentmgt_StudentView$6_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$6', 1094), Lcom_lemania_sis_client_form_studentmgt_StudentView$7_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$7', 1095), Lcom_lemania_sis_client_form_studentmgt_StudentView$8_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView$8', 1096), Lcom_lemania_sis_client_form_studentmgt_StudentView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView_BinderImpl', 1097), Lcom_lemania_sis_client_form_studentmgt_StudentView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.form.studentmgt.', 'StudentView_BinderImpl$Widgets', 1098), Lcom_lemania_sis_shared_bulletin_BulletinRequestFactory_1BulletinRequestContextImpl$14X_2_classLit = createForClass('com.lemania.sis.shared.bulletin.', 'BulletinRequestFactory_BulletinRequestContextImpl$14X', 1846), Lcom_lemania_sis_shared_student_StudentRequestFactory_1StudentRequestContextImpl$1X_2_classLit = createForClass('com.lemania.sis.shared.student.', 'StudentRequestFactory_StudentRequestContextImpl$1X', 2035), Lcom_lemania_sis_shared_student_StudentRequestFactory_1StudentRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.student.', 'StudentRequestFactory_StudentRequestContextImpl$7X', 2038), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$12X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$12X', 2022);
$entry(onLoad)(33);
