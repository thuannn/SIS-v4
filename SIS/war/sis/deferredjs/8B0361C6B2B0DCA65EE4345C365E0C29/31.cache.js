...
defineSeed(1039, 792, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ProfessorAgendaUiHandlers]), ProfessorAgendaPresenter_0);
...
defineSeed(1040, 723, makeCastMap([Q$Receiver]), ProfessorAgendaPresenter$1_0);
...
defineSeed(1041, 723, makeCastMap([Q$Receiver]), ProfessorAgendaPresenter$2_0);
...
defineSeed(1044, 797, makeCastMap([Q$IsWidget, Q$ProfessorAgendaPresenter$MyView]), ProfessorAgendaView_0);
_.colorIndex = 0;
_.lstProfs = null;
_.tblAgenda = null;
...
defineSeed(1045, 1, makeCastMap([Q$MouseOverHandler, Q$EventHandler]), ProfessorAgendaView$1_0);
...
defineSeed(1046, 1, makeCastMap([Q$MouseOutHandler, Q$EventHandler]), ProfessorAgendaView$2_0);
...
defineSeed(1047, 1, makeCastMap([Q$MouseOverHandler, Q$EventHandler]), ProfessorAgendaView$3_0);
...
defineSeed(1048, 1, makeCastMap([Q$MouseOutHandler, Q$EventHandler]), ProfessorAgendaView$4_0);
...
defineSeed(1049, 1, {}, ProfessorAgendaView_BinderImpl_0);
...
defineSeed(1050, 1, {}, ProfessorAgendaView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1051, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), ProfessorAgendaView_BinderImpl$Widgets$1_0);
...
defineSeed(1870, 727, makeCastMap([Q$AbstractRequest]), MasterAgendaItemRequestFactory_MasterAgendaItemRequestContextImpl$5X_0);
...
defineSeed(1982, 727, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$4X_0);
...
;
var Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaPresenter_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaPresenter', 1039), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaPresenter$1_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaPresenter$1', 1040), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaPresenter$2_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaPresenter$2', 1041), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView', 1044), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView$1_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView$1', 1045), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView$2_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView$2', 1046), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView$3_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView$3', 1047), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView$4_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView$4', 1048), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView_BinderImpl', 1049), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView_BinderImpl$Widgets', 1050), Lcom_lemania_sis_client_form_profagenda_ProfessorAgendaView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.form.profagenda.', 'ProfessorAgendaView_BinderImpl$Widgets$1', 1051), Lcom_lemania_sis_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$4X', 1982), Lcom_lemania_sis_shared_masteragendaitem_MasterAgendaItemRequestFactory_1MasterAgendaItemRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.masteragendaitem.', 'MasterAgendaItemRequestFactory_MasterAgendaItemRequestContextImpl$5X', 1870);
$entry(onLoad)(31);
