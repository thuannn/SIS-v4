...
defineSeed(1297, 792, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(1298, 723, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(1299, 723, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(1300, 723, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(1301, 723, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1601, 797, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1602, 423, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
_.getValue = function getValue_66(object){
  return dynamicCast(object, Q$ClasseProxy).getClassName();
}
;
function $update_29(this$static, index, classe, value){
...
_.update = function update_30(index, classe, value){
  $update_29(this, index, dynamicCast(classe, Q$ClasseProxy), dynamicCast(value, Q$String));
}
;
_.this$0 = null;
...
defineSeed(1604, 423, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
_.getValue = function getValue_67(classe){
...
_.update = function update_31(index, classe, value){
  $update_30(this, index, dynamicCast(classe, Q$ClasseProxy), dynamicCast(value, Q$Boolean));
}
;
_.this$0 = null;
...
defineSeed(1934, 727, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1938, 727, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
