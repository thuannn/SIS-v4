...
defineSeed(1049, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAddPresenter, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(1050, 635, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(1069, 635, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(1074, 709, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1436, 701, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1657, 639, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
