...
defineSeed(961, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmSubjectAddPresenter, Q$FrmSubjectAddUiHandler]), FrmSubjectAddPresenter_0);
...
defineSeed(962, 635, makeCastMap([Q$Receiver]), FrmSubjectAddPresenter$1_0);
...
defineSeed(1348, 701, makeCastMap([Q$IsWidget, Q$FrmSubjectAddPresenter$MyView]), FrmSubjectAddView_0);
...
defineSeed(1349, 10, makeCastMap([Q$Timer]), FrmSubjectAddView$1_0);
...
defineSeed(1350, 1, {}, FrmSubjectAddView_BinderImpl_0);
...
defineSeed(1351, 1, {}, FrmSubjectAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1352, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmSubjectAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1664, 639, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$6X_0);
...
;
_.val$subject = null;
var Lcom_lemania_sis_client_presenter_FrmSubjectAddPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmSubjectAddPresenter', 961), Lcom_lemania_sis_client_presenter_FrmSubjectAddPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmSubjectAddPresenter$1', 962), Lcom_lemania_sis_client_view_FrmSubjectAddView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectAddView', 1348), Lcom_lemania_sis_client_view_FrmSubjectAddView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectAddView$1', 1349), Lcom_lemania_sis_client_view_FrmSubjectAddView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectAddView_BinderImpl', 1350), Lcom_lemania_sis_client_view_FrmSubjectAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectAddView_BinderImpl$Widgets', 1351), Lcom_lemania_sis_client_view_FrmSubjectAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmSubjectAddView_BinderImpl$Widgets$1', 1352), Lcom_lemania_sis_shared_service_SubjectRequestFactory_1SubjectRequestContextImpl$6X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'SubjectRequestFactory_SubjectRequestContextImpl$6X', 1664);
$entry(onLoad)(19);
