...
defineSeed(746, 235, {}, DrawSchoolInterfaceEvent_0);
...
;
defineSeed(866, 720, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(867, 702, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1_0);
...
defineSeed(868, 1, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1$1_0);
...
defineSeed(923, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(924, 628, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(925, 628, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(926, 628, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(943, 702, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1251, 694, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1529, 632, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
