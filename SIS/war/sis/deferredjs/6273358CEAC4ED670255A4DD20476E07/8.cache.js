...
function $loadActiveStudentList(this$static){
  var rc, rf, x;
  rc = (rf = new StudentRequestFactoryImpl_0 , $initialize(rf, this$static.eventBus, new EventSourceRequestTransport_1(this$static.eventBus)) , new StudentRequestFactory_StudentRequestContextImpl_0(rf));
...
defineSeed(805, 685, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinCreationPresenter, Q$FrmBulletinCreationUiHandler]), FrmBulletinCreationPresenter_0);
...
defineSeed(806, 624, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$1_0);
...
defineSeed(807, 624, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$2_0);
...
defineSeed(808, 624, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$3_0);
...
defineSeed(809, 624, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$4_0);
...
defineSeed(810, 624, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$5_0);
...
defineSeed(811, 624, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$6_0);
...
defineSeed(812, 624, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$7_0);
...
defineSeed(813, 624, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$8_0);
...
defineSeed(1119, 690, makeCastMap([Q$IsWidget, Q$FrmBulletinCreationPresenter$MyView]), FrmBulletinCreationView_0);
...
defineSeed(1120, 382, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$1_0);
...
defineSeed(1121, 382, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$2_0);
...
defineSeed(1122, 382, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$3_0);
...
defineSeed(1123, 356, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$4_0);
...
defineSeed(1124, 1, {}, FrmBulletinCreationView$5_0);
...
defineSeed(1125, 382, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$6_0);
...
defineSeed(1126, 382, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$7_0);
...
defineSeed(1127, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinCreationView$8_0);
...
defineSeed(1128, 1, {}, FrmBulletinCreationView_BinderImpl_0);
...
defineSeed(1129, 1, {}, FrmBulletinCreationView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1130, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$1_0);
...
defineSeed(1131, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$2_0);
...
defineSeed(1132, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$3_0);
...
defineSeed(1133, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$4_0);
...
defineSeed(1417, 628, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$1X_0);
...
defineSeed(1420, 628, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$7X_0);
...
defineSeed(1422, 628, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$9X_0);
...
defineSeed(1494, 628, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$3X_0);
...
;
var Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinCreationPresenter', 805), Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinCreationPresenter$1', 806), Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinCreationPresenter$2', 807), Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinCreationPresenter$3', 808), Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinCreationPresenter$4', 809), Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinCreationPresenter$5', 810), Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinCreationPresenter$6', 811), Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter$7_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinCreationPresenter$7', 812), Lcom_lemania_sis_client_presenter_FrmBulletinCreationPresenter$8_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinCreationPresenter$8', 813), Lcom_lemania_sis_client_view_FrmBulletinCreationView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView', 1119), Lcom_lemania_sis_client_view_FrmBulletinCreationView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView$1', 1120), Lcom_lemania_sis_client_view_FrmBulletinCreationView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView$2', 1121), Lcom_lemania_sis_client_view_FrmBulletinCreationView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView$3', 1122), Lcom_lemania_sis_client_view_FrmBulletinCreationView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView$4', 1123), Lcom_lemania_sis_client_view_FrmBulletinCreationView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView$5', 1124), Lcom_lemania_sis_client_view_FrmBulletinCreationView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView$6', 1125), Lcom_lemania_sis_client_view_FrmBulletinCreationView$7_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView$7', 1126), Lcom_lemania_sis_client_view_FrmBulletinCreationView$8_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView$8', 1127), Lcom_lemania_sis_client_view_FrmBulletinCreationView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView_BinderImpl', 1128), Lcom_lemania_sis_client_view_FrmBulletinCreationView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView_BinderImpl$Widgets', 1129), Lcom_lemania_sis_client_view_FrmBulletinCreationView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView_BinderImpl$Widgets$1', 1130), Lcom_lemania_sis_client_view_FrmBulletinCreationView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView_BinderImpl$Widgets$2', 1131), Lcom_lemania_sis_client_view_FrmBulletinCreationView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView_BinderImpl$Widgets$3', 1132), Lcom_lemania_sis_client_view_FrmBulletinCreationView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinCreationView_BinderImpl$Widgets$4', 1133), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$1X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$1X', 1417), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$7X', 1420), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$9X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$9X', 1422), Lcom_lemania_sis_shared_service_StudentRequestFactory_1StudentRequestContextImpl$3X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'StudentRequestFactory_StudentRequestContextImpl$3X', 1494);
$entry(onLoad)(8);
