...
function $loadUsersByType(this$static, type){
  ...
  if ($equals_5(type, 'tout')) {
    ...
    $initialize(rf_0, this$static.eventBus, new EventSourceRequestTransport_1(this$static.eventBus));
...
;
_.onLoginAuthenticated = function onLoginAuthenticated_50(event_0){
}
;
...
defineSeed(1000, 624, makeCastMap([Q$Receiver]), UserManagementPresenter$1_0);
...
defineSeed(1001, 624, makeCastMap([Q$Receiver]), UserManagementPresenter$2_0);
...
defineSeed(1002, 624, makeCastMap([Q$Receiver]), UserManagementPresenter$3_0);
...
defineSeed(1005, 624, makeCastMap([Q$Receiver]), UserManagementPresenter$6_0);
...
defineSeed(1324, 690, makeCastMap([Q$IsWidget, Q$UserManagementPresenter$MyView]), UserManagementView_0);
...
defineSeed(1325, 382, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$1_0);
...
defineSeed(1326, 356, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$10_0);
...
defineSeed(1327, 1, {}, UserManagementView$11_0);
...
defineSeed(1328, 382, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$12_0);
...
defineSeed(1329, 382, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$2_0);
...
defineSeed(1330, 382, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$3_0);
...
defineSeed(1331, 356, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$4_0);
...
defineSeed(1332, 1, {}, UserManagementView$5_0);
...
defineSeed(1333, 356, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$6_0);
...
defineSeed(1334, 1, {}, UserManagementView$7_0);
...
defineSeed(1335, 356, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$8_0);
...
defineSeed(1336, 1, {}, UserManagementView$9_0);
...
defineSeed(1337, 1, {}, UserManagementView_BinderImpl_0);
...
defineSeed(1338, 1, {}, UserManagementView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1339, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), UserManagementView_BinderImpl$Widgets$1_0);
...
defineSeed(1340, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), UserManagementView_BinderImpl$Widgets$2_0);
...
defineSeed(1512, 628, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$5X_0);
...
defineSeed(1513, 628, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$7X_0);
...
;
_.val$type = null;
var Lcom_lemania_sis_client_presenter_UserManagementPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter', 999), Lcom_lemania_sis_client_presenter_UserManagementPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$1', 1000), Lcom_lemania_sis_client_presenter_UserManagementPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$2', 1001), Lcom_lemania_sis_client_presenter_UserManagementPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$3', 1002), Lcom_lemania_sis_client_presenter_UserManagementPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$6', 1005), Lcom_lemania_sis_client_view_UserManagementView_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView', 1324), Lcom_lemania_sis_client_view_UserManagementView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$1', 1325), Lcom_lemania_sis_client_view_UserManagementView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$2', 1329), Lcom_lemania_sis_client_view_UserManagementView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$3', 1330), Lcom_lemania_sis_client_view_UserManagementView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$4', 1331), Lcom_lemania_sis_client_view_UserManagementView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$5', 1332), Lcom_lemania_sis_client_view_UserManagementView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$6', 1333), Lcom_lemania_sis_client_view_UserManagementView$7_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$7', 1334), Lcom_lemania_sis_client_view_UserManagementView$8_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$8', 1335), Lcom_lemania_sis_client_view_UserManagementView$9_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$9', 1336), Lcom_lemania_sis_client_view_UserManagementView$10_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$10', 1326), Lcom_lemania_sis_client_view_UserManagementView$11_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$11', 1327), Lcom_lemania_sis_client_view_UserManagementView$12_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView$12', 1328), Lcom_lemania_sis_client_view_UserManagementView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView_BinderImpl', 1337), Lcom_lemania_sis_client_view_UserManagementView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView_BinderImpl$Widgets', 1338), Lcom_lemania_sis_client_view_UserManagementView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView_BinderImpl$Widgets$1', 1339), Lcom_lemania_sis_client_view_UserManagementView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'UserManagementView_BinderImpl$Widgets$2', 1340), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$5X', 1512), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$7X', 1513);
$entry(onLoad)(25);
