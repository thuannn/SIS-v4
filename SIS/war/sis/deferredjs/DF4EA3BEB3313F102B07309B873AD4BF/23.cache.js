...
defineSeed(955, 689, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(956, 628, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(957, 628, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(958, 628, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(959, 628, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(960, 628, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(970, 628, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
;
defineSeed(971, 720, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$ProfessorAfterAddEvent$ProfessorAfterAddHandler, Q$StudentAfterAddEvent$StudentAfterAddHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(976, 702, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1274, 694, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1275, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1277, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1279, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1281, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1378, 632, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1456, 632, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1458, 632, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1471, 632, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$11X_0);
