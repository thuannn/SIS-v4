...
defineSeed(925, 689, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(926, 628, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(968, 628, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(974, 702, {}, UserManagementPresenterMyProxyImpl$2_0);
...
defineSeed(1236, 694, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1426, 632, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
