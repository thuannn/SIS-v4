...
defineSeed(851, 689, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(852, 628, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(853, 628, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(854, 628, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(855, 628, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1145, 694, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1146, 359, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(1148, 359, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1397, 632, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1401, 632, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
