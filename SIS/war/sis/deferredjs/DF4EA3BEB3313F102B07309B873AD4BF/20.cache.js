...
defineSeed(929, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(930, 628, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(931, 628, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(932, 628, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(933, 628, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(934, 628, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(935, 628, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(936, 628, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(937, 628, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(938, 628, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1244, 694, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1245, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1246, 359, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1249, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1250, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1251, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1252, 359, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1355, 632, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1356, 632, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1357, 632, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1427, 632, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
