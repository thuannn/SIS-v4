...
defineSeed(447, 415, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]));
...
function $setRowSpan(this$static, row, column, rowSpan){
  (this$static.this$0.prepareCell(row, column) , $clinit_DOM() , $getCellElement(this$static.this$0.bodyElem, row, column))['rowSpan'] = rowSpan;
}
...
function $setWidth_1(this$static, column, width_0){
  $setPropertyString($ensureColumn(this$static, column), 'width', width_0);
}
...
function $drawBulletin(this$static, bulletinId, subjects, branches){
  ...
  $fire((x_0 = new BulletinRequestFactory_BulletinRequestContextImpl$2X_0(rc, bulletinId) , $addInvocation(rc.state.dialect, x_0) , x_0), new FrmBulletinViewDetailPresenter$6_0(this$static, subjects, branches));
}
...
function $getBranches(this$static, bulletinId){
  ...
  $fire((x_0 = new BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X_0(rc, bulletinId) , $addInvocation(rc.state.dialect, x_0) , x_0), new FrmBulletinViewDetailPresenter$5_0(this$static, bulletinId));
}
...
defineSeed(869, 702, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinViewDetailPresenter, Q$FrmBulletinViewDetailUiHandler]), FrmBulletinViewDetailPresenter_0);
...
defineSeed(870, 641, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$1_0);
...
defineSeed(871, 641, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$2_0);
...
defineSeed(872, 641, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$3_0);
...
defineSeed(873, 641, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$4_0);
...
defineSeed(874, 641, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$5_0);
...
defineSeed(875, 641, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$6_0);
...
function $onLstBulletinsChange(this$static){
  $removeAllRows(this$static.tblBulletin);
  !!this$static.uiHandlers && $onBulletinChange(dynamicCast(this$static.uiHandlers, Q$FrmBulletinViewDetailUiHandler), $getValue_1(this$static.lstBulletins, $getSelectElement(this$static.lstBulletins).selectedIndex));
}

function $onLstClassesChange_1(this$static){
  !!this$static.uiHandlers && $onClassChange_0(dynamicCast(this$static.uiHandlers, Q$FrmBulletinViewDetailUiHandler), $getValue_1(this$static.lstClasses, $getSelectElement(this$static.lstClasses).selectedIndex));
}
...
function $styleTableMatu(this$static){
  var i, j;
  $setPropertyInt(this$static.tblBulletin.tableElem, 'cellSpacing', 0);
  $setPropertyInt(this$static.tblBulletin.tableElem, 'cellPadding', 3);
  $setStyleName(this$static.tblBulletin, 'subSection');
  for (i = 0; i < 15; i++)
    for (j = 1; j < $getDOMRowCount(this$static.tblBulletin); j++) {
      $isCellPresent(this$static.tblBulletin, j, i) && $equals_5($getElement_0(this$static.tblBulletin.cellFormatter, j, i).className, '') && $setStyleName_0(this$static.tblBulletin.cellFormatter, j, i, 'brancheLine');
    }
}
...
defineSeed(1245, 707, makeCastMap([Q$IsWidget, Q$FrmBulletinViewDetailPresenter$MyView]), FrmBulletinViewDetailView_0);
...
defineSeed(1246, 1, {}, FrmBulletinViewDetailView_BinderImpl_0);
...
defineSeed(1247, 1, {}, FrmBulletinViewDetailView_BinderImpl$Widgets_0);
function FrmBulletinViewDetailView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1248, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewDetailView_BinderImpl$Widgets$1_0);
...
defineSeed(1249, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewDetailView_BinderImpl$Widgets$2_0);
...
defineSeed(1566, 645, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X_0);
...
function $listAllByEmail(this$static, email){
  var x_0;
  x_0 = new BulletinRequestFactory_BulletinRequestContextImpl$8X_0(this$static, email);
...
defineSeed(1577, 645, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$2X_0);
...
defineSeed(1580, 645, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$8X_0);
...
;
var Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter', 869), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$1', 870), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$2', 871), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$3', 872), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$4', 873), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$5', 874), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$6', 875), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView', 1245), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl', 1246), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets', 1247), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets$1', 1248), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets$2', 1249), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$2X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$2X', 1577), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$8X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$8X', 1580), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X', 1566);
$entry(onLoad)(10);
