...
defineSeed(770, 678, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$FrmBrancheAddUiHandler]), FrmBrancheAddPresenter_0);
...
function $onSuccess_10(this$static){
  $showStatus(dynamicCast(this$static.this$0.view, Q$FrmBrancheAddPresenter$MyView));
  $resetForm(dynamicCast(this$static.this$0.view, Q$FrmBrancheAddPresenter$MyView));
}
...
defineSeed(771, 617, makeCastMap([Q$Receiver]), FrmBrancheAddPresenter$1_0);
...
defineSeed(924, 1, makeCastMap([Q$RunAsyncCallback]));
_.onSuccess = function onSuccess_80(){
...
function $resetForm(this$static){
  this$static.txtBrancheName.element['value'] = '';
  this$static.txtBrancheCoef.element['value'] = '';
  $setValue_0(this$static.chkBrancheActive, ($clinit_Boolean() , $clinit_Boolean() , TRUE_1));
}

function $showStatus(this$static){
  var t;
  $setText_0(this$static.lblStatus, 'La nouvelle branche a \xE9t\xE9 cr\xE9\xE9e avec succ\xE8s.');
...
defineSeed(964, 683, makeCastMap([Q$IsWidget, Q$FrmBrancheAddPresenter$MyView]), FrmBrancheAddView_0);
...
defineSeed(965, 10, makeCastMap([Q$Timer]), FrmBrancheAddView$1_0);
...
defineSeed(966, 1, {}, FrmBrancheAddView_BinderImpl_0);
function $build_f_HTMLPanel1_4(this$static){
  ...
  $addAndReplaceElement(f_HTMLPanel1, (f_VerticalPanel2 = new VerticalPanel_0 , $add_9(f_VerticalPanel2, (f_Label3 = new Label_0 , f_Label3.element['className'] = 'pageTitle' , $setAutoHorizontalAlignment(f_Label3, ($clinit_HasHorizontalAlignment() , ALIGN_CENTER)) , $setTextOrHtml(f_Label3.directionalTextHelper, 'AJOUTER UNE NOUVELLE BRANCHE') , $updateHorizontalAlignment(f_Label3) , f_Label3)) , $add_9(f_VerticalPanel2, (f_Grid4 = new Grid_0 , $resizeColumns(f_Grid4, 2) , $resizeRows(f_Grid4, 5) , $setWidget_1(f_Grid4, 0, 0, (f_Label5 = new Label_0 , $setTextOrHtml(f_Label5.directionalTextHelper, 'Nom de la branche :') , $updateHorizontalAlignment(f_Label5) , f_Label5)) , $setWidget_1(f_Grid4, 0, 1, (txtBrancheName = new TextBox_0 , txtBrancheName.element['className'] = 'sis_textbox' , this$static.owner.txtBrancheName = txtBrancheName , txtBrancheName)) , $setWidget_1(f_Grid4, 1, 0, (f_Label6 = new Label_0 , $setTextOrHtml(f_Label6.directionalTextHelper, 'Coefficient :') , $updateHorizontalAlignment(f_Label6) , f_Label6)) , $setWidget_1(f_Grid4, 1, 1, (txtBrancheCoef = new TextBox_0 , this$static.owner.txtBrancheCoef = txtBrancheCoef , txtBrancheCoef)) , $setWidget_1(f_Grid4, 2, 0, (f_Label7 = new Label_0 , f_Label7.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label7.directionalTextHelper, '.') , $updateHorizontalAlignment(f_Label7) , f_Label7)) , $setWidget_1(f_Grid4, 2, 1, (chkBrancheActive = new CheckBox_0 , $setTextOrHtml(chkBrancheActive.directionalTextHelper, 'Active') , $setValue_0(chkBrancheActive, ($clinit_Boolean() , $clinit_Boolean() , TRUE_1)) , this$static.owner.chkBrancheActive = chkBrancheActive , chkBrancheActive)) , $setWidget_1(f_Grid4, 3, 0, (f_Label8 = new Label_0 , f_Label8.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label8.directionalTextHelper, '.') , $updateHorizontalAlignment(f_Label8) , f_Label8)) , $setWidget_1(f_Grid4, 3, 1, (f_HorizontalPanel9 = new HorizontalPanel_0 , $add_7(f_HorizontalPanel9, (cmdSave = new Button_0 , $setInnerText(cmdSave.element, 'Enregistrer') , $addDomHandler(cmdSave, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_ClickEvent() , $clinit_ClickEvent() , TYPE_0)) , cmdSave)) , f_HorizontalPanel9)) , $setWidget_1(f_Grid4, 4, 0, (f_Label10 = new Label_0 , f_Label10.element['className'] = 'hiddenText' , $setTextOrHtml(f_Label10.directionalTextHelper, '.') , $updateHorizontalAlignment(f_Label10) , f_Label10)) , $setWidget_1(f_Grid4, 4, 1, (lblStatus = new Label_0 , this$static.owner.lblStatus = lblStatus , lblStatus)) , f_Grid4.element.style['width'] = '80%' , f_Grid4.tableElem['cellSpacing'] = 5 , f_Grid4.tableElem['cellPadding'] = 5 , f_Grid4)) , f_VerticalPanel2.element.style['width'] = '100%' , f_VerticalPanel2.table['cellSpacing'] = 2 , f_VerticalPanel2), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(967, 1, {}, FrmBrancheAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(968, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBrancheAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1186, 621, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$4X_0);
...
;
_.val$branche = null;
var Lcom_lemania_sis_client_presenter_FrmBrancheAddPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheAddPresenter', 770), Lcom_lemania_sis_client_presenter_FrmBrancheAddPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheAddPresenter$1', 771), Lcom_lemania_sis_client_view_FrmBrancheAddView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView', 964), Lcom_lemania_sis_client_view_FrmBrancheAddView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView$1', 965), Lcom_lemania_sis_client_view_FrmBrancheAddView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView_BinderImpl', 966), Lcom_lemania_sis_client_view_FrmBrancheAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets', 967), Lcom_lemania_sis_client_view_FrmBrancheAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets$1', 968), Lcom_lemania_sis_shared_service_BrancheRequestFactory_1BrancheRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BrancheRequestFactory_BrancheRequestContextImpl$4X', 1186);
$entry(onLoad)(6);
