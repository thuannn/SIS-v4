...
defineSeed(947, 689, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(948, 628, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(949, 628, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(950, 628, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(951, 628, makeCastMap([Q$Receiver]), SettingsPresenter$4_0);
...
defineSeed(952, 628, makeCastMap([Q$Receiver]), SettingsPresenter$5_0);
...
defineSeed(1265, 694, makeCastMap([Q$IsWidget, Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1455, 632, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
...
defineSeed(1477, 632, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$3X_0);
