...
defineSeed(757, 689, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ContactUiHandler]), ContactPresenter_0);
...
defineSeed(1035, 694, makeCastMap([Q$IsWidget, Q$ContactPresenter$MyView]), ContactView_0);
...
defineSeed(1406, 623, {}, ContactRequestFactoryImpl_0);
...
defineSeed(1407, 633, makeCastMap([Q$AbstractRequestContext]), ContactRequestFactory_ContactRequestContextImpl_0);
...
defineSeed(1408, 632, makeCastMap([Q$AbstractRequest]), ContactRequestFactory_ContactRequestContextImpl$1X_0);
...
defineSeed(1409, 561, makeCastMap([Q$EnumMap]), ContactRequestFactory_ContactRequestContextImpl_FactoryImpl_0);
