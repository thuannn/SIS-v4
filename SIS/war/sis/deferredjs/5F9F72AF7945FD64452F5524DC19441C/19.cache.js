...
defineSeed(929, 689, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(930, 628, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(972, 628, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(978, 702, {}, UserManagementPresenterMyProxyImpl$2_0);
...
defineSeed(1240, 694, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1429, 632, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
