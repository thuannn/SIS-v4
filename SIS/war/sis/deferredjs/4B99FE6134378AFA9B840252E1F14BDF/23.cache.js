...
defineSeed(1400, 692, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1401, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1402, 357, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1405, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1406, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1407, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1408, 357, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1524, 630, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1525, 630, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1526, 630, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1615, 630, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
