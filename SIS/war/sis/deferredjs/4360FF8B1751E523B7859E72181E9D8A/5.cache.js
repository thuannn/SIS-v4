...
defineSeed(1162, 710, makeCastMap([Q$IsWidget, Q$EcolePresenter$MyView]), EcoleView_0);
...
defineSeed(1163, 392, makeCastMap([Q$HasCell, Q$Column]), EcoleView$1_0);
...
defineSeed(1164, 392, makeCastMap([Q$HasCell, Q$Column]), EcoleView$2_0);
...
defineSeed(1165, 366, makeCastMap([Q$HasCell, Q$Column]), EcoleView$3_0);
...
defineSeed(1583, 648, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$6X_0);
