...
defineSeed(1280, 805, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinViewDetailPresenter, Q$FrmBulletinViewDetailUiHandler]), FrmBulletinViewDetailPresenter_0);
...
defineSeed(1281, 736, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$1_0);
...
defineSeed(1282, 736, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$2_0);
...
defineSeed(1283, 736, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$3_0);
...
defineSeed(1284, 736, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$4_0);
...
defineSeed(1285, 736, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$5_0);
...
defineSeed(1286, 736, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$6_0);
...
defineSeed(1514, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(1590, 810, makeCastMap([Q$IsWidget, Q$FrmBulletinViewDetailPresenter$MyView]), FrmBulletinViewDetailView_0);
...
defineSeed(1591, 1, {}, FrmBulletinViewDetailView_BinderImpl_0);
...
defineSeed(1592, 1, {}, FrmBulletinViewDetailView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1593, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewDetailView_BinderImpl$Widgets$1_0);
...
defineSeed(1594, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewDetailView_BinderImpl$Widgets$2_0);
...
defineSeed(1861, 740, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$2X_0);
...
defineSeed(1865, 740, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$9X_0);
...
defineSeed(1932, 740, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X_0);
...
;
_.val$bulletinId = null;
var Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter', 1280), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$1', 1281), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$2', 1282), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$3', 1283), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$4', 1284), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$5', 1285), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$6', 1286), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView', 1590), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl', 1591), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets', 1592), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets$1', 1593), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets$2', 1594), Lcom_lemania_sis_shared_bulletin_BulletinRequestFactory_1BulletinRequestContextImpl$2X_2_classLit = createForClass('com.lemania.sis.shared.bulletin.', 'BulletinRequestFactory_BulletinRequestContextImpl$2X', 1861), Lcom_lemania_sis_shared_bulletin_BulletinRequestFactory_1BulletinRequestContextImpl$9X_2_classLit = createForClass('com.lemania.sis.shared.bulletin.', 'BulletinRequestFactory_BulletinRequestContextImpl$9X', 1865), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X', 1932);
$entry(onLoad)(10);
