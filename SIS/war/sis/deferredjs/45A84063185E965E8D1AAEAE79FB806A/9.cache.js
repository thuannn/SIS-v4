function $addBranche(this$static, bulletinSubjectId, brancheId, coef){
  ...
  $fire((x_0 = new BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X_0(rc, bulletinSubjectId, brancheId, coef) , $addInvocation(rc.state.dialect, x_0) , x_0), new FrmBulletinManagementPresenter$14_0(this$static));
}
...
function $addSubject(this$static, bulletinId, subjectId, profId, coef){
  ...
  $fire((x_0 = new BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X_0(rc, bulletinId, subjectId, profId, coef) , $addInvocation(rc.state.dialect, x_0) , x_0), new FrmBulletinManagementPresenter$13_0(this$static));
}
...
function $loadSubjectListByProfile(this$static, bulletin){
  ...
  $fire((x_0 = new SubjectRequestFactory_SubjectRequestContextImpl$4X_0(rc, bulletin) , $addInvocation(rc.state.dialect, x_0) , x_0), new FrmBulletinManagementPresenter$2_0(this$static));
}
...
function $removeBranche(this$static, branche){
  ...
  $initialize(rf, this$static.eventBus, new EventSourceRequestTransport_0(this$static.eventBus));
  rc = new BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl_0(rf);
  $fire((x_0 = new BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X_0(rc, branche) , $addInvocation(rc.state.dialect, x_0) , x_0), new FrmBulletinManagementPresenter$11_0(this$static));
}
...
function $removeSubject(this$static, subject){
  ...
  $initialize(rf, this$static.eventBus, new EventSourceRequestTransport_0(this$static.eventBus));
  rc = new BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl_0(rf);
  $fire((x_0 = new BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X_0(rc, subject) , $addInvocation(rc.state.dialect, x_0) , x_0), new FrmBulletinManagementPresenter$8_0(this$static));
}
...
defineSeed(849, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$1_0);
...
defineSeed(850, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$10_0);
...
defineSeed(851, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$11_0);
...
defineSeed(852, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$12_0);
...
defineSeed(853, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$13_0);
...
defineSeed(854, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$14_0);
...
defineSeed(856, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$16_0);
...
defineSeed(857, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$2_0);
...
defineSeed(858, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$3_0);
...
defineSeed(859, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$4_0);
...
defineSeed(860, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$5_0);
...
defineSeed(861, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$6_0);
...
defineSeed(862, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$7_0);
...
defineSeed(863, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$8_0);
...
defineSeed(864, 643, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$9_0);
...
defineSeed(1152, 1, makeCastMap([Q$RunAsyncCallback]));
...
function $onCmdAddBrancheClick(this$static){
  !!this$static.uiHandlers && $addBranche(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), '' + toString_6(this$static.selectedSubject.getId_0().value_0), $getValue_1(this$static.lstBranches, $getSelectElement(this$static.lstBranches).selectedIndex), $getPropertyString($getElement(this$static.txtBrancheCoef), 'value'));
}

function $onCmdAddSubjectClick(this$static){
  !!this$static.uiHandlers && $addSubject(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), '' + toString_6(this$static.selectedBulletin.getId_0().value_0), $getValue_1(this$static.lstSubjects, $getSelectElement(this$static.lstSubjects).selectedIndex), $getValue_1(this$static.lstProfessors, $getSelectElement(this$static.lstProfessors).selectedIndex), $getPropertyString($getElement(this$static.txtSubjectCoef), 'value'));
}
...
function $onLstClassesChange_0(this$static){
  ...
  !!this$static.uiHandlers && $onClassChange(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), $getValue_1(this$static.lstClasses, $getSelectElement(this$static.lstClasses).selectedIndex));
}
...
function $onLstEcolesChange_0(this$static){
  ...
  !!this$static.uiHandlers && $onEcoleSelected_0(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), $getValue_1(this$static.lstEcoles, $getSelectElement(this$static.lstEcoles).selectedIndex));
}
...
function $onLstProgrammesChange_0(this$static){
  ...
  if (!$getValue_1(this$static.lstProgrammes, $getSelectElement(this$static.lstProgrammes).selectedIndex).length)
    return;
  !!this$static.uiHandlers && $onProgrammeSelected_0(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), $getValue_1(this$static.lstProgrammes, $getSelectElement(this$static.lstProgrammes).selectedIndex));
}

function $onLstSubjectsChange(this$static){
  !!this$static.uiHandlers && $loadProfessorList(dynamicCast(this$static.uiHandlers, Q$FrmBulletinManagementUiHandler), $getValue_1(this$static.lstSubjects, $getSelectElement(this$static.lstSubjects).selectedIndex), $getValue_1(this$static.lstClasses, $getSelectElement(this$static.lstClasses).selectedIndex));
}
...
defineSeed(1222, 709, makeCastMap([Q$IsWidget, Q$FrmBulletinManagementPresenter$MyView]), FrmBulletinManagementView_0);
...
defineSeed(1223, 390, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$1_0);
...
defineSeed(1224, 390, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$10_0);
...
defineSeed(1225, 364, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$11_0);
_.getValue = function getValue_18(bp){
  return dynamicCast(bp, Q$BulletinSubjectProxy) , 'X';
}
;
function $update_8(this$static, index_0, subject){
  this$static.this$0.selectedSubjectIndex = valueOf_1(index_0);
...
defineSeed(1226, 1, {}, FrmBulletinManagementView$12_0);
_.update = function update_9(index_0, subject, value_0){
  $update_8(this, index_0, dynamicCast(subject, Q$BulletinSubjectProxy), dynamicCast(value_0, Q$String));
}
;
...
defineSeed(1227, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinManagementView$13_0);
...
defineSeed(1228, 390, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$14_0);
...
defineSeed(1229, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinManagementView$15_0);
...
defineSeed(1230, 364, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$2_0);
_.getValue = function getValue_20(object){
  return $getValue_5(dynamicCast(object, Q$BulletinBrancheProxy));
}
;
function $update_9(this$static, index_0, branche, value_0){
  this$static.this$0.selectedBrancheIndex = valueOf_1(index_0);
  this$static.this$0.selectedBranche = branche;
  !!this$static.this$0.uiHandlers && $updateBrancheCoef(dynamicCast(this$static.this$0.uiHandlers, Q$FrmBulletinManagementUiHandler), branche, value_0);
}
...
defineSeed(1231, 1, {}, FrmBulletinManagementView$3_0);
_.update = function update_10(index_0, branche, value_0){
  $update_9(this, index_0, dynamicCast(branche, Q$BulletinBrancheProxy), dynamicCast(value_0, Q$String));
}
;
...
defineSeed(1232, 364, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$4_0);
_.getValue = function getValue_21(bp){
  return dynamicCast(bp, Q$BulletinBrancheProxy) , 'X';
}
;
function $update_10(this$static, index_0, bp){
  this$static.this$0.selectedBrancheIndex = valueOf_1(index_0);
...
defineSeed(1233, 1, {}, FrmBulletinManagementView$5_0);
_.update = function update_11(index_0, bp, value_0){
  $update_10(this, index_0, dynamicCast(bp, Q$BulletinBrancheProxy), dynamicCast(value_0, Q$String));
}
;
...
defineSeed(1234, 390, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$6_0);
...
defineSeed(1235, 364, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$7_0);
_.getValue = function getValue_23(object){
  return $getValue_6(dynamicCast(object, Q$BulletinSubjectProxy));
}
;
function $update_11(this$static, index_0, subject, value_0){
  if (!this$static.this$0.selectedSubject.equals$(subject))
    return;
  if (subject.getSubjectCoef().value_0 != ($clinit_Double() , __parseAndValidateDouble(value_0))) {
    this$static.this$0.selectedSubjectIndex = valueOf_1(index_0);
    this$static.this$0.selectedSubject = subject;
    !!this$static.this$0.uiHandlers && ($equals_5('' + subject.getSubjectCoef().value_0, value_0) || $updateSubjectCoef(dynamicCast(this$static.this$0.uiHandlers, Q$FrmBulletinManagementUiHandler), subject, value_0, this$static.this$0.selectedSubjectIndex));
  }
}
...
defineSeed(1236, 1, {}, FrmBulletinManagementView$8_0);
_.update = function update_12(index_0, subject, value_0){
  $update_11(this, index_0, dynamicCast(subject, Q$BulletinSubjectProxy), dynamicCast(value_0, Q$String));
}
;
...
defineSeed(1237, 390, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinManagementView$9_0);
...
defineSeed(1238, 1, {}, FrmBulletinManagementView_BinderImpl_0);
...
defineSeed(1239, 1, {}, FrmBulletinManagementView_BinderImpl$Widgets_0);
function FrmBulletinManagementView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1240, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$1_0);
...
defineSeed(1241, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$2_0);
...
defineSeed(1242, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$3_0);
...
defineSeed(1243, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$4_0);
...
defineSeed(1244, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$5_0);
...
defineSeed(1245, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinManagementView_BinderImpl$Widgets$6_0);
...
defineSeed(1500, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
...
;
defineSeed(1501, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinBrancheProxy]));
_.setBrancheCoef = function setBrancheCoef_0(brancheCoef){
  $setProperty(this.this$0, 'brancheCoef', brancheCoef);
}
;
defineSeed(1506, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
;
defineSeed(1507, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinSubjectProxy]));
...
defineSeed(1566, 647, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X_0);
...
defineSeed(1570, 647, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X_0);
...
defineSeed(1587, 647, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X_0);
...
defineSeed(1590, 647, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X_0);
...
defineSeed(1682, 647, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$4X_0);
_.makeRequestData = function makeRequestData_73(){
  return new RequestData_0('K7KNwqW$sLQ_nhTaC55sPTL_$is=', initValues(_3Ljava_lang_Object_2_classLit, makeCastMap([Q$Serializable, Q$Object_$1]), Q$Object, [this.val$bulletin]), this.propertyRefs, Ljava_util_List_2_classLit, Lcom_lemania_sis_shared_SubjectProxy_2_classLit);
}
;
var Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter', 848), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$1', 849), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$2', 857), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$3', 858), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$4', 859), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$5', 860), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$6', 861), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$7_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$7', 862), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$8_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$8', 863), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$9_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$9', 864), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$10_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$10', 850), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$11_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$11', 851), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$12_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$12', 852), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$13_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$13', 853), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$14_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$14', 854), Lcom_lemania_sis_client_presenter_FrmBulletinManagementPresenter$16_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinManagementPresenter$16', 856), Lcom_lemania_sis_client_view_FrmBulletinManagementView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView', 1222), Lcom_lemania_sis_client_view_FrmBulletinManagementView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$1', 1223), Lcom_lemania_sis_client_view_FrmBulletinManagementView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$2', 1230), Lcom_lemania_sis_client_view_FrmBulletinManagementView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$3', 1231), Lcom_lemania_sis_client_view_FrmBulletinManagementView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$4', 1232), Lcom_lemania_sis_client_view_FrmBulletinManagementView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$5', 1233), Lcom_lemania_sis_client_view_FrmBulletinManagementView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$6', 1234), Lcom_lemania_sis_client_view_FrmBulletinManagementView$7_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$7', 1235), Lcom_lemania_sis_client_view_FrmBulletinManagementView$8_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$8', 1236), Lcom_lemania_sis_client_view_FrmBulletinManagementView$9_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$9', 1237), Lcom_lemania_sis_client_view_FrmBulletinManagementView$10_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$10', 1224), Lcom_lemania_sis_client_view_FrmBulletinManagementView$11_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$11', 1225), Lcom_lemania_sis_client_view_FrmBulletinManagementView$12_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$12', 1226), Lcom_lemania_sis_client_view_FrmBulletinManagementView$13_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$13', 1227), Lcom_lemania_sis_client_view_FrmBulletinManagementView$14_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$14', 1228), Lcom_lemania_sis_client_view_FrmBulletinManagementView$15_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView$15', 1229), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl', 1238), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets', 1239), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$1', 1240), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$2', 1241), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$3', 1242), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$4', 1243), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$5', 1244), Lcom_lemania_sis_client_view_FrmBulletinManagementView_1BinderImpl$Widgets$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinManagementView_BinderImpl$Widgets$6', 1245), Lcom_lemania_sis_shared_service_SubjectRequestFactory_1SubjectRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'SubjectRequestFactory_SubjectRequestContextImpl$4X', 1682), Lcom_lemania_sis_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$7X', 1590), Lcom_lemania_sis_shared_service_BulletinSubjectRequestFactory_1BulletinSubjectRequestContextImpl$10X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$10X', 1587), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$7X', 1570), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$10X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$10X', 1566);
$entry(onLoad)(9);
