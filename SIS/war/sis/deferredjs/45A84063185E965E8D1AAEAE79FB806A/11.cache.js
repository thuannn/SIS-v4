...
defineSeed(882, 704, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinViewSummaryPresenter, Q$FrmBulletinViewSummaryUiHandler]), FrmBulletinViewSummaryPresenter_0);
...
defineSeed(883, 643, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$1_0);
...
defineSeed(884, 643, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$2_0);
...
defineSeed(885, 643, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$3_0);
...
defineSeed(886, 643, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$4_0);
...
function $drawESBulletin(this$static, subjects){
  ...
  for (i0 = rowStart.value_0; i0 < subjects.size_1() + rowStart.value_0; i0++) {
    ...
    $setText_0(this$static.tblNotes, i0, 1, '' + dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getSubjectCoef().value_0);
    $setText_0(this$static.tblNotes, i0, 2, dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getT1());
    $setText_0(this$static.tblNotes, i0, 3, dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getT2());
    $setText_0(this$static.tblNotes, i0, 4, dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getT3());
    $setText_0(this$static.tblNotes, i0, 5, dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getAn());
    if (dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getAn().length) {
      totalMoyenne = new Double_0(totalMoyenne.value_0 + __parseAndValidateDouble(dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getAn()) * dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getSubjectCoef().value_0);
      totalCoef = new Double_0(totalCoef.value_0 + dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getSubjectCoef().value_0);
      if (dynamicCast(subjects.get_1(rowCount.value_0), Q$BulletinSubjectProxy).getT1().length) {
...
function $onCmdPrintClick(this$static){
  ...
  $getParentElement(($clinit_DOM() , $getFirstChildElement(popup.element))).className = 'bulletin';
...
function $styleESTable(this$static){
  ...
  $setPropertyInt(this$static.tblNotes.tableElem, 'cellSpacing', 0);
  $setPropertyInt(this$static.tblNotes.tableElem, 'cellPadding', 3);
  for (i0 = 1; i0 < $getCellCount(this$static.tblNotes, 0) - 1; i0++)
    $setStyleName_0(this$static.tblNotes.cellFormatter, 0, i0, 'bulletinHeaderNote');
  $setStyleName_0(this$static.tblNotes.cellFormatter, 0, 0, 'bulletinHeader');
  $setStyleName_0(this$static.tblNotes.cellFormatter, 0, $getCellCount(this$static.tblNotes, 0) - 1, 'bulletinHeader');
  for (i = 0; i < 6; i++)
    for (j = 1; j < $getDOMRowCount(this$static.tblNotes); j++) {
      $isCellPresent(this$static.tblNotes, j, i) && $equals_5($getElement_0(this$static.tblNotes.cellFormatter, j, i).className, '') && $setStyleName_0(this$static.tblNotes.cellFormatter, j, i, 'bulletinBrancheLine');
    }
}
...
defineSeed(1253, 709, makeCastMap([Q$IsWidget, Q$FrmBulletinViewSummaryPresenter$MyView]), FrmBulletinViewSummaryView_0);
...
defineSeed(1254, 502, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]), FrmBulletinViewSummaryView$1_0);
...
defineSeed(1255, 1, makeCastMap([Q$CloseHandler, Q$EventHandler]), FrmBulletinViewSummaryView$2_0);
...
defineSeed(1256, 1, {}, FrmBulletinViewSummaryView_BinderImpl_0);
...
defineSeed(1257, 1, {}, FrmBulletinViewSummaryView_BinderImpl$Widgets_0);
function FrmBulletinViewSummaryView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1258, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$1_0);
...
defineSeed(1259, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$2_0);
...
defineSeed(1260, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$3_0);
...
defineSeed(1261, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$4_0);
...
defineSeed(1262, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$5_0);
...
defineSeed(1576, 647, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$12X_0);
...
;
var Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter', 882), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter$1', 883), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter$2', 884), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter$3', 885), Lcom_lemania_sis_client_presenter_FrmBulletinViewSummaryPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewSummaryPresenter$4', 886), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView', 1253), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView$1', 1254), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView$2', 1255), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl', 1256), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets', 1257), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$1', 1258), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$2', 1259), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$3', 1260), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$4', 1261), Lcom_lemania_sis_client_view_FrmBulletinViewSummaryView_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewSummaryView_BinderImpl$Widgets$5', 1262), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$12X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$12X', 1576);
$entry(onLoad)(11);
