...
defineSeed(845, 689, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$FrmClasseAddUiHandler]), FrmClasseAddPresenter_0);
...
defineSeed(846, 628, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$1_0);
...
defineSeed(847, 628, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$2_0);
...
defineSeed(848, 628, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$3_0);
...
defineSeed(1138, 694, makeCastMap([Q$IsWidget, Q$FrmClasseAddPresenter$MyView]), FrmClasseAddView_0);
...
defineSeed(1139, 10, makeCastMap([Q$Timer]), FrmClasseAddView$1_0);
...
defineSeed(1400, 632, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$8X_0);
