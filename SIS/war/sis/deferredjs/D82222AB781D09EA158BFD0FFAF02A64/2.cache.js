...
defineSeed(757, 685, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(758, 624, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(759, 624, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(767, 716, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CoursAddedEvent$CoursAddedHandler]));
...
defineSeed(768, 698, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(1036, 690, makeCastMap([Q$IsWidget, Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(1410, 628, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
