...
defineSeed(951, 685, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(952, 624, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(967, 624, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(972, 698, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1267, 690, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1458, 628, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
