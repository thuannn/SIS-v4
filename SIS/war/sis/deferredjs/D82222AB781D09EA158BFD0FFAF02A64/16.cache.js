...
defineSeed(876, 685, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$FrmSubjectAddUiHandler]), FrmSubjectAddPresenter_0);
...
defineSeed(877, 624, makeCastMap([Q$Receiver]), FrmSubjectAddPresenter$1_0);
...
defineSeed(1182, 690, makeCastMap([Q$IsWidget, Q$FrmSubjectAddPresenter$MyView]), FrmSubjectAddView_0);
...
defineSeed(1183, 12, makeCastMap([Q$Timer]), FrmSubjectAddView$1_0);
...
defineSeed(1465, 628, makeCastMap([Q$AbstractRequest]), SubjectRequestFactory_SubjectRequestContextImpl$6X_0);
