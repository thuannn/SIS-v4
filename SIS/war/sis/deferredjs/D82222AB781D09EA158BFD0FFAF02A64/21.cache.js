...
defineSeed(943, 685, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(944, 624, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(945, 624, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(946, 624, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(947, 624, makeCastMap([Q$Receiver]), SettingsPresenter$4_0);
...
defineSeed(948, 624, makeCastMap([Q$Receiver]), SettingsPresenter$5_0);
...
defineSeed(1261, 690, makeCastMap([Q$IsWidget, Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1451, 628, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
...
defineSeed(1473, 628, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$3X_0);
