...
defineSeed(742, 230, {}, StudentAfterAddEvent_0);
...
defineSeed(985, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAddPresenter, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(986, 619, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(1005, 619, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(1010, 693, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1309, 685, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1501, 623, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
