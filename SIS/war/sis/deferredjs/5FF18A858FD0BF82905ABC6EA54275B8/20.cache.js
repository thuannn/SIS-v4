...
defineSeed(967, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(968, 631, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(969, 631, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(970, 631, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(987, 705, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(988, 1, {}, MainPagePresenterMyProxyImpl$5$1_0);
...
defineSeed(1354, 697, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1660, 635, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
