...
defineSeed(1174, 697, makeCastMap([Q$IsWidget, Q$FrmBrancheListPresenter$MyView]), FrmBrancheListView_0);
...
defineSeed(1175, 359, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$1_0);
...
defineSeed(1177, 359, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$3_0);
...
defineSeed(1179, 359, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$5_0);
...
defineSeed(1534, 635, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$5X_0);
...
defineSeed(1541, 635, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$6X_0);
