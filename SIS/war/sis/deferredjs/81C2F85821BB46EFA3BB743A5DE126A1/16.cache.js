...
defineSeed(716, 223, {}, StudentAfterAddEvent_0);
...
defineSeed(827, 659, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(828, 598, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(843, 598, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(846, 672, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(847, 1, {}, UserManagementPresenterMyProxyImpl$1$1_0);
...
defineSeed(1039, 664, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1040, 1, {}, StudentAddView_BinderImpl_0);
...
defineSeed(1041, 1, {}, StudentAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1042, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), StudentAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1150, 602, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$5X_0);
...
_.val$lastName = null;
var Lcom_lemania_sis_client_presenter_StudentAddPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentAddPresenter', 827), Lcom_lemania_sis_client_presenter_StudentAddPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentAddPresenter$1', 828), Lcom_lemania_sis_client_presenter_UserManagementPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$4', 843), Lcom_lemania_sis_client_event_StudentAfterAddEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'StudentAfterAddEvent', 716), Lcom_lemania_sis_client_presenter_UserManagementPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenterMyProxyImpl$1', 846), Lcom_lemania_sis_client_presenter_UserManagementPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenterMyProxyImpl$1$1', 847), Lcom_lemania_sis_client_view_StudentAddView_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentAddView', 1039), Lcom_lemania_sis_client_view_StudentAddView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentAddView_BinderImpl', 1040), Lcom_lemania_sis_client_view_StudentAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentAddView_BinderImpl$Widgets', 1041), Lcom_lemania_sis_client_view_StudentAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentAddView_BinderImpl$Widgets$1', 1042), Lcom_lemania_sis_shared_service_StudentRequestFactory_1StudentRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'StudentRequestFactory_StudentRequestContextImpl$5X', 1150);
$entry(onLoad)(16);
