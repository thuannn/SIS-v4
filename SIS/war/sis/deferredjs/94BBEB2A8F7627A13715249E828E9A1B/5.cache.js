...
defineSeed(795, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$EcoleAddedEvent$EcoleAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$EcolePresenter, Q$EcoleListUiHandler]), EcolePresenter_0);
...
defineSeed(796, 631, makeCastMap([Q$Receiver]), EcolePresenter$1_0);
...
defineSeed(797, 631, makeCastMap([Q$Receiver]), EcolePresenter$2_0);
...
defineSeed(1167, 697, makeCastMap([Q$IsWidget, Q$EcolePresenter$MyView]), EcoleView_0);
...
defineSeed(1168, 385, makeCastMap([Q$HasCell, Q$Column]), EcoleView$1_0);
...
defineSeed(1169, 385, makeCastMap([Q$HasCell, Q$Column]), EcoleView$2_0);
...
defineSeed(1170, 359, makeCastMap([Q$HasCell, Q$Column]), EcoleView$3_0);
...
defineSeed(1601, 635, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$6X_0);
