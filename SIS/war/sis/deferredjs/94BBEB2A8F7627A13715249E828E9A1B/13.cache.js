...
defineSeed(889, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(890, 631, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(891, 631, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(892, 631, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(893, 631, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1259, 697, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1260, 359, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(1262, 359, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1580, 635, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1584, 635, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
