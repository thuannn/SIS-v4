...
defineSeed(955, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmPasswordPresenter, Q$FrmPasswordUiHandler]), FrmPasswordPresenter_0);
...
defineSeed(956, 631, makeCastMap([Q$Receiver]), FrmPasswordPresenter$1_0);
...
defineSeed(1346, 697, makeCastMap([Q$IsWidget, Q$FrmPasswordPresenter$MyView]), FrmPasswordView_0);
...
defineSeed(1676, 635, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$2X_0);
...
_.val$password = null;
_.val$userName = null;
var Lcom_lemania_sis_client_presenter_FrmPasswordPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmPasswordPresenter', 955), Lcom_lemania_sis_client_presenter_FrmPasswordPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmPasswordPresenter$1', 956), Lcom_lemania_sis_client_view_FrmPasswordView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmPasswordView', 1346), Lcom_lemania_sis_client_view_FrmPasswordView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmPasswordView_BinderImpl', 1347), Lcom_lemania_sis_client_view_FrmPasswordView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmPasswordView_BinderImpl$Widgets', 1348), Lcom_lemania_sis_client_view_FrmPasswordView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmPasswordView_BinderImpl$Widgets$1', 1349), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$2X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$2X', 1676);
$entry(onLoad)(18);
