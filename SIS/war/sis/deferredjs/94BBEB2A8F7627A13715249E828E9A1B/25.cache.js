...
defineSeed(758, 234, {}, StudentAfterAddEvent_0);
...
defineSeed(1049, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAddPresenter, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(1050, 631, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(1069, 631, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(1074, 705, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1439, 697, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1661, 635, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
