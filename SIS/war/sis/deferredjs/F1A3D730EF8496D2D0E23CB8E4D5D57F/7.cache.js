...
defineSeed(1178, 701, makeCastMap([Q$IsWidget, Q$FrmBrancheListPresenter$MyView]), FrmBrancheListView_0);
...
defineSeed(1179, 362, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$1_0);
...
defineSeed(1181, 362, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$3_0);
...
defineSeed(1183, 362, makeCastMap([Q$HasCell, Q$Column]), FrmBrancheListView$5_0);
...
defineSeed(1535, 639, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$5X_0);
...
defineSeed(1542, 639, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$6X_0);
