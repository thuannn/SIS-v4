...
defineSeed(867, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(868, 619, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(869, 619, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(870, 619, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(871, 619, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1185, 685, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1186, 354, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(1188, 354, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1439, 623, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1443, 623, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
