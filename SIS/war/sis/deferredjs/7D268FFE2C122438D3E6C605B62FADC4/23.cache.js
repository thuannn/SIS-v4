...
defineSeed(743, 230, {}, StudentAfterStatusChangeEvent_0);
...
defineSeed(821, 619, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(831, 711, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(832, 693, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
...
defineSeed(833, 1, {}, FrmBulletinManagementPresenterMyProxyImpl$1$1_0);
...
defineSeed(991, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(992, 619, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(993, 619, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(994, 619, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(995, 619, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(996, 619, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1008, 619, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1014, 693, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1316, 685, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1317, 354, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1319, 354, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1321, 354, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1323, 354, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1421, 623, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1498, 623, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1500, 623, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1513, 623, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$11X_0);
