...
defineSeed(764, 235, {}, StudentAfterAddEvent_0);
...
defineSeed(1055, 698, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAddPresenter, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(1056, 637, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(1075, 637, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(1080, 711, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1445, 703, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1667, 641, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
