...
defineSeed(784, 698, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(785, 637, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(786, 637, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(787, 637, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(788, 637, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(1158, 703, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1159, 363, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1161, 363, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1601, 641, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
