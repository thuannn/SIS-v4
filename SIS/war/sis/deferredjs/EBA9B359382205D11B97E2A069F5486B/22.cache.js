...
defineSeed(760, 238, {}, ProfessorAfterAddEvent_0);
...
defineSeed(1022, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsAddPresenter, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(1023, 635, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(1074, 635, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(1080, 709, {}, UserManagementPresenterMyProxyImpl$2_0);
...
defineSeed(1409, 701, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1410, 1, {}, ProfsAddView_BinderImpl_0);
...
defineSeed(1411, 1, {}, ProfsAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1412, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1413, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1414, 1, makeCastMap([Q$KeyUpHandler, Q$EventHandler]), ProfsAddView_BinderImpl$Widgets$3_0);
...
defineSeed(1415, 1, makeCastMap([Q$KeyUpHandler, Q$EventHandler]), ProfsAddView_BinderImpl$Widgets$4_0);
...
;
defineSeed(1517, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$ProfessorProxy]));
...
defineSeed(1632, 639, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
...
;
_.val$prof = null;
var Lcom_lemania_sis_client_presenter_ProfsAddPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsAddPresenter', 1022), Lcom_lemania_sis_client_presenter_ProfsAddPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ProfsAddPresenter$1', 1023), Lcom_lemania_sis_client_presenter_UserManagementPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenter$5', 1074), Lcom_lemania_sis_client_event_ProfessorAfterAddEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'ProfessorAfterAddEvent', 760), Lcom_lemania_sis_client_presenter_UserManagementPresenterMyProxyImpl$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenterMyProxyImpl$2', 1080), Lcom_lemania_sis_client_presenter_UserManagementPresenterMyProxyImpl$2$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'UserManagementPresenterMyProxyImpl$2$1', 1081), Lcom_lemania_sis_client_view_ProfsAddView_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView', 1409), Lcom_lemania_sis_client_view_ProfsAddView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView_BinderImpl', 1410), Lcom_lemania_sis_client_view_ProfsAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView_BinderImpl$Widgets', 1411), Lcom_lemania_sis_client_view_ProfsAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView_BinderImpl$Widgets$1', 1412), Lcom_lemania_sis_client_view_ProfsAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView_BinderImpl$Widgets$2', 1413), Lcom_lemania_sis_client_view_ProfsAddView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView_BinderImpl$Widgets$3', 1414), Lcom_lemania_sis_client_view_ProfsAddView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'ProfsAddView_BinderImpl$Widgets$4', 1415), Lcom_lemania_sis_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$5X', 1632);
$entry(onLoad)(22);
