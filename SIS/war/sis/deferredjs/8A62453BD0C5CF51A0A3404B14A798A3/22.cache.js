...
defineSeed(756, 234, {}, ProfessorAfterAddEvent_0);
...
defineSeed(1018, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsAddPresenter, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(1019, 631, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(1070, 631, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(1076, 705, {}, UserManagementPresenterMyProxyImpl$2_0);
...
defineSeed(1405, 697, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1628, 635, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
