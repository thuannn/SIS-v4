...
defineSeed(759, 234, {}, StudentAfterStatusChangeEvent_0);
...
defineSeed(843, 631, makeCastMap([Q$Receiver]), FrmBulletinManagementPresenter$15_0);
...
;
defineSeed(853, 723, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentAfterStatusChangeEvent$StudentAfterStatusChangeHandler]));
...
defineSeed(854, 705, {}, FrmBulletinManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1055, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(1056, 631, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(1057, 631, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(1058, 631, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(1059, 631, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(1060, 631, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1072, 631, makeCastMap([Q$Receiver]), UserManagementPresenter$7_0);
...
defineSeed(1078, 705, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1446, 697, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1447, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1449, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1451, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1453, 359, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1562, 635, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1658, 635, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1660, 635, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1674, 635, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
