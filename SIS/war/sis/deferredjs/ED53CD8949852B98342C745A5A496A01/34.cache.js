...
function $addNewUser(this$static, fullName, userName, password, email){
  ...
  newUser = dynamicCast($create_1(rc, Lcom_lemania_sis_shared_user_UserProxy_2_classLit), Q$UserProxy);
...
function $updateUserStatus(this$static, user, active, admin, isProf, isStudent, isParent){
...
;
_.onParentAfterAdd = function onParentAfterAdd_1(event_0){
  $onParentAfterAdd_0(this, event_0);
}
;
...
defineSeed(1110, 729, makeCastMap([Q$Receiver]), UserManagementPresenter$1_0);
...
defineSeed(1111, 729, makeCastMap([Q$Receiver]), UserManagementPresenter$2_0);
...
defineSeed(1112, 729, makeCastMap([Q$Receiver]), UserManagementPresenter$3_0);
...
defineSeed(1115, 729, makeCastMap([Q$Receiver]), UserManagementPresenter$6_0);
...
function $initializeTables_0(this$static){
  var cellActive, cellAdmin, cellParent, cellProf, cellReadOnly, cellStudent, colActive, colAdmin, colFullName, colLastLogin, colParent, colProf, colReadOnly, colStudent, colUserName, passCol;
  ...
  cellParent = new CheckboxCell_0;
  colParent = new UserManagementView$13_0(cellParent);
  $addColumn(this$static.tblUser, colParent, 'Parent');
  $setColumnWidth_0(this$static.tblUser, colParent, '5%');
  $setFieldUpdater(colParent, new UserManagementView$14_0(this$static));
  colLastLogin = new UserManagementView$15_0;
...
defineSeed(1130, 803, makeCastMap([Q$IsWidget, Q$UserManagementPresenter$MyView, Q$UserManagementView]), UserManagementView_0);
...
defineSeed(1131, 472, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$1_0);
...
function $update_15(this$static, index, user, value){
  if (this$static.this$0.uiHandlers) {
    ...
    $updateUserStatus(dynamicCast(this$static.this$0.uiHandlers, Q$UserManagementUiHandler), user, user.getActive(), user.getAdmin(), value, user.getIsStudent(), user.getIsParent());
  }
}
...
defineSeed(1132, 1, {}, UserManagementView$10_0);
...
defineSeed(1133, 427, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$11_0);
...
function $update_16(this$static, index, user, value){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedUserIndex = index;
    $updateUserStatus(dynamicCast(this$static.this$0.uiHandlers, Q$UserManagementUiHandler), user, user.getActive(), user.getAdmin(), user.getIsProf(), value, user.getIsParent());
  }
}
...
defineSeed(1134, 1, {}, UserManagementView$12_0);
...
;
_.this$0 = null;
function UserManagementView$13_0($anonymous0){
  this.cell = $anonymous0;
}

defineSeed(1135, 427, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$13_0);
_.getValue = function getValue_32(user){
  return dynamicCast(user, Q$UserProxy).getIsParent();
}
;
function $update_17(this$static, index, user, value){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedUserIndex = index;
    $updateUserStatus(dynamicCast(this$static.this$0.uiHandlers, Q$UserManagementUiHandler), user, user.getActive(), user.getAdmin(), user.getIsProf(), user.getIsStudent(), value);
  }
}

function UserManagementView$14_0(this$0){
  this.this$0 = this$0;
}

defineSeed(1136, 1, {}, UserManagementView$14_0);
...
;
_.this$0 = null;
function UserManagementView$15_0(){
  TextColumn_0.call(this);
}

defineSeed(1137, 472, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$15_0);
...
defineSeed(1138, 472, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$2_0);
...
defineSeed(1139, 472, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$3_0);
...
defineSeed(1140, 427, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$4_0);
...
function $update_18(this$static, index, user, value){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedUserIndex = index;
    $updateUserStatus(dynamicCast(this$static.this$0.uiHandlers, Q$UserManagementUiHandler), user, value, user.getAdmin(), user.getIsProf(), user.getIsStudent(), user.getIsParent());
  }
}
...
defineSeed(1141, 1, {}, UserManagementView$5_0);
...
defineSeed(1142, 427, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$6_0);
...
function $update_19(this$static, index, user, value){
  if (this$static.this$0.uiHandlers) {
    this$static.this$0.selectedUserIndex = index;
    $updateUserStatus(dynamicCast(this$static.this$0.uiHandlers, Q$UserManagementUiHandler), user, user.getActive(), value, user.getIsProf(), user.getIsStudent(), user.getIsParent());
  }
}
...
defineSeed(1143, 1, {}, UserManagementView$7_0);
...
defineSeed(1144, 427, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$8_0);
...
defineSeed(1145, 427, makeCastMap([Q$HasCell, Q$Column]), UserManagementView$9_0);
_.getValue = function getValue_39(user){
...
defineSeed(1146, 1, {}, UserManagementView_BinderImpl_0);
...
defineSeed(1147, 1, {}, UserManagementView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1148, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), UserManagementView_BinderImpl$Widgets$1_0);
...
defineSeed(1149, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), UserManagementView_BinderImpl$Widgets$2_0);
...
defineSeed(2049, 733, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$6X_0);
_.makeRequestData = function makeRequestData_102(){
  return new RequestData_0('V17C$hSQSiPyzHIpcxYB0C$KXDE=', initValues(_3Ljava_lang_Object_2_classLit, makeCastMap([Q$Serializable, Q$Object_$1]), Q$Object, []), this.propertyRefs, Ljava_util_List_2_classLit, Lcom_lemania_sis_shared_user_UserProxy_2_classLit);
}
;
...
defineSeed(2050, 733, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$8X_0);
_.makeRequestData = function makeRequestData_103(){
  return new RequestData_0('YOfldPTRYTQXfTdMPbZpDEqSEG8=', initValues(_3Ljava_lang_Object_2_classLit, makeCastMap([Q$Serializable, Q$Object_$1]), Q$Object, [this.val$type]), this.propertyRefs, Ljava_util_List_2_classLit, Lcom_lemania_sis_shared_user_UserProxy_2_classLit);
}
;
_.val$type = null;
var Lcom_lemania_sis_client_form_usermgt_UserManagementPresenter_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementPresenter', 1109), Lcom_lemania_sis_client_form_usermgt_UserManagementPresenter$1_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementPresenter$1', 1110), Lcom_lemania_sis_client_form_usermgt_UserManagementPresenter$2_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementPresenter$2', 1111), Lcom_lemania_sis_client_form_usermgt_UserManagementPresenter$3_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementPresenter$3', 1112), Lcom_lemania_sis_client_form_usermgt_UserManagementPresenter$6_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementPresenter$6', 1115), Lcom_lemania_sis_client_form_usermgt_UserManagementView_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView', 1130), Lcom_lemania_sis_client_form_usermgt_UserManagementView$1_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$1', 1131), Lcom_lemania_sis_client_form_usermgt_UserManagementView$2_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$2', 1138), Lcom_lemania_sis_client_form_usermgt_UserManagementView$3_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$3', 1139), Lcom_lemania_sis_client_form_usermgt_UserManagementView$4_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$4', 1140), Lcom_lemania_sis_client_form_usermgt_UserManagementView$5_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$5', 1141), Lcom_lemania_sis_client_form_usermgt_UserManagementView$6_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$6', 1142), Lcom_lemania_sis_client_form_usermgt_UserManagementView$7_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$7', 1143), Lcom_lemania_sis_client_form_usermgt_UserManagementView$8_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$8', 1144), Lcom_lemania_sis_client_form_usermgt_UserManagementView$9_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$9', 1145), Lcom_lemania_sis_client_form_usermgt_UserManagementView$10_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$10', 1132), Lcom_lemania_sis_client_form_usermgt_UserManagementView$11_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$11', 1133), Lcom_lemania_sis_client_form_usermgt_UserManagementView$12_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$12', 1134), Lcom_lemania_sis_client_form_usermgt_UserManagementView$13_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$13', 1135), Lcom_lemania_sis_client_form_usermgt_UserManagementView$14_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$14', 1136), Lcom_lemania_sis_client_form_usermgt_UserManagementView$15_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView$15', 1137), Lcom_lemania_sis_client_form_usermgt_UserManagementView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView_BinderImpl', 1146), Lcom_lemania_sis_client_form_usermgt_UserManagementView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView_BinderImpl$Widgets', 1147), Lcom_lemania_sis_client_form_usermgt_UserManagementView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView_BinderImpl$Widgets$1', 1148), Lcom_lemania_sis_client_form_usermgt_UserManagementView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.form.usermgt.', 'UserManagementView_BinderImpl$Widgets$2', 1149), Lcom_lemania_sis_shared_user_UserRequestFactory_1UserRequestContextImpl$6X_2_classLit = createForClass('com.lemania.sis.shared.user.', 'UserRequestFactory_UserRequestContextImpl$6X', 2049), Lcom_lemania_sis_shared_user_UserRequestFactory_1UserRequestContextImpl$8X_2_classLit = createForClass('com.lemania.sis.shared.user.', 'UserRequestFactory_UserRequestContextImpl$8X', 2050);
$entry(onLoad)(34);
