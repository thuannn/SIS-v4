...
defineSeed(885, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(886, 628, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(887, 628, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(888, 628, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(903, 702, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1198, 694, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1472, 632, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
