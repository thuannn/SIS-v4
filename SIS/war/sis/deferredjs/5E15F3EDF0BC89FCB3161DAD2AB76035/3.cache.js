...
defineSeed(1042, 694, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1043, 360, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(1045, 360, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1412, 632, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
