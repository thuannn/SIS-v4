...
defineSeed(840, 660, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(841, 599, makeCastMap([Q$Receiver]), StudentPresenter$1_0);
...
defineSeed(842, 599, makeCastMap([Q$Receiver]), StudentPresenter$2_0);
...
defineSeed(843, 599, makeCastMap([Q$Receiver]), StudentPresenter$3_0);
...
defineSeed(844, 599, makeCastMap([Q$Receiver]), StudentPresenter$4_0);
...
defineSeed(845, 599, makeCastMap([Q$Receiver]), StudentPresenter$5_0);
...
defineSeed(1065, 665, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1066, 344, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1067, 1, {}, StudentView$2_0);
...
defineSeed(1068, 344, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1069, 1, {}, StudentView$4_0);
...
defineSeed(1070, 344, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1071, 1, {}, StudentView$6_0);
...
defineSeed(1072, 344, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1073, 1, {}, StudentView$8_0);
...
defineSeed(1074, 1, {}, StudentView_BinderImpl_0);
...
defineSeed(1075, 1, {}, StudentView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1119, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
;
defineSeed(1120, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$StudentProxy]));
...
defineSeed(1178, 603, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1179, 603, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$4X_0);
...
var Lcom_lemania_sis_client_presenter_StudentPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentPresenter', 840), Lcom_lemania_sis_client_presenter_StudentPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentPresenter$1', 841), Lcom_lemania_sis_client_presenter_StudentPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentPresenter$2', 842), Lcom_lemania_sis_client_presenter_StudentPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentPresenter$3', 843), Lcom_lemania_sis_client_presenter_StudentPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentPresenter$4', 844), Lcom_lemania_sis_client_presenter_StudentPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'StudentPresenter$5', 845), Lcom_lemania_sis_client_view_StudentView_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView', 1065), Lcom_lemania_sis_client_view_StudentView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$1', 1066), Lcom_lemania_sis_client_view_StudentView$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$2', 1067), Lcom_lemania_sis_client_view_StudentView$3_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$3', 1068), Lcom_lemania_sis_client_view_StudentView$4_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$4', 1069), Lcom_lemania_sis_client_view_StudentView$5_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$5', 1070), Lcom_lemania_sis_client_view_StudentView$6_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$6', 1071), Lcom_lemania_sis_client_view_StudentView$7_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$7', 1072), Lcom_lemania_sis_client_view_StudentView$8_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView$8', 1073), Lcom_lemania_sis_client_view_StudentView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView_BinderImpl', 1074), Lcom_lemania_sis_client_view_StudentView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'StudentView_BinderImpl$Widgets', 1075), Lcom_lemania_sis_shared_service_StudentRequestFactory_1StudentRequestContextImpl$1X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'StudentRequestFactory_StudentRequestContextImpl$1X', 1178), Lcom_lemania_sis_shared_service_StudentRequestFactory_1StudentRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'StudentRequestFactory_StudentRequestContextImpl$4X', 1179);
$entry(onLoad)(18);
