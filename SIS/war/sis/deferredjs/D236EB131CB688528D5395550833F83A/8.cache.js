...
defineSeed(1188, 701, makeCastMap([Q$IsWidget, Q$FrmBulletinCreationPresenter$MyView]), FrmBulletinCreationView_0);
...
defineSeed(1189, 388, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$1_0);
...
defineSeed(1190, 388, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$2_0);
...
defineSeed(1191, 388, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$3_0);
...
defineSeed(1192, 362, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$4_0);
...
defineSeed(1193, 1, {}, FrmBulletinCreationView$5_0);
...
defineSeed(1194, 388, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$6_0);
...
defineSeed(1195, 388, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$7_0);
...
defineSeed(1196, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinCreationView$8_0);
...
defineSeed(1553, 639, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$1X_0);
...
defineSeed(1556, 639, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$7X_0);
...
defineSeed(1558, 639, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$9X_0);
...
defineSeed(1648, 639, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$3X_0);
