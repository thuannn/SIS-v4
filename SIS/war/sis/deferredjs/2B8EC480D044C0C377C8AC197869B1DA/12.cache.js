...
defineSeed(801, 673, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(802, 612, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(803, 612, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(992, 678, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1175, 616, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
