...
defineSeed(757, 673, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$EcoleAddedEvent$EcoleAddedHandler, Q$EcolePresenter, Q$EcoleListUiHandler]), EcolePresenter_0);
...
defineSeed(758, 612, makeCastMap([Q$Receiver]), EcolePresenter$1_0);
...
defineSeed(759, 612, makeCastMap([Q$Receiver]), EcolePresenter$2_0);
...
defineSeed(930, 678, makeCastMap([Q$IsWidget, Q$EcolePresenter$MyView]), EcoleView_0);
...
defineSeed(931, 377, makeCastMap([Q$HasCell, Q$Column]), EcoleView$1_0);
...
defineSeed(932, 377, makeCastMap([Q$HasCell, Q$Column]), EcoleView$2_0);
...
defineSeed(933, 351, makeCastMap([Q$HasCell, Q$Column]), EcoleView$3_0);
...
defineSeed(1145, 616, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$6X_0);
