...
defineSeed(764, 673, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$FrmBrancheAddUiHandler]), FrmBrancheAddPresenter_0);
...
defineSeed(765, 612, makeCastMap([Q$Receiver]), FrmBrancheAddPresenter$1_0);
...
defineSeed(938, 678, makeCastMap([Q$IsWidget, Q$FrmBrancheAddPresenter$MyView]), FrmBrancheAddView_0);
...
defineSeed(939, 10, makeCastMap([Q$Timer]), FrmBrancheAddView$1_0);
...
defineSeed(1126, 616, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$4X_0);
