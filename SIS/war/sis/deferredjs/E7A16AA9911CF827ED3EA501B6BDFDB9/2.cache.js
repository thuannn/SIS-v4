...
defineSeed(784, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$CoursAddPresenter, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(785, 644, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(786, 644, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(796, 736, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CoursAddedEvent$CoursAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(797, 718, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(1159, 710, makeCastMap([Q$IsWidget, Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(1160, 1, {}, CoursAddView_BinderImpl_0);
...
defineSeed(1161, 1, {}, CoursAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1162, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1163, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1607, 648, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
...
_.val$cours = null;
_.val$ecoleId = null;
var Lcom_lemania_sis_client_presenter_CoursAddPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursAddPresenter', 784), Lcom_lemania_sis_client_presenter_CoursAddPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursAddPresenter$1', 785), Lcom_lemania_sis_client_presenter_CoursAddPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursAddPresenter$2', 786), Lcom_lemania_sis_client_event_CoursAddedEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'CoursAddedEvent', 762), Lcom_lemania_sis_client_presenter_CoursPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursPresenterMyProxyImpl$1', 797), Lcom_lemania_sis_client_presenter_CoursPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'CoursPresenterMyProxyImpl$1$1', 798), Lcom_lemania_sis_client_view_CoursAddView_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView', 1159), Lcom_lemania_sis_client_view_CoursAddView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView_BinderImpl', 1160), Lcom_lemania_sis_client_view_CoursAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView_BinderImpl$Widgets', 1161), Lcom_lemania_sis_client_view_CoursAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView_BinderImpl$Widgets$1', 1162), Lcom_lemania_sis_client_view_CoursAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'CoursAddView_BinderImpl$Widgets$2', 1163), Lcom_lemania_sis_shared_service_CoursRequestFactory_1CoursRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$7X', 1607);
$entry(onLoad)(2);
