...
defineSeed(931, 689, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(932, 628, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(933, 628, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(934, 628, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(935, 628, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(936, 628, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(937, 628, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(938, 628, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(939, 628, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(940, 628, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1246, 694, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1247, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1248, 359, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1251, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1252, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1253, 385, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1254, 359, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1357, 632, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1358, 632, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1359, 632, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1428, 632, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
