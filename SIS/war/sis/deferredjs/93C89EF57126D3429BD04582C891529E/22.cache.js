...
defineSeed(953, 689, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$StudentAddUiHandler]), StudentAddPresenter_0);
...
defineSeed(954, 628, makeCastMap([Q$Receiver]), StudentAddPresenter$1_0);
...
defineSeed(969, 628, makeCastMap([Q$Receiver]), UserManagementPresenter$4_0);
...
defineSeed(974, 702, {}, UserManagementPresenterMyProxyImpl$1_0);
...
defineSeed(1269, 694, makeCastMap([Q$IsWidget, Q$StudentAddPresenter$MyView]), StudentAddView_0);
...
defineSeed(1460, 632, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$8X_0);
