...
defineSeed(927, 691, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(928, 630, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(970, 630, makeCastMap([Q$Receiver]), UserManagementPresenter$5_0);
...
defineSeed(976, 704, {}, UserManagementPresenterMyProxyImpl$2_0);
...
defineSeed(1238, 696, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView]), ProfsAddView_0);
...
defineSeed(1428, 634, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
