...
defineSeed(860, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmMarkInputPresenter, Q$FrmMarkInputUiHandler]), FrmMarkInputPresenter_0);
...
defineSeed(861, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$1_0);
...
defineSeed(862, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$2_0);
...
defineSeed(863, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$3_0);
...
defineSeed(864, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$4_0);
...
defineSeed(865, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$5_0);
...
defineSeed(866, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$6_0);
...
defineSeed(867, 630, makeCastMap([Q$Receiver]), FrmMarkInputPresenter$7_0);
...
defineSeed(1157, 696, makeCastMap([Q$IsWidget, Q$FrmMarkInputPresenter$MyView]), FrmMarkInputView_0);
...
defineSeed(1360, 634, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$5X_0);
...
defineSeed(1392, 634, makeCastMap([Q$AbstractRequest]), BulletinSubjectRequestFactory_BulletinSubjectRequestContextImpl$6X_0);
...
defineSeed(1426, 634, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$1X_0);
