...
defineSeed(933, 698, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmPasswordPresenter, Q$FrmPasswordUiHandler]), FrmPasswordPresenter_0);
...
defineSeed(934, 637, makeCastMap([Q$Receiver]), FrmPasswordPresenter$1_0);
_.onFailure_0 = function onFailure_76(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_76(response){
  $onSuccess_73(this, dynamicCast(response, Q$UserProxy));
}
;
_.this$0 = null;
...
defineSeed(1295, 703, makeCastMap([Q$IsWidget, Q$FrmPasswordPresenter$MyView]), FrmPasswordView_0);
...
defineSeed(1296, 1, {}, FrmPasswordView_BinderImpl_0);
...
defineSeed(1297, 1, {}, FrmPasswordView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1298, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmPasswordView_BinderImpl$Widgets$1_0);
...
defineSeed(1612, 641, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$2X_0);
...
_.val$password = null;
_.val$userName = null;
var Lcom_lemania_sis_client_presenter_FrmPasswordPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmPasswordPresenter', 933), Lcom_lemania_sis_client_presenter_FrmPasswordPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmPasswordPresenter$1', 934), Lcom_lemania_sis_client_view_FrmPasswordView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmPasswordView', 1295), Lcom_lemania_sis_client_view_FrmPasswordView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmPasswordView_BinderImpl', 1296), Lcom_lemania_sis_client_view_FrmPasswordView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmPasswordView_BinderImpl$Widgets', 1297), Lcom_lemania_sis_client_view_FrmPasswordView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmPasswordView_BinderImpl$Widgets$1', 1298), Lcom_lemania_sis_shared_service_UserRequestFactory_1UserRequestContextImpl$2X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'UserRequestFactory_UserRequestContextImpl$2X', 1612);
$entry(onLoad)(17);
