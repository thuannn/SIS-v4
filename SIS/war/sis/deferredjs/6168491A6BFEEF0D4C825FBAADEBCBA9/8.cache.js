...
defineSeed(1187, 697, makeCastMap([Q$IsWidget, Q$FrmBulletinCreationPresenter$MyView]), FrmBulletinCreationView_0);
...
defineSeed(1188, 385, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$1_0);
...
defineSeed(1189, 385, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$2_0);
...
defineSeed(1190, 385, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$3_0);
...
defineSeed(1191, 359, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$4_0);
...
defineSeed(1193, 385, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$6_0);
...
defineSeed(1194, 385, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$7_0);
...
defineSeed(1195, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinCreationView$8_0);
...
defineSeed(1196, 1, {}, FrmBulletinCreationView_BinderImpl_0);
...
defineSeed(1197, 1, {}, FrmBulletinCreationView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1198, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$1_0);
...
defineSeed(1199, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$2_0);
...
defineSeed(1200, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$3_0);
...
defineSeed(1201, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$4_0);
...
defineSeed(1554, 635, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$1X_0);
...
defineSeed(1557, 635, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$7X_0);
...
defineSeed(1559, 635, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$9X_0);
...
defineSeed(1650, 635, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$3X_0);
