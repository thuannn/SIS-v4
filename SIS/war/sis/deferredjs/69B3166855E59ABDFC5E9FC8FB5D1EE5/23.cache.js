...
defineSeed(1317, 685, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1318, 354, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1319, 1, {}, StudentView$2_0);
...
defineSeed(1320, 354, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1321, 1, {}, StudentView$4_0);
...
defineSeed(1322, 354, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1323, 1, {}, StudentView$6_0);
...
defineSeed(1324, 354, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1325, 1, {}, StudentView$8_0);
...
defineSeed(1326, 1, {}, StudentView_BinderImpl_0);
...
defineSeed(1327, 1, {}, StudentView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1422, 623, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1499, 623, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1501, 623, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1514, 623, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$11X_0);
