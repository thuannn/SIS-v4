...
defineSeed(974, 698, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(975, 637, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(976, 637, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(977, 637, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(994, 711, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(1363, 703, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1670, 641, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
