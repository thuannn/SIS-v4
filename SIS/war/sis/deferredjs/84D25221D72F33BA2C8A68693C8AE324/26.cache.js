...
defineSeed(1055, 698, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$StudentPresenter, Q$StudentListUiHandler]), StudentPresenter_0);
...
defineSeed(1078, 711, {}, UserManagementPresenterMyProxyImpl$3_0);
...
defineSeed(1442, 703, makeCastMap([Q$IsWidget, Q$StudentPresenter$MyView]), StudentView_0);
...
defineSeed(1443, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$1_0);
...
defineSeed(1445, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$3_0);
...
defineSeed(1447, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$5_0);
...
defineSeed(1449, 363, makeCastMap([Q$HasCell, Q$Column]), StudentView$7_0);
...
defineSeed(1557, 641, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$13X_0);
...
defineSeed(1653, 641, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$1X_0);
...
defineSeed(1655, 641, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$7X_0);
...
defineSeed(1669, 641, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$12X_0);
