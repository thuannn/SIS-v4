...
defineSeed(747, 232, {}, DrawSchoolInterfaceEvent_0);
...
;
defineSeed(864, 722, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(865, 704, {}, FrmBulletinViewSummaryPresenterMyProxyImpl$1_0);
...
defineSeed(921, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(922, 630, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(923, 630, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(924, 630, makeCastMap([Q$Receiver]), HomePresenter$3_0);
...
defineSeed(941, 704, {}, MainPagePresenterMyProxyImpl$5_0);
...
defineSeed(942, 1, {}, MainPagePresenterMyProxyImpl$5$1_0);
...
defineSeed(1249, 696, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1525, 634, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$1X_0);
