...
defineSeed(799, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBrancheAddPresenter, Q$FrmBrancheAddUiHandler]), FrmBrancheAddPresenter_0);
...
defineSeed(800, 630, makeCastMap([Q$Receiver]), FrmBrancheAddPresenter$1_0);
...
defineSeed(1116, 696, makeCastMap([Q$IsWidget, Q$FrmBrancheAddPresenter$MyView]), FrmBrancheAddView_0);
...
defineSeed(1418, 634, makeCastMap([Q$AbstractRequest]), BrancheRequestFactory_BrancheRequestContextImpl$4X_0);
...
;
_.val$branche = null;
var Lcom_lemania_sis_client_presenter_FrmBrancheAddPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheAddPresenter', 799), Lcom_lemania_sis_client_presenter_FrmBrancheAddPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBrancheAddPresenter$1', 800), Lcom_lemania_sis_client_view_FrmBrancheAddView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView', 1116), Lcom_lemania_sis_client_view_FrmBrancheAddView$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView$1', 1117), Lcom_lemania_sis_client_view_FrmBrancheAddView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView_BinderImpl', 1118), Lcom_lemania_sis_client_view_FrmBrancheAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets', 1119), Lcom_lemania_sis_client_view_FrmBrancheAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBrancheAddView_BinderImpl$Widgets$1', 1120), Lcom_lemania_sis_shared_service_BrancheRequestFactory_1BrancheRequestContextImpl$4X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BrancheRequestFactory_BrancheRequestContextImpl$4X', 1418);
$entry(onLoad)(6);
