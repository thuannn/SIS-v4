...
defineSeed(882, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseAddPresenter, Q$FrmClasseAddUiHandler]), FrmClasseAddPresenter_0);
...
defineSeed(883, 635, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$1_0);
...
defineSeed(884, 635, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$2_0);
...
defineSeed(885, 635, makeCastMap([Q$Receiver]), FrmClasseAddPresenter$3_0);
...
defineSeed(1252, 701, makeCastMap([Q$IsWidget, Q$FrmClasseAddPresenter$MyView]), FrmClasseAddView_0);
...
defineSeed(1583, 639, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$8X_0);
