...
defineSeed(1025, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(1026, 635, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(1027, 635, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(1028, 635, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(1029, 635, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(1030, 635, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(1031, 635, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(1032, 635, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(1033, 635, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(1034, 635, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1413, 701, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1414, 388, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1415, 362, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1418, 388, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1419, 388, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1420, 388, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1421, 362, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1537, 639, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1538, 639, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1539, 639, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1629, 639, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
