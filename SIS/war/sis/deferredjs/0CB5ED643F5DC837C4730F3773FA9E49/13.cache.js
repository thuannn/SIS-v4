...
defineSeed(890, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmClasseListPresenter, Q$FrmClasseListUiHandler]), FrmClasseListPresenter_0);
...
defineSeed(891, 635, makeCastMap([Q$Receiver]), FrmClasseListPresenter$1_0);
...
defineSeed(892, 635, makeCastMap([Q$Receiver]), FrmClasseListPresenter$2_0);
...
defineSeed(893, 635, makeCastMap([Q$Receiver]), FrmClasseListPresenter$3_0);
...
defineSeed(894, 635, makeCastMap([Q$Receiver]), FrmClasseListPresenter$4_0);
...
defineSeed(1259, 701, makeCastMap([Q$IsWidget, Q$FrmClasseListPresenter$MyView]), FrmClasseListView_0);
...
defineSeed(1260, 362, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$1_0);
...
defineSeed(1262, 362, makeCastMap([Q$HasCell, Q$Column]), FrmClasseListView$3_0);
...
defineSeed(1580, 639, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$3X_0);
...
defineSeed(1584, 639, makeCastMap([Q$AbstractRequest]), ClasseRequestFactory_ClasseRequestContextImpl$9X_0);
