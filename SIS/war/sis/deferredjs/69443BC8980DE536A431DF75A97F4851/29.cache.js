...
defineSeed(796, 725, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoadNonAttribuedStudentEvent$LoadNonAttribuedStudentHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinCreationPresenter, Q$FrmBulletinCreationUiHandler]), FrmBulletinCreationPresenter_0);
...
defineSeed(797, 664, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$1_0);
...
defineSeed(798, 664, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$2_0);
...
defineSeed(799, 664, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$3_0);
...
defineSeed(800, 664, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$4_0);
...
defineSeed(801, 664, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$5_0);
...
defineSeed(802, 664, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$6_0);
...
defineSeed(803, 664, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$7_0);
...
defineSeed(804, 664, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$8_0);
...
defineSeed(805, 664, makeCastMap([Q$Receiver]), FrmBulletinCreationPresenter$9_0);
...
;
_.this$0 = null;
defineSeed(806, 756, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LoadNonAttribuedStudentEvent$LoadNonAttribuedStudentHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(809, 738, {}, FrmBulletinCreationPresenterMyProxyImpl$2_0);
...
defineSeed(810, 1, {}, FrmBulletinCreationPresenterMyProxyImpl$2$1_0);
...
defineSeed(812, 730, makeCastMap([Q$IsWidget, Q$FrmBulletinCreationPresenter$MyView]), FrmBulletinCreationView_0);
...
defineSeed(813, 409, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$1_0);
...
defineSeed(814, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), FrmBulletinCreationView$10_0);
...
defineSeed(815, 409, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$2_0);
...
defineSeed(816, 409, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$3_0);
...
defineSeed(817, 382, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$4_0);
...
defineSeed(818, 1, {}, FrmBulletinCreationView$5_0);
...
defineSeed(819, 382, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$6_0);
...
defineSeed(820, 1, {}, FrmBulletinCreationView$7_0);
...
defineSeed(821, 409, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$8_0);
...
defineSeed(822, 409, makeCastMap([Q$HasCell, Q$Column]), FrmBulletinCreationView$9_0);
...
defineSeed(823, 1, {}, FrmBulletinCreationView_BinderImpl_0);
function $build_f_HTMLPanel1(this$static){
  var attachRecord28, f_HTMLPanel1, f_VerticalPanel2, f_Label3, f_HorizontalPanel4, f_VerticalPanel5, f_VerticalPanel8, f_VerticalPanel17, f_Label6, tblStudents, f_Label7, f_Label9, f_Grid10, f_Label11, lstYear, f_Label12, lstEcoles, f_Label13, lstProgrammes, f_Label14, lstClasses, f_Label15, lstProfiles, f_Label16, lblSelectedStudentName, cmdCreateBulletin, f_Label18, f_HorizontalPanel19, f_Label20, lstIsFinished, tblBulletins, f_Label21;
...
defineSeed(824, 1, {}, FrmBulletinCreationView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(825, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$1_0);
...
defineSeed(826, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$2_0);
...
defineSeed(827, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$3_0);
...
defineSeed(828, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$4_0);
...
defineSeed(829, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$5_0);
...
defineSeed(830, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinCreationView_BinderImpl$Widgets$6_0);
...
defineSeed(834, 1, makeCastMap([Q$RunAsyncCallback]));
...
;
defineSeed(1604, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$BulletinProxy]));
...
defineSeed(1702, 668, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$11X_0);
...
defineSeed(1705, 668, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$1X_0);
...
defineSeed(1708, 668, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$7X_0);
...
defineSeed(1710, 668, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$9X_0);
...
defineSeed(1801, 668, makeCastMap([Q$AbstractRequest]), StudentRequestFactory_StudentRequestContextImpl$3X_0);
...
;
var Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationPresenter_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationPresenter', 796), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationPresenter$1_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationPresenter$1', 797), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationPresenter$2_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationPresenter$2', 798), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationPresenter$3_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationPresenter$3', 799), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationPresenter$4_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationPresenter$4', 800), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationPresenter$5_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationPresenter$5', 801), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationPresenter$6_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationPresenter$6', 802), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationPresenter$7_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationPresenter$7', 803), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationPresenter$8_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationPresenter$8', 804), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationPresenter$9_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationPresenter$9', 805), Lcom_lemania_sis_client_event_LoadNonAttribuedStudentEvent_2_classLit = createForClass('com.lemania.sis.client.event.', 'LoadNonAttribuedStudentEvent', 788), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationPresenterMyProxyImpl$2_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationPresenterMyProxyImpl$2', 809), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationPresenterMyProxyImpl$2$1_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationPresenterMyProxyImpl$2$1', 810), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView', 812), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView$1_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView$1', 813), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView$2_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView$2', 815), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView$3_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView$3', 816), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView$4_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView$4', 817), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView$5_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView$5', 818), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView$6_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView$6', 819), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView$7_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView$7', 820), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView$8_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView$8', 821), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView$9_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView$9', 822), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView$10_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView$10', 814), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView_BinderImpl', 823), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView_BinderImpl$Widgets', 824), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView_BinderImpl$Widgets$1', 825), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView_BinderImpl$Widgets$2', 826), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView_BinderImpl$Widgets$3', 827), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView_BinderImpl$Widgets$4', 828), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView_BinderImpl$Widgets$5', 829), Lcom_lemania_sis_client_form_bulletincreation_FrmBulletinCreationView_1BinderImpl$Widgets$6_2_classLit = createForClass('com.lemania.sis.client.form.bulletincreation.', 'FrmBulletinCreationView_BinderImpl$Widgets$6', 830), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$1X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$1X', 1705), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$7X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$7X', 1708), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$9X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$9X', 1710), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$11X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$11X', 1702), Lcom_lemania_sis_shared_service_StudentRequestFactory_1StudentRequestContextImpl$3X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'StudentRequestFactory_StudentRequestContextImpl$3X', 1801);
$entry(onLoad)(29);
