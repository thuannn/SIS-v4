...
defineSeed(1010, 725, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinViewDetailPresenter, Q$FrmBulletinViewDetailUiHandler]), FrmBulletinViewDetailPresenter_0);
...
defineSeed(1011, 664, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$1_0);
...
defineSeed(1012, 664, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$2_0);
...
defineSeed(1013, 664, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$3_0);
...
defineSeed(1014, 664, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$4_0);
...
defineSeed(1015, 664, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$5_0);
...
defineSeed(1016, 664, makeCastMap([Q$Receiver]), FrmBulletinViewDetailPresenter$6_0);
_.onFailure_0 = function onFailure_64(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_64(response){
  $onSuccess_57(this, dynamicCast(response, Q$BulletinProxy));
}
;
_.this$0 = null;
_.val$branches = null;
...
defineSeed(1276, 1, makeCastMap([Q$RunAsyncCallback]));
...
function FrmBulletinViewDetailView_0(){
  this.widget = $build_f_HTMLPanel1_11(new FrmBulletinViewDetailView_BinderImpl$Widgets_0(this));
}

defineSeed(1352, 730, makeCastMap([Q$IsWidget, Q$FrmBulletinViewDetailPresenter$MyView]), FrmBulletinViewDetailView_0);
...
defineSeed(1353, 1, {}, FrmBulletinViewDetailView_BinderImpl_0);
...
defineSeed(1354, 1, {}, FrmBulletinViewDetailView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1355, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewDetailView_BinderImpl$Widgets$1_0);
...
defineSeed(1356, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewDetailView_BinderImpl$Widgets$2_0);
...
defineSeed(1695, 668, makeCastMap([Q$AbstractRequest]), BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X_0);
...
defineSeed(1706, 668, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$2X_0);
...
defineSeed(1709, 668, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$8X_0);
...
;
_.val$email = null;
var Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter', 1010), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$1', 1011), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$2_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$2', 1012), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$3_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$3', 1013), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$4_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$4', 1014), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$5_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$5', 1015), Lcom_lemania_sis_client_presenter_FrmBulletinViewDetailPresenter$6_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'FrmBulletinViewDetailPresenter$6', 1016), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView', 1352), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl', 1353), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets', 1354), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets$1', 1355), Lcom_lemania_sis_client_view_FrmBulletinViewDetailView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.sis.client.view.', 'FrmBulletinViewDetailView_BinderImpl$Widgets$2', 1356), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$2X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$2X', 1706), Lcom_lemania_sis_shared_service_BulletinRequestFactory_1BulletinRequestContextImpl$8X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinRequestFactory_BulletinRequestContextImpl$8X', 1709), Lcom_lemania_sis_shared_service_BulletinBrancheRequestFactory_1BulletinBrancheRequestContextImpl$5X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'BulletinBrancheRequestFactory_BulletinBrancheRequestContextImpl$5X', 1695);
$entry(onLoad)(10);
