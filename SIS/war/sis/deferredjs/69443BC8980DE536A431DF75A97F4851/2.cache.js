...
defineSeed(932, 725, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ContactPresenter, Q$ContactUiHandler]), ContactPresenter_0);
...
defineSeed(933, 664, makeCastMap([Q$Receiver]), ContactPresenter$1_0);
...
defineSeed(1277, 730, makeCastMap([Q$IsWidget, Q$ContactPresenter$MyView]), ContactView_0);
...
defineSeed(1728, 659, {}, ContactRequestFactoryImpl_0);
...
defineSeed(1729, 669, makeCastMap([Q$AbstractRequestContext]), ContactRequestFactory_ContactRequestContextImpl_0);
...
defineSeed(1730, 668, makeCastMap([Q$AbstractRequest]), ContactRequestFactory_ContactRequestContextImpl$1X_0);
...
defineSeed(1731, 597, makeCastMap([Q$EnumMap]), ContactRequestFactory_ContactRequestContextImpl_FactoryImpl_0);
...
;
var Lcom_lemania_sis_client_presenter_ContactPresenter_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ContactPresenter', 932), Lcom_lemania_sis_client_presenter_ContactPresenter$1_2_classLit = createForClass('com.lemania.sis.client.presenter.', 'ContactPresenter$1', 933), Lcom_lemania_sis_client_view_ContactView_2_classLit = createForClass('com.lemania.sis.client.view.', 'ContactView', 1277), Lcom_lemania_sis_client_view_ContactView_1BinderImpl_2_classLit = createForClass('com.lemania.sis.client.view.', 'ContactView_BinderImpl', 1278), Lcom_lemania_sis_client_view_ContactView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.sis.client.view.', 'ContactView_BinderImpl$Widgets', 1279), Lcom_lemania_sis_client_view_ContactView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.sis.client.view.', 'ContactView_BinderImpl$Widgets$1', 1280), Lcom_lemania_sis_shared_service_ContactRequestFactoryImpl_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ContactRequestFactoryImpl', 1728), Lcom_lemania_sis_shared_service_ContactRequestFactory_1ContactRequestContextImpl_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl', 1729), Lcom_lemania_sis_shared_service_ContactRequestFactory_1ContactRequestContextImpl$1X_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl$1X', 1730), Lcom_lemania_sis_shared_service_ContactRequestFactory_1ContactRequestContextImpl_1FactoryImpl_2_classLit = createForClass('com.lemania.sis.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl_FactoryImpl', 1731);
$entry(onLoad)(2);
