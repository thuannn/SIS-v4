...
defineSeed(799, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$EcoleAddedEvent$EcoleAddedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$EcolePresenter, Q$EcoleListUiHandler]), EcolePresenter_0);
...
defineSeed(800, 635, makeCastMap([Q$Receiver]), EcolePresenter$1_0);
...
defineSeed(801, 635, makeCastMap([Q$Receiver]), EcolePresenter$2_0);
...
defineSeed(1171, 701, makeCastMap([Q$IsWidget, Q$EcolePresenter$MyView]), EcoleView_0);
...
defineSeed(1172, 388, makeCastMap([Q$HasCell, Q$Column]), EcoleView$1_0);
...
defineSeed(1173, 388, makeCastMap([Q$HasCell, Q$Column]), EcoleView$2_0);
...
defineSeed(1174, 362, makeCastMap([Q$HasCell, Q$Column]), EcoleView$3_0);
...
defineSeed(1605, 639, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$6X_0);
