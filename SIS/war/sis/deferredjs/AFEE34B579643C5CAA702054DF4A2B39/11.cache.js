...
defineSeed(874, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$DrawSchoolInterfaceEvent$DrawSchoolInterfaceHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmBulletinViewSummaryPresenter, Q$FrmBulletinViewSummaryUiHandler]), FrmBulletinViewSummaryPresenter_0);
...
defineSeed(875, 635, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$1_0);
...
defineSeed(876, 635, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$2_0);
...
defineSeed(877, 635, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$3_0);
...
defineSeed(878, 635, makeCastMap([Q$Receiver]), FrmBulletinViewSummaryPresenter$4_0);
...
function $drawBulletinSubjectList(this$static, subjects){
  dynamicCast(this$static.classes.get_0(this$static.lstClasses.element.selectedIndex - 1), Q$ClasseProxy).getProgrammeName().toLowerCase().indexOf('matu') != -1 && (dynamicCast(this$static.classes.get_0(this$static.lstClasses.element.selectedIndex - 1), Q$ClasseProxy).getClassName().toLowerCase().indexOf('pr\xE9maturit\xE9') != -1?$drawMatuTroisTrimestres(this$static, subjects):$drawMatuBulletin(this$static, subjects));
...
function $drawESBulletin(this$static, subjects){
  var applicationComportementSubject, i, rowCount, rowStart, totalCoef, totalMoyenne;
  $removeAllRows(this$static.tblNotes);
  $setText_0(this$static.tblNotes, 0, 0, 'Groupe');
  $setText_0(this$static.tblNotes, 0, 1, 'Coef');
  $setText_0(this$static.tblNotes, 0, 2, 'T1');
...
function $drawMatuTroisTrimestres(this$static, subjects){
  var i, rowCount, rowStart, totalCoef, totalMoyenne;
  $removeAllRows(this$static.tblNotes);
  $setText_0(this$static.tblNotes, 0, 0, 'Groupe');
  $setText_0(this$static.tblNotes, 0, 1, 'Coef');
...
defineSeed(1245, 701, makeCastMap([Q$IsWidget, Q$FrmBulletinViewSummaryPresenter$MyView]), FrmBulletinViewSummaryView_0);
...
defineSeed(1246, 496, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]), FrmBulletinViewSummaryView$1_0);
...
defineSeed(1254, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), FrmBulletinViewSummaryView_BinderImpl$Widgets$5_0);
...
defineSeed(1565, 639, makeCastMap([Q$AbstractRequest]), BulletinRequestFactory_BulletinRequestContextImpl$12X_0);
