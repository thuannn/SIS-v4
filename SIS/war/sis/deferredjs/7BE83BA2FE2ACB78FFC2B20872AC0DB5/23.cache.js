...
defineSeed(1024, 696, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(1025, 635, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(1026, 635, makeCastMap([Q$Receiver]), ProfsPresenter$10_0);
...
defineSeed(1027, 635, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(1028, 635, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(1029, 635, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(1030, 635, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(1031, 635, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(1032, 635, makeCastMap([Q$Receiver]), ProfsPresenter$8_0);
...
defineSeed(1033, 635, makeCastMap([Q$Receiver]), ProfsPresenter$9_0);
...
defineSeed(1410, 701, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1411, 389, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(1412, 363, makeCastMap([Q$HasCell, Q$Column]), ProfsView$2_0);
...
defineSeed(1415, 389, makeCastMap([Q$HasCell, Q$Column]), ProfsView$5_0);
...
defineSeed(1416, 389, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(1417, 389, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1418, 363, makeCastMap([Q$HasCell, Q$Column]), ProfsView$8_0);
...
defineSeed(1534, 639, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$10X_0);
...
defineSeed(1535, 639, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$11X_0);
...
defineSeed(1536, 639, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1625, 639, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
